# Site Intelligence v4.35.0 — Install and Test
...
4. Do not install the WordPress ZIP until the installer reports the exact v4.35.0 backend release gate and deep-live gate as successful.
