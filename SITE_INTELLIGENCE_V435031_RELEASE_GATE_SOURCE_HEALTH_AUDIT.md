# v4.35.3.1 Release-Gate & Source-Health Audit
...
The v4.35.3.1 test suite asserts that the current promotion script contains no `Deep gate:` and does not probe representative domain state endpoints such as Climate, Biodiversity, Mining, Water/Sanitation or Exoplanet state routes.
