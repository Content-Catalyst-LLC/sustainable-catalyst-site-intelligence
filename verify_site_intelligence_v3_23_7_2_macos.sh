...
printf '
==> Running mandatory v3.23.8 country dropdown interaction and focus-safety gate
'
"$PYTHON" "$ROOT/scripts/run_browser_gate_v32372.py" browser_country_selector_interaction_v32372.py

printf '
==> Running mandatory v3.23.8 global country selector hydration gate
'
"$PYTHON" "$ROOT/scripts/run_browser_gate_v32372.py" browser_country_selector_hydration_v32372.py

printf '\n==> Running mandatory v3.23.8 global country truth browser gate\n'
...
printf '
==> Verifying v3.23.8 country dropdown interaction and focus safety
'
...
grep -q 'data-truth-v32371.js?v=3.23.8' "$BACKEND/public_app/index.html"
...
printf '\n==> Running mandatory v3.23.8 production-soak route and service-worker gate\n'
...
printf '
SUCCESS: Site Intelligence v3.23.8 passed country dropdown interaction and focus-safety validation.
Repository: %s
' "$ROOT"
