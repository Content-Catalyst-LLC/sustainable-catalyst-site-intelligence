...
printf '
==> Verifying v4.13.0 country dropdown interaction and focus safety
'
...
printf '
SUCCESS: Site Intelligence v4.13.0 passed country dropdown interaction and focus-safety validation.
Repository: %s
' "$ROOT"
