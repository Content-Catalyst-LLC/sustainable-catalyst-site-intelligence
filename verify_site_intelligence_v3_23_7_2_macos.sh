...
printf '
==> Running mandatory v3.29.0 country dropdown interaction and focus-safety gate
'
...
printf '
==> Verifying v3.29.0 country dropdown interaction and focus safety
'
...
printf '
SUCCESS: Site Intelligence v3.29.0 passed country dropdown interaction and focus-safety validation.
Repository: %s
' "$ROOT"
