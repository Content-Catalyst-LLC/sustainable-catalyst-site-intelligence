...
grep -q 'data-truth-v32371.js?v=3.31.0' "$BACKEND/public_app/index.html"
...
printf '\n==> Running mandatory v3.31.0 production-soak route and service-worker gate\n'
...
printf '
SUCCESS: Site Intelligence v3.31.0 passed country dropdown interaction and focus-safety validation.
Repository: %s
' "$ROOT"
