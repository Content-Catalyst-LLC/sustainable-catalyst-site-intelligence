...
grep -q 'data-truth-v32371.js?v=4.11.0' "$BACKEND/public_app/index.html"
...
printf '\n==> Running mandatory v4.11.0 production-soak route and service-worker gate\n'
...
printf '
SUCCESS: Site Intelligence v4.11.0 passed country dropdown interaction and focus-safety validation.
Repository: %s
' "$ROOT"
