...
printf '
==> Running complete inherited and v3.26.0 test suite with process-isolated teardown
'
PYTHONPATH="$BACKEND" PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 "$PYTHON" "$ROOT/scripts/run_v32372_test_suite.py"
printf '
==> Verifying v3.26.0 country dropdown interaction and focus safety
'
...
printf '
SUCCESS: Site Intelligence v3.26.0 passed country dropdown interaction and focus-safety validation.
Repository: %s
' "$ROOT"
