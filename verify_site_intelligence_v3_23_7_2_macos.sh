...
printf '
==> Running mandatory v4.3.0 country dropdown interaction and focus-safety gate
'
...
printf '
==> Verifying v4.3.0 country dropdown interaction and focus safety
'
...
printf '
SUCCESS: Site Intelligence v4.3.0 passed country dropdown interaction and focus-safety validation.
Repository: %s
' "$ROOT"
