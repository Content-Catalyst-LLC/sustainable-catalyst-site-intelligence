# Site Intelligence v4.35.6 — Install and Test
...
No new credentials are required for the five v4.35.6 connectors. Existing FIRMS/NASS/ReliefWeb credentials remain optional/configuration-gated as documented in prior releases.
