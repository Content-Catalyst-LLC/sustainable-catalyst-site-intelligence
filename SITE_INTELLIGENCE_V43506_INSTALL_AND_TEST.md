# Site Intelligence v4.35.11 — Install and Test
...
No new credentials are required for the five v4.35.11 connectors. Existing FIRMS/NASS/ReliefWeb credentials remain optional/configuration-gated as documented in prior releases.
