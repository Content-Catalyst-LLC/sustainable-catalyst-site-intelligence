# Site Intelligence v3.22.5 recovery audit
...
Application modules previously implemented their own one-shot fetch helpers. Some core routes retried, while many specialized workspaces failed immediately. The v3.22.5 recovery runtime now wraps eligible same-origin public JSON requests before application modules load.
