...
printf '\n==> Running deterministic v%s validation\n' "$RELEASE"; PYTHON="$ROOT/.venv/bin/python" bash "$ROOT/verify_site_intelligence_v4_38_0_macos.sh"
printf '\n==> Running browser certification\n'; SC_SI_SKIP_TESTS=1 SC_SI_RUN_BROWSER=1 PYTHON="$ROOT/.venv/bin/python" bash "$ROOT/verify_site_intelligence_v4_38_0_macos.sh"
printf '\n==> Promoting certified tree through GitHub and Render\n'; PYTHON="$ROOT/.venv/bin/python" bash "$ROOT/promote_site_intelligence_v4_38_0_to_github_and_render_macos.sh"
