...
printf '\n==> Running complete inherited and v3.25.0 test suite with bounded process-isolated teardown\n'
...
printf '
==> Verifying v3.25.0 Global Data Truth Control Plane
'
...
grep -q 'record-provenance-v3238.js?v=3.25.0' "$BACKEND/public_app/index.html"
...
grep -q 'data-truth-control-plane-v3240.js?v=3.25.0' "$BACKEND/public_app/index.html"
...
printf '\n==> Running mandatory v3.25.0 record provenance and indicator-truth gate\n'
reset_runtime
"$PYTHON" "$ROOT/scripts/run_browser_gate_v3240.py" browser_record_provenance_v3238.py
printf '
==> Running mandatory v3.25.0 Global Data Truth Control Plane gate
'
reset_runtime
...
printf '
SUCCESS: Site Intelligence v3.25.0 passed Global Data Truth Control Plane validation.
Repository: %s
' "$ROOT"
