...
Extend Global Ocean Intelligence below the sea surface without converting a depth request into a fabricated observation. v4.7.0 adds a source-bounded vertical navigation and profile-evidence contract inside the existing Earth Observation route.
...
- v4.7.0 performs **no interpolation** between profile samples.
