...
Site Intelligence v4.35.10 removes the split evidence path between country-workspace indicator cards and Record Truth. Country headline values, evidence metadata, Truth responses, country truth catalogs, and record-truth manifests now resolve from one canonical country-indicator observation object.
...
The release carries 1,479 deterministic tests, including 12 new v4.35.10 unification regressions. The suite preserves the complete v4.35.7 connector, deployment, source-precedence, Palestine-resolution, domain-workspace, and Record Provenance compatibility contracts.
