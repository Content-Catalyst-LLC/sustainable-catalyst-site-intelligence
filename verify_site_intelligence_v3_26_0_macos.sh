...
printf '\n==> Validating v3.26.0 comparative, scenario, and model assurance contracts\n'
...
grep -q 'assurance-v3260.js?v=3.26.0' "$BACKEND/public_app/index.html"
...
printf '\nSUCCESS: Site Intelligence v3.26.0 passed comparative, scenario, and model assurance validation.\nRepository: %s\n' "$ROOT"
