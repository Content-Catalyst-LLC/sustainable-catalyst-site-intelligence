...
printf '\n==> Validating v4.5.0 comparative, scenario, and model assurance contracts\n'
...
grep -q 'assurance-v3260.js?v=4.5.0' "$BACKEND/public_app/index.html"
...
grep -q 'cross-view-state-v3250.js?v=4.5.0' "$BACKEND/public_app/index.html"
...
printf '\nSUCCESS: Site Intelligence v4.5.0 passed comparative, scenario, and model assurance validation.\nRepository: %s\n' "$ROOT"
