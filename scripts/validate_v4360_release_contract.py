...
assert overview["ok"] and overview["version"] == "4.39.1" and overview["system_count"] == 11
...
assert 'ocean-observation-v4360.js?v=4.39.1' in index and 'ocean-observation-v4360.css?v=4.39.1' in index
...
print("PASS: v4.39.1 R4 Science/Ocean controller, route ownership and Ocean/Space prominence release contract")
