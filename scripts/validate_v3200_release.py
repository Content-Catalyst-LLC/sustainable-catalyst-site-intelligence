...
requirements = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 4.9.0", "sc_live_intelligence_registry_discovery",
    ...
    "README.md": ["v4.9.0 — Public Registry Discovery, Evidence Search, and Institutional Profiles"],
    "RELEASE_NOTES_SITE_INTELLIGENCE_V3200.md": ["Registry Discovery", "institutional profiles", "Search queries are not stored"],
    "docs/RELEASE_MANIFEST_V3200.json": ['"version": "4.9.0"', '"search_queries_stored": false'],
