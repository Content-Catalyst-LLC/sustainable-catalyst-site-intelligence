...
requirements = {
    ...
    "backend/public_app/assets/spatial-v2150.js": ['const VERSION = "3.23.6.3"', "L.geoJSON", "renderEvidence"],
    "backend/public_app/service-worker.js": ['const RELEASE="3.23.6.3"', "map-fallback-v3221.js", "map-fallback-v3221.css"],
    "backend/public_app/manifest.webmanifest": ["release=3.23.6.3"],
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 3.23.6.3", "mapFallbackUrl"],
...
if manifest_path.exists():
    ...
    if manifest.get("release") != "3.23.6.3":
        raise SystemExit("MANIFEST.json is not aligned to v3.23.6.3")
print("Site Intelligence v3.23.6.3 map runtime repair contract passed.")
