...
requirements = {
    ...
    "backend/public_app/assets/spatial-v2150.js": ['const VERSION = "4.16.0"', "L.geoJSON", "renderEvidence"],
    "backend/public_app/service-worker.js": ['const RELEASE="4.16.0"', "map-fallback-v3221.js", "map-fallback-v3221.css"],
    "backend/public_app/manifest.webmanifest": ["release=4.16.0"],
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 4.16.0", "mapFallbackUrl"],
...
if manifest_path.exists():
    ...
    if manifest.get("release") != "4.16.0":
        raise SystemExit("MANIFEST.json is not aligned to v4.16.0")
print("Site Intelligence v4.16.0 map runtime repair contract passed.")
