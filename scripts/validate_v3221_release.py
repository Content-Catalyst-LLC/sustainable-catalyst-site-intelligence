...
requirements = {
    ...
    "backend/public_app/assets/spatial-v2150.js": ['const VERSION = "3.23.6.1"', "L.geoJSON", "renderEvidence"],
    "backend/public_app/service-worker.js": ['const RELEASE="3.23.6.1"', "map-fallback-v3221.js", "map-fallback-v3221.css"],
    "backend/public_app/manifest.webmanifest": ["release=3.23.6.1"],
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 3.23.6.1", "mapFallbackUrl"],
...
if manifest_path.exists():
    ...
    if manifest.get("release") != "3.23.6.1":
        raise SystemExit("MANIFEST.json is not aligned to v3.23.6.1")
print("Site Intelligence v3.23.6.1 map runtime repair contract passed.")
