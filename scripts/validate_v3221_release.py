...
requirements = {
    "backend/app/version.py": ['APP_VERSION = "3.22.5"'],
    ...
    "backend/public_app/assets/spatial-v2150.js": ['const VERSION = "3.22.5"', "L.geoJSON", "renderEvidence"],
    "backend/public_app/service-worker.js": ['const RELEASE="3.22.5"', "map-fallback-v3221.js", "map-fallback-v3221.css"],
    "backend/public_app/manifest.webmanifest": ["release=3.22.5"],
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 3.22.5", "mapFallbackUrl"],
...
if manifest_path.exists():
    ...
    if manifest.get("release") != "3.22.5":
        raise SystemExit("MANIFEST.json is not aligned to v3.22.5")
print("Site Intelligence v3.22.5 map runtime repair contract passed.")
