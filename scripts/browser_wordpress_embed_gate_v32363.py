#!/usr/bin/env python3
"""Mandatory long-page WordPress embed stability gate for Site Intelligence v4.4.0."""
...
<div class=\"scsi-standalone-app scsi-fixed-application-viewport\" data-scsi-fixed-app data-scsi-embed-mode=\"fixed\" data-scsi-fixed-height=\"1100\" data-scsi-release=\"4.4.0\" style=\"--scsi-fixed-app-height:1100px\">
...
<script>window.SCSiteIntelligence={{version:\"4.4.0\",restBase:\"\",backendUrl:\"https://example.invalid\"}};</script>
...
def main() -> int:
    ...
    print("PASS: v4.4.0 fixed WordPress application viewport remained 1100px and the long host page did not jump during route, mutation, scroll, or viewport changes.")
    return 0
