#!/usr/bin/env python3
"""Run the complete v3.23.7.2 test inventory in one file-backed process.
...
from run_v32372_test_groups import completed_pass, passed_count, run_file_backed
...
def main() -> int:
    base = Path(os.environ.get("SC_SI_RUNTIME_STATE_ROOT") or tempfile.mkdtemp(prefix="scsi-v32372-tests-"))
