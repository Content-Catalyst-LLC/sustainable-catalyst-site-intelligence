...
assert 'data-scsi-release="4.35.7"' in index
assert 'const APP_VERSION="4.35.7"' in app
...
print('PASS: v4.35.7 national statistical/domain-authority connector browser/static gate')
