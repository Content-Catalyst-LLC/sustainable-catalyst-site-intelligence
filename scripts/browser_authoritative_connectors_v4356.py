...
assert 'data-scsi-release="4.35.10"' in index
assert 'const APP_VERSION="4.35.10"' in app
...
print('PASS: v4.35.10 national statistical/domain-authority connector browser/static gate')
