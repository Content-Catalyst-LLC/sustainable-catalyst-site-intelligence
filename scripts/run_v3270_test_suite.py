...
from run_v3270_test_groups import completed_pass, passed_count, run_file_backed
...
def main() -> int:
    base = Path(os.environ.get("SC_SI_RUNTIME_STATE_ROOT") or tempfile.mkdtemp(prefix="scsi-v3270-tests-"))
