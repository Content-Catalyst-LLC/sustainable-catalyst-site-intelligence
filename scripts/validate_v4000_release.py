...
assert platform["version"] == "4.12.0"
...
print(json.dumps({"version":"4.12.0","primary_areas":6,"routes":35,"contracts":6,"readiness":ready["ok"],"platform_sha256":platform["platform_sha256"]},indent=2))
print("PASS: Site Intelligence v4.12.0 Unified Public Intelligence Platform contracts are complete.")
