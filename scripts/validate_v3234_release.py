...
required={
 ...
 "backend/public_app/index.html":["analytical-workspaces-v3234.css?v=3.25.0","analytical-workspaces-v3234.js?v=3.25.0"],
 "backend/public_app/service-worker.js":["const RELEASE=\"3.25.0\"","analytical-workspaces-v3234.js"],
 "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php":["Version: 3.25.0","analyticalWorkspacesJsUrl"],
...
if not payload.get("ok") or payload.get("version")!="3.25.0" or payload.get("workflow_count")!=5:raise SystemExit("Analytical workspace endpoint failed")
...
print("Site Intelligence v3.25.0 analytical workspace release contract passed.")
