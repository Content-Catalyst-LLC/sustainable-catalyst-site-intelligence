...
sw=(ROOT/'backend/public_app/service-worker.js').read_text();prev=(ROOT/'backend/public_app/assets/industrial-manufacturing-v43000.js').read_text()
assert 'mining-critical-materials-v43100.js' in prev and 'mining-critical-materials-v43100.js' in sw and 'mining-critical-materials-v43100.css' in sw
...
print('PASS: v4.31.0 static release validation')
