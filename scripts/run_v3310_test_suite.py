#!/usr/bin/env python3
"""Run the complete v4.14.0 pytest inventory once with bounded teardown.
...
MIN_EXPECTED_TESTS=1079

def main()->int:
    base=Path(os.environ.get('SC_SI_RUNTIME_STATE_ROOT') or tempfile.mkdtemp(prefix='scsi-v3310-tests-'))
