#!/usr/bin/env python3
"""Complete application-shell Chromium startup validation for v3.23.6.3.
...
def main():
    ...
    for key,value in results.items():
        assert value['release']=='3.23.6.3',(key,value)
    ...
    print(json.dumps(results,indent=2));print('PASS: complete v3.23.6.3 HTML/app.js startup is visible across worker failure and iframe conditions.');return 0
