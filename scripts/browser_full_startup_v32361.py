#!/usr/bin/env python3
"""Complete application-shell Chromium startup validation for v3.23.6.2.
...
def main():
    ...
    for key,value in results.items():
        assert value['release']=='3.23.6.2',(key,value)
    ...
    print(json.dumps(results,indent=2));print('PASS: complete v3.23.6.2 HTML/app.js startup is visible across worker failure and iframe conditions.');return 0
