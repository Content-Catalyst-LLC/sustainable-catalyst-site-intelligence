#!/usr/bin/env python3
"""Complete application-shell Chromium startup validation for v4.10.0.
...
def main():
    ...
    for key,value in results.items():
        assert value['release']=='4.10.0',(key,value)
    ...
    print(json.dumps(results,indent=2));print('PASS: complete v4.10.0 HTML/app.js startup is visible across worker failure and iframe conditions.');return 0
