...
def fixture_html():
    catalog = {
        'ok': True, 'version': '4.10.0', 'maximum_navigation_depth_m': 11000,
        'sources': [
...
def exercise(page, label):
    ...
    page.wait_for_function("window.SCSIWaterColumnV4600?.version==='4.10.0'")
    ...
    assert m['version']=='4.10.0' and m['variable']=='dissolved-oxygen' and m['source']=='copernicus-marine' and m['depth']=='1500'
...
def main():
    ...
    print(json.dumps({'browser':path,'results':[r1,r2]},indent=2)); print('PASS: v4.10.0 Water Column & Depth Explorer passed direct and iframe interaction.'); sys.stdout.flush(); os._exit(0)
