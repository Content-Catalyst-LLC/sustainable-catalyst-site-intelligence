...
with sync_playwright() as p:
 ...
 page.set_content('<!doctype html><style>'+CSS+'</style><div id="app" data-scsi-release="4.2.0"><header><div class="topbar-controls"><select id="countrySelect"><option value="BRA">Brazil</option><option value="KEN">Kenya</option></select></div></header></div>')
...
print(json.dumps(result,indent=2));assert not errors and result['country_ready'] and result['matrix_ready'] and result['filter_hides'] and result['api']=='4.2.0';print('PASS: v4.2.0 country truth and coverage matrix rendered without browser errors.')
