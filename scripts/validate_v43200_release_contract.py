...
assert o.get('ok') and o.get('version')=='4.33.0' and o.get('contract')=='global-water-supply-wastewater-sanitation-infrastructure-intelligence' and o.get('route')=='earth' and o.get('source_count')==4
...
print('PASS: v4.33.0 water supply / wastewater / sanitation release contract')
