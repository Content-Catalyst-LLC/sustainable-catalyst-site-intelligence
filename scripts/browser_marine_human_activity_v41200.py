...
def fixture_html():
    catalog={
      'ok':True,'version':'4.13.0','contract':'marine-human-activity-protected-areas-maritime-pressure',
      'sources':[
...
def exercise(page,label):
    ...
    page.wait_for_function("window.SCSIMarineHumanActivityV41200?.version==='4.13.0'")
    ...
    assert m['version']=='4.13.0' and m['source']=='global-fishing-watch' and m['activity']=='fishing-activity'
...
def main():
    ...
    print(json.dumps({'browser':path,'results':[r1,r2]},indent=2)); print('PASS: v4.13.0 Marine Human Activity passed direct and iframe interaction.'); os._exit(0)
