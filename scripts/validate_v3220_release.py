...
requirements = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 3.23.6.3", "sc_live_intelligence_registry_publications"],
    ...
    "README.md": ["v3.23.6.3 — Collection Publication, Citation Exports, and Research Brief Packages"],
    "RELEASE_NOTES_SITE_INTELLIGENCE_V3220.md": ["Collection Publication", "Citation exports", "No automatic publication"],
    "docs/RELEASE_MANIFEST_V3220.json": ['"version": "3.23.6.3"', '"automatic_publication_performed": false'],
