#!/usr/bin/env python3
"""Deterministic browser regression for v4.37.0 country evidence hierarchy."""
...
def main() -> int:
    ...
    if not browser_path:
        print("ERROR: Chromium or Chrome is required for v4.37.0 country presentation gate.")
        return 2
    try:
        from playwright.sync_api import sync_playwright
    except ImportError:
        print("ERROR: Playwright is required for v4.37.0 country presentation gate.")
        return 2
    ...
    print("PASS: v4.37.0 country evidence hierarchy is visible and Conditions Now remains separate from structural indicators.")
    return 0
