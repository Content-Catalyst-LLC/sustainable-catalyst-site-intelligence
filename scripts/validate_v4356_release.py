...
assert 'Version: 4.35.6' in wp and 'site-intelligence-v4.35.6' in wp
index=(ROOT/'backend/public_app/index.html').read_text(); app=(ROOT/'backend/public_app/assets/app.js').read_text()
assert 'data-scsi-release="4.35.6"' in index and 'const APP_VERSION="4.35.6"' in app
...
print('PASS: v4.35.6 static release validation')
