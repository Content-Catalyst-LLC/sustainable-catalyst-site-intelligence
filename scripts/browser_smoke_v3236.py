#!/usr/bin/env python3
"""Network-independent Chromium smoke test for v4.12.0 performance/offline recovery."""
...
def main() -> int:
    ...
    html = f'''<!doctype html><html><head><style>{CSS.read_text(encoding="utf-8")}</style></head><body>
      <div id="app" data-scsi-release="4.12.0">
    ...
    print("PASS: v4.12.0 first-useful-map measurement, route isolation, and recovery status rendered without browser errors.")
    return 0
