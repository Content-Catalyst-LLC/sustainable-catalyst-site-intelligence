...
EXCLUDED_PREFIXES = {
    ...
    'backend/data/live_intelligence_public_archive_v3150', 'backend/data/live_intelligence_archive_audits_v3160',
    'backend/data/live_intelligence_preservation_exchange_v3170', 'backend/data/live_intelligence_preservation_registry_v3180',
    'backend/data/live_intelligence_registry_governance_v3190', 'backend/data/live_intelligence_registry_collections_v3210',
    'backend/data/live_intelligence_registry_publications_v3220', 'backend/backend/data',
}
EXCLUDED_FILES = {
...
manifest = {'release': '4.15.0', 'file_count': len(files), 'files': files}
(ROOT / 'MANIFEST.json').write_text(json.dumps(manifest, indent=2) + '\n', encoding='utf-8')
print(f'Wrote {len(files)}-file immutable v4.15.0 release manifest.')
