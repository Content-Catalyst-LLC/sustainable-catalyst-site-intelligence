#!/usr/bin/env python3
"""Browser certification for v4.36.0 R2 Science Core-decoupling.
...
def main() -> int:
    ...
    if not browser_path:
        print("ERROR: Chromium or Chrome is required for the v4.36.0 R2 Science browser gate.")
        return 2
    try:
        from playwright.sync_api import sync_playwright
    except ImportError:
        print("ERROR: Playwright is required for the v4.36.0 R2 Science browser gate.")
        return 2
    ...
    print("PASS: v4.36.0 R2 Science remains usable with Platform Core unconfigured and launches both Ocean and Space.")
    return 0
