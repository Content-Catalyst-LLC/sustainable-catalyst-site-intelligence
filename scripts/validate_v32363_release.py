...
required = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 4.11.0", "data-scsi-fixed-app", 'data-scsi-release="%5$s"'],
...
if not contract.get("ok") or contract.get("version") != "4.11.0" or contract.get("application_embed", {}).get("document_auto_resize") is not False:
...
print("Site Intelligence v4.11.0 fixed application viewport and WordPress embed isolation contract passed.")
