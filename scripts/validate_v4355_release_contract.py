...
from app.authoritative_connectors_v4355 import connector_catalog, connector_readiness
from app.authoritative_api_audit_v4355 import audit_overview
...
assert catalog['connector_count']==15
assert catalog['live_connector_count']==11 and catalog['discovery_connector_count']==2
...
assert len(audit['completed_connector_targets'])==15
assert summary['source_registrations']==179 and summary['machine_readable_registrations']==96
assert summary['implemented_or_configuration_gated_registrations']==61
assert summary['counts']['LIVE']==41 and summary['counts']['DISCOVERY']==8
...
for endpoint in ('/public/authoritative-connectors/usfws-nwi/wetlands','/public/authoritative-connectors/epa-echo/facilities','/public/authoritative-connectors/nasa-firms/area','/public/authoritative-connectors/usda-nass/quick-stats','/public/authoritative-connectors/nasa-cmr/graphql/collections'):
...
for marker in ('site-intelligence-v4.35.5','SC_SI_NASA_FIRMS_MAP_KEY','SC_SI_USDA_NASS_API_KEY','SC_SI_NASA_EARTHDATA_TOKEN'):
    assert marker in render
print('PASS: v4.35.5 authoritative connector expansion III release contract')
