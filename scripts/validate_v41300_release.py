...
human = (ROOT / 'backend/public_app/assets/marine-human-activity-v41200.js').read_text()
assert 'marine-pollution-v41300.js' in human
assert 'marine-pollution-v41300.js' in sw and 'marine-pollution-v41300.css' in sw
for asset in (
...
subprocess.run([sys.executable, str(ROOT/'scripts/validate_v41300_release_contract.py')], check=True, cwd=ROOT, env={**os.environ, 'PYTHONPATH':str(ROOT/'backend')})
