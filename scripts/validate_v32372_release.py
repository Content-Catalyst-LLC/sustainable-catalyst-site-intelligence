...
for token in ('data-truth-v32371.css?v=3.23.7.2','data-truth-v32371.js?v=3.23.7.2'):assert token in html
assert 'data-truth-v32371.js' in worker and 'Version: 3.23.7.2' in php
...
print('Site Intelligence v3.23.7.2 country dropdown interaction and focus-safety release contract passed.')
