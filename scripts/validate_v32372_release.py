...
for token in ('data-truth-v32371.css?v=4.14.0','data-truth-v32371.js?v=4.14.0'):assert token in html
assert 'data-truth-v32371.js' in worker and 'Version: 4.14.0' in php
...
print('Site Intelligence v4.14.0 country dropdown interaction and focus-safety release contract passed.')
