...
assert o['ok'] and o['version']=='4.8.0' and o['contract']=='orbital-earth-satellite-observation' and o['route']=='earth'
...
assert 'data-scsi-release="4.8.0"' in html and 'data-scsi-orbital-contract="orbital-earth-v4200"' in html
assert 'orbital-earth-v4200.js?v=4.8.0' in html and 'orbital-earth-v4200.css?v=4.8.0' in html
...
print(json.dumps({'version':'4.8.0','contract':o['contract'],'layers':c['layer_count'],'routes':nav['route_count'],'primary_areas':nav['primary_area_count'],'readiness':r['ok'],'state_sha256':s['state_sha256']},indent=2))
print('PASS: Site Intelligence v4.8.0 Orbital Earth & Satellite Observation contracts are complete.')
