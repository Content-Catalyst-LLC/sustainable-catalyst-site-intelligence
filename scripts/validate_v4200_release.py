...
assert 'data-scsi-release="4.3.0"' in html and 'data-scsi-orbital-contract="orbital-earth-v4200"' in html
assert 'orbital-earth-v4200.js?v=4.3.0' in html and 'orbital-earth-v4200.css?v=4.3.0' in html
