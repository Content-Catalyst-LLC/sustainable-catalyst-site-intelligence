...
assert 'data-scsi-release="4.35.17"' in index
assert 'const APP_VERSION="4.35.17"' in app
for marker in ('EXTERNAL RESILIENCE · v4.35.17', 'externalResilienceStatus', 'resilienceCircuitMetric'):
