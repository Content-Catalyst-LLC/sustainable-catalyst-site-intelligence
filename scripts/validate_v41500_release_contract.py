...
c=catalog(); assert c['version']=='4.15.0'; assert {x['id'] for x in c['sources']}=={'noaa-maritime-boundaries','marine-regions-vliz','fao-major-fishing-areas','fao-regional-fishery-bodies'}
...
print('PASS: v4.15.0 ocean governance / jurisdiction / maritime boundaries release contract')
