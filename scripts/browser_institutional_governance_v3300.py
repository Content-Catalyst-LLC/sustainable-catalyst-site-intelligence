...
def exercise(page,label):
    ...
    page.locator('.nav-item[data-route="workspaces"]').click()
...
def main():
    ...
    print(json.dumps({'browser':path,'results':results,'errors':errors},indent=2));print('PASS: v3.30.0 Institutional Workspaces and Review Governance rendered in direct and iframe modes.');return 0
