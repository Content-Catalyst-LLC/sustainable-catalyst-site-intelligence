...
requirements = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 3.23.2", "sc_live_intelligence_registry_governance",
    ...
    "README.md": ["v3.23.2 — Registry Governance, Challenges, Revocation, and Appeals"],
    "RELEASE_NOTES_SITE_INTELLIGENCE_V3190.md": ["Registry Governance", "append-only", "appeals"],
    "docs/RELEASE_MANIFEST_V3190.json": ['"version": "3.23.2"', '"automatic_enforcement_performed": false'],
