...
assert overview['ok'] and overview['version'] == '3.27.0'
...
for token in ('data-truth-control-plane-v3240.css?v=3.27.0','data-truth-control-plane-v3240.js?v=3.27.0'):
...
print('Site Intelligence v3.27.0 Global Data Truth Control Plane release contract passed.')
