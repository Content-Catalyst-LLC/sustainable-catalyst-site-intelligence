...
assert overview['ok'] and overview['version'] == '4.12.0'
...
for token in ('data-truth-control-plane-v3240.css?v=4.12.0','data-truth-control-plane-v3240.js?v=4.12.0'):
...
print('Site Intelligence v4.12.0 Global Data Truth Control Plane release contract passed.')
