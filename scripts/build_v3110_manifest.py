...
manifest={'schema':'sc-site-intelligence-release-manifest/1.0','release':'3.28.0','release_name':'Editorial Workspace, Review Queues, and Publication Orchestration','file_count':len(files),'files':files}
