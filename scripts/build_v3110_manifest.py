...
EXCLUDED_PREFIXES = {
    ...
    'backend/data/live_intelligence_editorial_v3110',
}
EXCLUDED_FILES = {
    'MANIFEST.json', '.DS_Store',
    'backend/data/platform_core_queue.jsonl', 'backend/data/country_last_known_good.json',
    'backend/data/country_last_known_good.json.tmp',
...
manifest={'schema':'sc-site-intelligence-release-manifest/1.0','release':'3.23.6.3','release_name':'Editorial Workspace, Review Queues, and Publication Orchestration','file_count':len(files),'files':files}
