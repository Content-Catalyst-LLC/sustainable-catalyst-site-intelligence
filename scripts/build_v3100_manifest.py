...
manifest={'schema':'sc-site-intelligence-release-manifest/1.0','release':'4.11.0','release_name':'Live Intelligence Briefings, Narrative Context, and Publication Workflow','file_count':len(files),'files':files}
