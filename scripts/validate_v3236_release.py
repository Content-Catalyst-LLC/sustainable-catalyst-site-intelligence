...
required={
 ...
 'backend/public_app/index.html':['performance-offline-v3236.css?v=3.23.6.2','performance-offline-v3236.js?v=3.23.6.2'],
 'backend/public_app/service-worker.js':['const RELEASE="3.23.6.2"','cacheFirstImmutable','networkFirstData','X-SCSI-Data-State'],
 'wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php':['Version: 3.23.6.2','performanceOfflineJsUrl'],
...
if not payload.get('ok') or payload.get('version')!='3.23.6.2' or payload.get('contract')!='performance-and-offline-recovery':raise SystemExit('Performance/offline endpoint failed')
...
print('Site Intelligence v3.23.6.2 performance and offline recovery release contract passed.')
