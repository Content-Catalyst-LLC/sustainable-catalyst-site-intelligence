...
required={
 'backend/app/version.py':['APP_VERSION = "4.6.0"'],
 ...
 'backend/public_app/index.html':['performance-offline-v3236.css?v=4.6.0','performance-offline-v3236.js?v=4.6.0'],
 'backend/public_app/service-worker.js':['const RELEASE="4.6.0"','cacheFirstImmutable','networkFirstData','X-SCSI-Data-State'],
 'wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php':['Version: 4.6.0','performanceOfflineJsUrl'],
...
if not payload.get('ok') or payload.get('version')!='4.6.0' or payload.get('contract')!='performance-and-offline-recovery':raise SystemExit('Performance/offline endpoint failed')
...
if manifest and manifest.get('release')!='4.6.0':raise SystemExit('Manifest release mismatch')
print('Site Intelligence v4.6.0 performance and offline recovery release contract passed.')
