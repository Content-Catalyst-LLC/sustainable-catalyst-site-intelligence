...
required={
 ...
 'backend/public_app/index.html':['performance-offline-v3236.css?v=3.25.0','performance-offline-v3236.js?v=3.25.0'],
 'backend/public_app/service-worker.js':['const RELEASE="3.25.0"','cacheFirstImmutable','networkFirstData','X-SCSI-Data-State'],
 'wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php':['Version: 3.25.0','performanceOfflineJsUrl'],
...
if not payload.get('ok') or payload.get('version')!='3.25.0' or payload.get('contract')!='performance-and-offline-recovery':raise SystemExit('Performance/offline endpoint failed')
...
print('Site Intelligence v3.25.0 performance and offline recovery release contract passed.')
