#!/usr/bin/env python3
"""Browser certification for v4.39.1 live underwater media discovery."""
...
PROVIDERS={
  'ok':True,'version':'4.39.1','default_provider':'fathomnet','provider_count':3,
  'providers':[
...
SEARCH={
  'ok':True,'version':'4.39.1','contract':'live-underwater-media-discovery-imagery-video-retrieval',
...
def main()->int:
    ...
    if not browser_path:
        print('ERROR: Chromium or Chrome is required for v4.39.1 underwater browser certification.'); return 2
    try:
        from playwright.sync_api import sync_playwright
    except ImportError:
        print('ERROR: Playwright is required for v4.39.1 underwater browser certification.'); return 2
...
window.URL=HarnessURL;
        ...
        page.wait_for_function('window.SCSIUnderwaterV4800?.version === "4.39.1"',timeout=5000)
    ...
    print('PASS: v4.39.1 renders live underwater candidate media, defaults to FathomNet, keeps ONC optional, and does not fabricate 0,0/depth defaults.')
    return 0
