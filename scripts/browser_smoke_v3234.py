#!/usr/bin/env python3
"""Network-independent Chromium smoke test for v3.23.6 analytical workflow presentation."""
...
def main()->int:
 ...
 payload={"ok":True,"version":"3.23.6","workflow_count":5,"summary":{"operational":5,"limited":0,"unavailable":0},"workflows":workflows,"completion_gate":{"principle":"Non-live records cannot claim live status."}}
 errors=[]
 with sync_playwright() as pw:
  ...
  page.set_content('<!doctype html><html><body><div id="app" data-scsi-release="3.23.6"><header class="topbar"><div class="topbar-controls"></div></header><nav><button class="nav-item" data-route="global">Global</button><button class="nav-item" data-route="country">Country</button><button class="nav-item" data-route="compare">Compare</button><button class="nav-item" data-route="spatial">Spatial</button><button class="nav-item" data-route="earth">Earth</button></nav></div></body></html>')
 ...
 print(json.dumps({**result,"opened":opened},indent=2));print("PASS: v3.23.6 rendered five bounded analytical workflows with route actions and no host leakage.");return 0
