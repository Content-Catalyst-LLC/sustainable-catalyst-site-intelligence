...
def exercise(page,label):
    ...
    page.wait_for_function("window.SCSIOceanGovernanceV41500?.version==='4.15.0'")
    ...
    assert m['version']=='4.15.0' and m['source']=='fao-major-fishing-areas' and m['zone']=='fao-major-fishing-area'
...
def main():
    ...
    print(json.dumps({'browser':path,'results':[r1,r2]},indent=2),flush=True); print('PASS: v4.15.0 Ocean Governance passed direct and iframe interaction.',flush=True); os._exit(0)
