...
assert o.get('ok') and o.get('version')=='4.35.0' and o.get('contract')=='exoplanets-habitability-atmospheric-biosignature-intelligence' and o.get('route')=='earth' and o.get('source_count')==4
...
print('PASS: v4.35.0 exoplanets / habitability / atmospheric biosignature release contract')
