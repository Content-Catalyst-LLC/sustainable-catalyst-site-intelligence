...
x=overview(); assert x['version']=='4.17.0' and x['contract']=='global-cryosphere-intelligence-frozen-earth-conditions' and x['route']=='earth' and x['source_count']==4
...
print('PASS: v4.17.0 global cryosphere release contract')
