...
REQUIRED = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 3.8.0", "rest_live_intelligence_analytics_events", "rest_live_intelligence_analytics_summary",
    ],
    ...
    "README.md": ["v3.8.0 — Analytics and Public-Value Measurement"],
    "RELEASE_NOTES_SITE_INTELLIGENCE_V372.md": ["Analytics and Public-Value Measurement", "Raw events are never stored"],
    "docs/RELEASE_MANIFEST_V372.json": ['"version": "3.8.0"', '"raw_events_stored": false', '"individual_user_tracking": false'],
}
