...
requirements = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 3.23.6.2", "sc_live_intelligence_archive_audits",
    ...
    "README.md": ["v3.23.6.2 — Archive Verification, Preservation Audits, and Institutional Custody"],
    "RELEASE_NOTES_SITE_INTELLIGENCE_V3160.md": ["Archive Verification", "custody", "checksum"],
    "docs/RELEASE_MANIFEST_V3160.json": [
        '"version": "3.23.6.2"', '"append_only_audit_ledger": true',
