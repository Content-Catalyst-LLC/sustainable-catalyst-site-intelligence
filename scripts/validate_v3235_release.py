...
required={
 ...
 'backend/public_app/index.html':['browser-reliability-v3235.css?v=3.25.0','browser-reliability-v3235.js?v=3.25.0'],
 'backend/public_app/service-worker.js':['const RELEASE="3.25.0"','browser-reliability-v3235.js'],
 'wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php':['Version: 3.25.0','browserReliabilityJsUrl'],
...
if not payload.get('ok') or payload.get('version')!='3.25.0' or payload.get('contract')!='browser-reliability-mobile-accessibility':raise SystemExit('Browser reliability endpoint failed')
...
print('Site Intelligence v3.25.0 browser reliability release contract passed.')
