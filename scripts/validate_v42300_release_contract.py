...
x=overview(); assert x['version']=='4.23.0' and x['contract']=='global-biodiversity-species-distribution-conservation-intelligence' and x['route']=='earth' and x['source_count']==4
...
print('PASS: v4.23.0 biodiversity / species distribution / conservation release contract')
