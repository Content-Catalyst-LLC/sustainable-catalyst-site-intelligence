...
RUNTIME_DIR="${2:-$(mktemp -d "${TMPDIR:-/tmp}/scsi-v2220-regression.XXXXXX")}" 
...
mkdir -p "$RUNTIME_DIR"/{country,history,spatial,harmonization,models,evidence,graph,publishing,monitoring,workspaces,connectors,platform}
