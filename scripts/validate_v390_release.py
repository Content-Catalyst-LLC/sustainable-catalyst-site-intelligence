...
REQUIRED = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 3.14.0", "sc_live_intelligence_watchlists", "sc_live_intelligence_alerts",
    ...
    "README.md": ["v3.14.0 — Signal Subscriptions, Alerts, and Scheduled Intelligence"],
    ...
    "docs/RELEASE_MANIFEST_V390.json": [
        '"version": "3.14.0"', '"subscriber_profiles_stored": false',
