#!/usr/bin/env python3
"""Network-independent Chromium smoke test for v4.12.0 production truth."""
...
def main() -> int:
    ...
    with sync_playwright() as playwright:
        ...
        page.evaluate("()=>window.SCSIRouterV3228.navigate('global')")
    ...
    print("PASS: v4.12.0 production truth disabled a missing controller, reported route readiness, and restored browser history.")
    return 0
