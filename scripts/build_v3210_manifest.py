...
EXCLUDED_PREFIXES = {
    ...
    'backend/data/live_intelligence_registry_governance_v3190', 'backend/data/live_intelligence_registry_collections_v3210', 'backend/backend/data',
}
EXCLUDED_FILES = {
...
manifest = {
    ...
    'release': '3.22.0',
    'release_name': 'Saved Discovery Views, Public Research Collections, and Evidence Pathways',
