...
assert 'const APP_VERSION="4.35.21"' in app
for marker in ("SIMPLY WORKS WORKSPACE AUDIT", "LIVE-OPERATION STRESS LAYER · v4.35.21", "workspace-reliability-v43518.js"):
