#!/usr/bin/env python3
"""Deterministic browser smoke for the v4.37.0 first-class Ocean workspace."""
...
def main() -> int:
    ...
    if not browser_path:
        print("ERROR: Chromium or Chrome is required for v4.37.0 Ocean browser gate.")
        return 2
    try:
        from playwright.sync_api import sync_playwright
    except ImportError:
        print("ERROR: Playwright is required for v4.37.0 Ocean browser gate.")
        return 2
    ...
    print("PASS: v4.37.0 R1 Ocean workspace survives v4 navigation regrouping and is first-class, visible, grouped and source-bound.")
    return 0
