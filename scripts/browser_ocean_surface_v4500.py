...
def exercise(page,label):
    ...
    page.wait_for_function("window.SCSIOceanSurfaceV4500?.version==='4.14.0'")
    ...
    assert m['version']=='4.14.0' and m['variable']=='surface-currents' and m['source']=='copernicus-marine'
...
def main():
    ...
    print(json.dumps({'browser':path,'results':[r1,r2]},indent=2)); print('PASS: v4.14.0 Global Ocean Intelligence passed direct and iframe interaction.'); sys.stdout.flush(); os._exit(0)
