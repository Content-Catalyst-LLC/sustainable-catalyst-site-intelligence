#!/usr/bin/env python3
"""Network-independent Chromium validation for v3.27.0 bootstrap ownership and loading recovery."""
...
def shell(deadline=600):
    return f'''<!doctype html><html><body><div id="launchScreen"><p id="launchMessage">Opening</p><span id="launchProgressBar"></span><button id="launchRetry" hidden>Retry</button></div><div id="app" class="app-loading" data-scsi-release="3.27.0" data-scsi-startup-deadline-ms="{deadline}"></div></body></html>'''
...
def main():
    ...
    print(json.dumps(results,indent=2));print('PASS: v3.27.0 single-owner bootstrap and bounded loading recovery passed all startup conditions.');return 0
