...
for token in ('data-truth-v32371.css?v=3.23.7.1','data-truth-v32371.js?v=3.23.7.1'):assert token in html
assert 'data-truth-v32371.js' in worker and 'Version: 3.23.7.1' in php
...
print('Site Intelligence v3.23.7.1 country selector hydration release contract passed.')
