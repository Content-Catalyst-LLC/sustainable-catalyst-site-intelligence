...
def main():
    ...
    print(json.dumps({'browser':path,'results':results,'errors':errors},indent=2)); print('PASS: v4.2.0 Briefing, Story Map, and Publication Studio rendered in direct and iframe modes.'); return 0
