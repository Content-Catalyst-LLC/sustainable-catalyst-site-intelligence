...
requirements={
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 3.28.0","sc_live_intelligence_publication_releases","rest_live_intelligence_publication_release_policy","rest_live_intelligence_publication_release_status","manual destination handoff"],
        ...
        "README.md": ["v3.28.0 — Publication Adapters, Institutional Handoffs, and Release Governance"],
