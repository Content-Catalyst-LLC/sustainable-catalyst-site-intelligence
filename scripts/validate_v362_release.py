...
checks = {
    'backend/app/version.py': ['APP_VERSION = "3.8.0"', 'Connected Public Intelligence and Evidence Platform'],
    ...
    'wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php': ['Version: 3.8.0', "const VERSION = '3.8.0';", 'live_intelligence_presentation_mode', 'live_intelligence_reduced_motion_mode', 'live_intelligence_max_visible', 'data-scsi-live-announcer', 'rest_live_intelligence_presentation_policy'],
    ...
    'wordpress-plugin/sustainable-catalyst-site-intelligence/assets/sc-site-intelligence.css': ['v3.8.0 — Live Intelligence presentation', 'is-static-mode', 'is-manual-mode', 'is-mobile-stacked', 'min-height:44px'],
    'README.md': ['v3.8.0 — Live Intelligence Presentation, Motion, and Accessibility Controls', 'Current release:** v3.8.0'],
...
if manifest.get('release') != '3.8.0' or manifest.get('file_count') != len(manifest.get('files') or []):
