#!/usr/bin/env python3
"""Overview-route browser regression for the v4.36.0 Palestine navigation repair."""
...
def main() -> int:
    ...
    if not browser_path:
        print("ERROR: Chromium or Chrome is required for v4.36.0 Palestine navigation gate.")
        return 2
    try:
        from playwright.sync_api import sync_playwright
    except ImportError:
        print("ERROR: Playwright is required for v4.36.0 Palestine navigation gate.")
        return 2
...
"""
    ...
    print("PASS: v4.36.0 keeps Palestine and Israel canonical on the Overview selector even when external catalog/overview payloads attempt to swap them.")
    return 0
