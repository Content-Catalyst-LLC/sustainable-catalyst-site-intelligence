...
assert "Version: 4.39.1" in wp and "site-intelligence-v4.39.1" in wp
assert 'data-scsi-release="4.39.1"' in index
assert 'const APP_VERSION="4.39.1"' in app
...
assert 'v4.39.1' in (ROOT / "backend/app/scientific_earth_systems_observatory.py").read_text(encoding="utf-8")
assert '/app/assets/science-v240.js?v=4.39.1' in index
assert '/app/assets/ocean-observation-v4360.js?v=4.39.1' in index
assert '/app/assets/app.js?v=4.39.1' in index
assert '/app/assets/unified-platform-v4000.css?v=4.39.1' in index
...
print("PASS: v4.39.1 R4 static release validation")
