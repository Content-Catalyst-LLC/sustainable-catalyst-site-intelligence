...
def exercise(page,label):
    ...
    page.wait_for_function("window.SCSIPlanetaryV4200?.version==='4.2.0'")
    ...
    assert m['version']=='4.2.0' and m['body']=='Mars' and 'Mars Odyssey' in m['mission'] and 'Orientation only' in m['truth'] and not m['hidden']
...
def main():
    ...
    print(json.dumps({'browser':path,'results':[r1,r2]},indent=2)); print('PASS: v4.2.0 Lunar & Planetary Intelligence passed direct and iframe interaction.')
