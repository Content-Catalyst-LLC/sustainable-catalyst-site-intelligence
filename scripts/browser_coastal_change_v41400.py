...
def fixture_html():
    catalog={
      'ok':True,'version':'4.17.0','contract':'coastal-change-sea-level-blue-carbon',
      'sources':[
...
def exercise(page,label):
    ...
    page.wait_for_function("window.SCSICoastalChangeV41400?.version==='4.17.0'")
    ...
    assert m['version']=='4.17.0' and m['source']=='global-mangrove-watch' and m['indicator']=='mangrove-extent'
...
def main():
    ...
    print(json.dumps({'browser':path,'results':[r1,r2]},indent=2), flush=True); print('PASS: v4.17.0 Coastal Change passed direct and iframe interaction.', flush=True); os._exit(0)
