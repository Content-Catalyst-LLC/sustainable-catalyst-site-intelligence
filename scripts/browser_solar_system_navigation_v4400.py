...
def fixture_html():
    ...
    catalog = {
        'ok': True, 'version': '4.12.0', 'bodies': bodies,
        'missions': [
            {'id':'juno','title':'Juno'},
...
def exercise(page, label):
    ...
    page.wait_for_function("window.SCSISolarSystemV4400?.version==='4.12.0'")
...
def main():
    ...
    print('PASS: v4.12.0 Solar System Navigation & Mission Ephemeris passed direct and iframe interaction.')
    sys.stdout.flush()
    os._exit(0)
