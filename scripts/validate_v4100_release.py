...
assert 'data-scsi-release="4.5.0"' in html and 'data-scsi-orbital-contract="orbital-earth-v4100"' in html
assert 'orbital-earth-v4100.js?v=4.5.0' in html and 'orbital-earth-v4100.css?v=4.5.0' in html
