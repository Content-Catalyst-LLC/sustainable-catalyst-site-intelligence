...
assert 'data-scsi-release="4.4.0"' in html and 'data-scsi-solar-system-contract="solar-system-navigation-v4400"' in html
assert 'solar-system-navigation-v4400.js?v=4.4.0' in html and 'solar-system-navigation-v4400.css?v=4.4.0' in html
...
print(json.dumps({'version':'4.4.0','contract':o['contract'],'bodies':c['body_count'],'missions':c['mission_context_count'],'routes':nav['route_count'],'primary_areas':nav['primary_area_count'],'readiness':r['ok'],'state_sha256':s['state_sha256']},indent=2))
print('PASS: Site Intelligence v4.4.0 Solar System Navigation & Mission Ephemeris contracts are complete.')
