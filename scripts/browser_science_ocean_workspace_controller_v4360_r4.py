#!/usr/bin/env python3
"""Browser certification for v4.39.1 R4 Science/Ocean route ownership and recovery."""
...
def main()->int:
    ...
    if not browser_path:
        print('ERROR: Chromium or Chrome is required for the v4.39.1 R4 browser gate.'); return 2
    try:
        from playwright.sync_api import sync_playwright
    except ImportError:
        print('ERROR: Playwright is required for the v4.39.1 R4 browser gate.'); return 2
    ...
    with sync_playwright() as pw:
        ...
        page.wait_for_function("window.SCScienceV240?.status?.().repair === '4.39.1'",timeout=10000)
        ...
        assert science['route']=='science' and science['repair']=='4.39.1' and science['visible'],science
    ...
    print('PASS: v4.39.1 R4 keeps Ocean and Space first-class, recovers a missing Science controller, certifies six Space workspaces, transfers route ownership to Ocean, and certifies 11 visible marine systems.')
    return 0
