...
EXCLUDED_FILES = {
    ...
    'connector_operations_state_v2130.json', 'connector_operations_state_v2130.json.tmp',
    'connector_operations_history_v2130.jsonl', 'connector_operations_quarantine_v2130.jsonl',
    'live_intelligence_source_operations_state_v320.json', 'live_intelligence_source_operations_state_v320.json.tmp',
    'live_intelligence_source_operations_history_v320.jsonl',
    'live_intelligence_last_known_good_v361.json', 'live_intelligence_last_known_good_v361.json.tmp',
    'live_intelligence_rotation_state_v371.json', 'live_intelligence_rotation_state_v371.json.tmp',
    'live_intelligence_analytics_state_v372.json', 'live_intelligence_analytics_state_v372.json.tmp',
}
records = []
...
manifest = {
    ...
    'release': '3.7.2',
    'release_name': 'Analytics and Public-Value Measurement',
