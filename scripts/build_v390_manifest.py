...
EXCLUDED_PREFIXES = {
    ...
    'backend/data/live_intelligence_subscriptions_v390',
}
EXCLUDED_FILES = {
...
manifest={'schema':'sc-site-intelligence-release-manifest/1.0','release':'3.9.0','release_name':'Signal Subscriptions, Alerts, and Scheduled Intelligence','file_count':len(files),'files':files}
