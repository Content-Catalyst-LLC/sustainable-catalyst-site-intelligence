...
assert 'data-scsi-release="4.7.0"' in html and 'data-scsi-astronomical-contract="astronomical-observation-v4300"' in html
assert 'astronomical-observation-v4300.js?v=4.7.0' in html and 'astronomical-observation-v4300.css?v=4.7.0' in html
...
print(json.dumps({'version':'4.7.0','contract':o['contract'],'surveys':c['survey_count'],'targets':c['target_count'],'routes':nav['route_count'],'primary_areas':nav['primary_area_count'],'readiness':r['ok'],'state_sha256':s['state_sha256']},indent=2))
print('PASS: Site Intelligence v4.7.0 Astronomical Observation Environment contracts are complete.')
