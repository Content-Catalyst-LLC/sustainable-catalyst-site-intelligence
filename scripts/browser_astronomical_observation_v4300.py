...
def exercise(page,label):
    ...
    page.wait_for_function("window.SCSIAstronomicalV4300?.version==='4.15.0'")
    ...
    assert m['version']=='4.15.0' and 'Crab' in m['target'] and 'ROSAT' in m['survey'] and 'Orientation only' in m['truth'] and 'NOT SURVEY PIXELS' in m['stage'] and not m['hidden']
...
def main():
    ...
    print('PASS: v4.15.0 Astronomical Observation Environment passed direct and iframe interaction.')
