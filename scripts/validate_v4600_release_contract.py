...
c=TestClient(app)
p=c.get('/public/water-column').json(); assert p['ok'] and p['version']=='4.13.0' and p['contract']=='water-column-depth-explorer'
...
print('PASS: v4.13.0 water-column release contract')
