...
assert o.get('ok') and o.get('version')=='4.31.0' and o.get('contract')=='global-mining-mineral-resources-critical-materials-intelligence' and o.get('route')=='earth' and o.get('source_count')==4
...
print('PASS: v4.31.0 mining / mineral resources / critical-materials release contract')
