...
requirements = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 3.23.3", "sc_live_intelligence_change_history",
    ...
    "README.md": ["v3.23.3 — Corrections, Retractions, and Public Change History"],
    ...
    "docs/RELEASE_MANIFEST_V3140.json": [
        '"version": "3.23.3"', '"original_release_retained": true',
