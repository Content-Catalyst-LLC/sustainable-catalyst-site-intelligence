...
requirements = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 3.22.9", "sc_live_intelligence_change_history",
    ...
    "README.md": ["v3.22.9 — Corrections, Retractions, and Public Change History"],
    ...
    "docs/RELEASE_MANIFEST_V3140.json": [
        '"version": "3.22.9"', '"original_release_retained": true',
