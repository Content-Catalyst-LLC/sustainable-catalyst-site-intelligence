...
requirements = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 4.8.0", "sc_live_intelligence_change_history",
    ...
    "README.md": ["v4.8.0 — Corrections, Retractions, and Public Change History"],
    ...
    "docs/RELEASE_MANIFEST_V3140.json": [
        '"version": "4.8.0"', '"original_release_retained": true',
