...
req('const VERSION="4.39.1"' in uw,'underwater browser controller not 4.39.1')
...
req('/app/assets/app.js?v=4.39.1' in html,'current router cache lineage is not 4.39.1')
...
if errors:
    ...
    raise SystemExit(1)
print('PASS: v4.39.1 Live Underwater Media Discovery release contract')
