...
req('const VERSION="4.38.0"' in uw,'underwater browser controller not 4.38.0')
...
req('/app/assets/app.js?v=4.38.0' in html,'current router cache lineage is not 4.38.0')
...
if errors:
    ...
    raise SystemExit(1)
print('PASS: v4.38.0 Live Underwater Media Discovery release contract')
