...
req('APP_VERSION = "4.37.0"' in version,'backend APP_VERSION is not 4.37.0')
req('Version: 4.37.0' in plugin and "site-intelligence-v4.37.0" in plugin,'WordPress release identity mismatch')
...
req('const VERSION="4.37.0"' in uw,'underwater browser controller not 4.37.0')
...
req('/app/assets/app.js?v=4.37.0' in html,'current router cache lineage is not 4.37.0')
...
if errors:
    ...
    raise SystemExit(1)
print('PASS: v4.37.0 Live Underwater Media Discovery release contract')
