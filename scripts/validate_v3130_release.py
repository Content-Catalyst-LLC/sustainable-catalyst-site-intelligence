...
requirements={
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 4.16.0", "sc_live_intelligence_release_operations",
    ...
    "README.md": ["v4.16.0 — Release Monitoring, Rollback, and Post-Publication Governance"],
    ...
    "docs/RELEASE_MANIFEST_V3130.json": [
        '"version": "4.16.0"', '"network_fetch_performed": false',
