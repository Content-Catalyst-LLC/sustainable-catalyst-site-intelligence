...
requirements={
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 3.23.7.1", "sc_live_intelligence_release_operations",
    ...
    "README.md": ["v3.23.7.1 — Release Monitoring, Rollback, and Post-Publication Governance"],
    ...
    "docs/RELEASE_MANIFEST_V3130.json": [
        '"version": "3.23.7.1"', '"network_fetch_performed": false',
