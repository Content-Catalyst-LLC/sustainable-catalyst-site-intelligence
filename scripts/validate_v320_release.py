...
checks = {
    ...
    'wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php': [
        'Version: 3.4.0', "const VERSION = '3.4.0';", 'Signal source operations',
    ...
    'README.md': ['v3.4.0 — Signal Source Operations', 'Current release:** v3.4.0'],
...
if registry.get('version') != '3.4.0' or len(registry.get('sources', [])) != 8:
