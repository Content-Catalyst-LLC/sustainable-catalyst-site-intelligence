...
checks = {
    'backend/app/version.py': ['APP_VERSION = "3.3.0"', 'Connected Public Intelligence and Evidence Platform'],
    ...
    'wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php': [
        'Version: 3.3.0', "const VERSION = '3.3.0';", 'Signal source operations',
    ...
    'README.md': ['v3.3.0 — Signal Source Operations', 'Current release:** v3.3.0'],
...
if registry.get('version') != '3.3.0' or len(registry.get('sources', [])) != 8:
...
print('Site Intelligence v3.3.0 release contract passed.')
