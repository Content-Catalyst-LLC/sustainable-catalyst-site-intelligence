...
def fixture_html():
    catalog={
      'ok':True,'version':'4.10.0','contract':'seafloor-bathymetric-intelligence',
      'sources':[
...
def exercise(page,label):
    ...
    page.wait_for_function("window.SCSISeafloorV4700?.version==='4.10.0'")
    ...
    assert m['version']=='4.10.0' and m['layer']=='multibeam-coverage' and m['source']=='noaa-ncei-bathymetry'
...
def main():
    ...
    print(json.dumps({'browser':path,'results':[r1,r2]},indent=2)); print('PASS: v4.10.0 Seafloor & Bathymetric Intelligence passed direct and iframe interaction.'); sys.stdout.flush(); os._exit(0)
