...
required={
 ...
 'backend/public_app/index.html':['data-truth-v3233.css?v=3.23.6','data-truth-v3233.js?v=3.23.6'],
 'backend/public_app/service-worker.js':['const RELEASE="3.23.6"','data-truth-v3233.js'],
 'wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php':['Version: 3.23.6','dataTruthJsUrl'],
...
if not payload.get('ok') or payload.get('version')!='3.23.6' or payload.get('source_count')!=8: raise SystemExit('Data truth endpoint failed')
...
print('Site Intelligence v3.23.6 data truth release contract passed.')
