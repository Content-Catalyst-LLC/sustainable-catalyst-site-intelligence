...
required={
 ...
 'backend/public_app/index.html':['data-truth-v32371.css?v=3.28.0','data-truth-v32371.js?v=3.28.0'],
 'backend/public_app/service-worker.js':['const RELEASE="3.28.0"','data-truth-v32371.js'],
 'wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php':['Version: 3.28.0','dataTruthJsUrl'],
...
if not payload.get('ok') or payload.get('version')!='3.28.0' or payload.get('source_count')!=8: raise SystemExit('Data truth endpoint failed')
...
print('Site Intelligence v3.28.0 data truth release contract passed.')
