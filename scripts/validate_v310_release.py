...
checks={
"backend/app/version.py":["APP_VERSION = \"3.1.0\"","Connected Public Intelligence and Evidence Platform"],
...
"wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php":["Version: 3.1.0","sc_live_intelligence","astra_header_after","show_top_live_intelligence"],
...
print("Site Intelligence v3.1.0 release contract passed.")
