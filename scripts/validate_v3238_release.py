...
assert indicator['ok'] and indicator['version']=='4.3.0'
...
for token in ('record-provenance-v3238.css?v=4.3.0','record-provenance-v3238.js?v=4.3.0','mapLayerTruthButton'): assert token in html
...
print('Site Intelligence v4.3.0 record provenance and indicator truth release contract passed.')
