...
for token in ('record-provenance-v3238.css?v=3.27.0','record-provenance-v3238.js?v=3.27.0','mapLayerTruthButton'): assert token in html
...
print('Site Intelligence v3.27.0 record provenance and indicator truth release contract passed.')
