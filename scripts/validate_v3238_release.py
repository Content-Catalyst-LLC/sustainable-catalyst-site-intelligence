...
for token in ('record-provenance-v3238.css?v=4.8.0','record-provenance-v3238.js?v=4.8.0','mapLayerTruthButton'): assert token in html
...
print('Site Intelligence v4.8.0 record provenance and indicator truth release contract passed.')
