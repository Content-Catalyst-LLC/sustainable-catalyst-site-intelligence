...
required={
 ...
 'backend/public_app/index.html':['bootstrap-v32361.js?v=3.23.7','data-scsi-startup-deadline-ms="9000"'],
 ...
 'backend/public_app/service-worker.js':['const RELEASE="3.23.7"','bootstrap-v32361.js'],
 'wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php':['Version: 3.23.7'],
...
if not bootstrap.get('ok') or bootstrap.get('version')!='3.23.7' or bootstrap.get('service_worker',{}).get('registration_owner_count')!=1:raise SystemExit('Bootstrap endpoint failed')
...
print('Site Intelligence v3.23.7 single-owner bootstrap and loading recovery release contract passed.')
