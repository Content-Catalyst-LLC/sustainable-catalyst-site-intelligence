...
REQUIRED = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 3.22.0", "sc_live_intelligence_briefings", "rest_live_intelligence_briefings",
    ...
    "README.md": ["v3.22.0 — Live Intelligence Briefings, Narrative Context, and Publication Workflow"],
