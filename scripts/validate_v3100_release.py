...
REQUIRED = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 3.23.6", "sc_live_intelligence_briefings", "rest_live_intelligence_briefings",
    ...
    "README.md": ["v3.23.6 — Live Intelligence Briefings, Narrative Context, and Publication Workflow"],
    ...
    "docs/RELEASE_MANIFEST_V3100.json": [
        '"version": "3.23.6"', '"automatic_publication": false',
