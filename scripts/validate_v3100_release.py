...
REQUIRED = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
        "Version: 4.5.0", "sc_live_intelligence_briefings", "rest_live_intelligence_briefings",
    ...
    "README.md": ["v4.5.0 — Live Intelligence Briefings, Narrative Context, and Publication Workflow"],
    ...
    "docs/RELEASE_MANIFEST_V3100.json": [
        '"version": "4.5.0"', '"automatic_publication": false',
