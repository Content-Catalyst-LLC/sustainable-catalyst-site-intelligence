...
REQUIRED = {
    ...
    "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 3.8.0", "rest_live_intelligence_homepage", "data-surface"],
    ...
    "README.md": ["v3.8.0 — Homepage Intelligence Gateway"],
    "RELEASE_NOTES_SITE_INTELLIGENCE_V370.md": ["Homepage Intelligence Gateway"],
    "docs/RELEASE_MANIFEST_V370.json": ["\"version\": \"3.8.0\"", "\"automatic_emergency_publication\": false"],
}
