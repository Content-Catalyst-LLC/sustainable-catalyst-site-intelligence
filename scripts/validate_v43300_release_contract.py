...
assert o.get('ok') and o.get('version')=='4.35.1' and o.get('contract')=='global-solid-waste-recycling-circular-materials-intelligence' and o.get('route')=='earth' and o.get('source_count')==4
...
print('PASS: v4.35.1 solid waste / recycling / circular-materials release contract')
