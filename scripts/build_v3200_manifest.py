...
EXCLUDED_PREFIXES = {
    ...
    'backend/data/live_intelligence_registry_governance_v3190', 'backend/backend/data',
}
EXCLUDED_FILES = {
...
manifest = {
    ...
    'release': '3.22.0',
    'release_name': 'Public Registry Discovery, Evidence Search, and Institutional Profiles',
