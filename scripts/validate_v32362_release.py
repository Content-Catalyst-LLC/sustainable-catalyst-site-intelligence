...
required={
 ...
 'scripts/browser_complete_shell_gate_v32362.py':['ERROR: Chromium or Chrome is required','SCSIDataTruthV3237','SCSIProductionTruthV3231'],
...
if not contract.get('ok') or contract.get('version')!='3.23.7' or not contract.get('complete_shell_gate',{}).get('required'):raise SystemExit('Mutation observer endpoint failed.')
...
print('Site Intelligence v3.23.7 mutation observer recovery and complete-shell browser gate contract passed.')
