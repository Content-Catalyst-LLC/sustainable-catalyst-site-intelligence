...
if not contract.get('ok') or contract.get('version')!='3.31.0' or not contract.get('complete_shell_gate',{}).get('required'):raise SystemExit('Mutation observer endpoint failed.')
...
print('Site Intelligence v3.31.0 mutation observer recovery and complete-shell browser gate contract passed.')
