...
if not contract.get('ok') or contract.get('version')!='4.1.0' or not contract.get('complete_shell_gate',{}).get('required'):raise SystemExit('Mutation observer endpoint failed.')
...
print('Site Intelligence v4.1.0 mutation observer recovery and complete-shell browser gate contract passed.')
