...
```bash
cd ~/Downloads
unzip -o sustainable-catalyst-site-intelligence-v3.20.0-release-bundle.zip
...
Upload and activate `sustainable-catalyst-site-intelligence-v3.20.0-wordpress.zip`, then place:
