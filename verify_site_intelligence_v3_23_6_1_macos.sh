...
printf '\n==> Verifying v3.24.0 single-owner bootstrap and loading recovery\n'
...
printf '\n==> Running complete inherited and v3.24.0 test suite\n'
(
  cd "$BACKEND"
...
printf '\nSUCCESS: Site Intelligence v3.24.0 passed single-owner bootstrap and loading recovery validation.\nRepository: %s\n' "$ROOT"
