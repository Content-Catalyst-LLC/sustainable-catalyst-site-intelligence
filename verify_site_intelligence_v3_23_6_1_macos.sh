...
printf '\n==> Verifying v3.26.0 single-owner bootstrap and loading recovery\n'
...
printf '\nSUCCESS: Site Intelligence v3.26.0 passed single-owner bootstrap and loading recovery validation.\nRepository: %s\n' "$ROOT"
