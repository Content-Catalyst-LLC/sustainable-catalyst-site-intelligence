...
printf '\n==> Verifying v4.4.0 single-owner bootstrap and loading recovery\n'
...
printf '\nSUCCESS: Site Intelligence v4.4.0 passed single-owner bootstrap and loading recovery validation.\nRepository: %s\n' "$ROOT"
