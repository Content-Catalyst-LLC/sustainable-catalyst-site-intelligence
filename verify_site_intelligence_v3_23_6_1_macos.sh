...
printf '\n==> Verifying v3.23.8 single-owner bootstrap and loading recovery\n'
...
printf '\n==> Running complete inherited and v3.23.8 test suite\n'
(
  cd "$BACKEND"
...
printf '\nSUCCESS: Site Intelligence v3.23.8 passed single-owner bootstrap and loading recovery validation.\nRepository: %s\n' "$ROOT"
