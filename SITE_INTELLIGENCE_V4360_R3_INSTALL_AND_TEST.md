# Site Intelligence v4.38.0 R3 — Install & Test
...
After backend promotion, upload the R3 WordPress plugin ZIP and choose **Replace current with uploaded**. WordPress runtime version remains `4.38.0`, so the administrative version number alone will not distinguish R3 from earlier repairs.
