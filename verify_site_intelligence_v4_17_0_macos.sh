...
for endpoint in /public/orbital-earth /public/planetary-intelligence /public/astronomical-observation /public/solar-system-navigation /public/ocean-intelligence /public/water-column /public/seafloor-intelligence /public/underwater-observation /public/marine-biodiversity /public/ocean-missions /public/ocean-events /public/marine-human-activity /public/marine-pollution /public/marine-pollution/readiness /public/coastal-change /public/coastal-change/catalog /public/coastal-change/state /public/coastal-change/water-level/normalize /public/coastal-change/shoreline/normalize /public/coastal-change/habitat/normalize /public/coastal-change/scenario/preview /public/coastal-change/export-manifest /public/coastal-change/readiness /public/ocean-governance /public/ocean-governance/catalog /public/ocean-governance/state /public/ocean-governance/zone/normalize /public/ocean-governance/management-area/normalize /public/ocean-governance/overlap/preview /public/ocean-governance/export-manifest /public/ocean-governance/readiness /public/cryosphere /public/cryosphere/catalog /public/cryosphere/state /public/cryosphere/measurement/normalize /public/cryosphere/feature/normalize /public/cryosphere/anomaly/preview /public/cryosphere/export-manifest /public/cryosphere/readiness /public/atmosphere /public/atmosphere/catalog /public/atmosphere/state /public/atmosphere/measurement/normalize /public/atmosphere/forecast/normalize /public/atmosphere/threshold/preview /public/atmosphere/export-manifest /public/atmosphere/readiness /public/v4/readiness; do grep -q "$endpoint" "$BACKEND/app/main.py"; done
for asset in ocean-surface-v4500 water-column-v4600 seafloor-bathymetry-v4700 underwater-observation-v4800 marine-biodiversity-v4900 ocean-missions-v41000 ocean-events-v41100 marine-human-activity-v41200 marine-pollution-v41300 coastal-change-v41400 ocean-governance-v41500 cryosphere-v41600 atmosphere-v41700; do
...
"$PYTHON" "$ROOT/scripts/validate_v41700_release.py"
...
PY
if command -v node >/dev/null 2>&1; then node "$ROOT/scripts/check_javascript_v41700.js" "$BACKEND/public_app" "$ROOT/wordpress-plugin/sustainable-catalyst-site-intelligence/assets"; fi
...
if [[ "${SC_SI_RUN_BROWSER:-0}" == "1" ]]; then PYTHON="$PYTHON" "$PYTHON" "$ROOT/scripts/browser_atmosphere_v41700.py"; fi
echo 'SUCCESS: Site Intelligence v4.17.0 passed Global Atmosphere, Air Quality & Aerosol Intelligence validation.'
