...
printf '\n==> Validating v4.11.0 Monitoring, Digests, and Early-Warning Operations contracts\n'
...
grep -q 'monitoring-operations-v3280.js?v=4.11.0' "$BACKEND/public_app/index.html"
...
printf '\nSUCCESS: Site Intelligence v4.11.0 passed Monitoring, Digests, and Early-Warning Operations validation.\nRepository: %s\n' "$ROOT"
