...
printf '\n==> Validating v4.13.0 Monitoring, Digests, and Early-Warning Operations contracts\n'
...
grep -q 'monitoring-operations-v3280.js?v=4.13.0' "$BACKEND/public_app/index.html"
...
printf '\nSUCCESS: Site Intelligence v4.13.0 passed Monitoring, Digests, and Early-Warning Operations validation.\nRepository: %s\n' "$ROOT"
