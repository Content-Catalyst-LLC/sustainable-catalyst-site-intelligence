...
printf '\n==> Validating v4.7.0 Monitoring, Digests, and Early-Warning Operations contracts\n'
...
grep -q 'monitoring-operations-v3280.js?v=4.7.0' "$BACKEND/public_app/index.html"
...
printf '\n==> Running complete inherited and v4.7.0 test suite\n'
reset_runtime
...
printf '\nSUCCESS: Site Intelligence v4.7.0 passed Monitoring, Digests, and Early-Warning Operations validation.\nRepository: %s\n' "$ROOT"
