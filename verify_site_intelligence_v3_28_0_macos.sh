...
printf '\n==> Validating v3.28.0 Monitoring, Digests, and Early-Warning Operations contracts\n'
...
grep -q 'monitoring-operations-v3280.js?v=3.28.0' "$BACKEND/public_app/index.html"
...
printf '\n==> Running complete inherited and v3.28.0 test suite\n'
reset_runtime
...
printf '\nSUCCESS: Site Intelligence v3.28.0 passed Monitoring, Digests, and Early-Warning Operations validation.\nRepository: %s\n' "$ROOT"
