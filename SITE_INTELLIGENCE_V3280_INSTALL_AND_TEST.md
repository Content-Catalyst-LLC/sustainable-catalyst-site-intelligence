...
The mandatory v4.12.0 browser gates cover Monitoring Operations, Research Integration, comparative/model assurance, country-selector interaction and hydration, complete-shell initialization, production soak, service-worker closure, and fixed WordPress embed isolation.

Install the WordPress ZIP only after the live GitHub/Render gate reports success for the exact v4.12.0 commit and release id.
