# Site Intelligence v3.23.6.2 performance and offline audit
...
11. **WordPress isolation** — v3.23.6.2 assets are available to the embedded app but are not enqueued as application runtimes in the WordPress host page.
