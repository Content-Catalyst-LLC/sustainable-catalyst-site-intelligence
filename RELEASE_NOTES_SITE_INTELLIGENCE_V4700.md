# Site Intelligence v4.11.0 — Seafloor & Bathymetric Intelligence

v4.11.0 extends the Earth Observation ocean sequence from the water column to the seabed while preserving the v4 six-area / 35-route platform architecture.
