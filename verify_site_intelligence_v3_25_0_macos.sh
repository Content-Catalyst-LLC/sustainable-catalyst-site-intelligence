...
grep -q 'cross-view-state-v3250.js?v=3.25.0' "$BACKEND/public_app/index.html"
...
printf '\nSUCCESS: Site Intelligence v3.25.0 passed unified analytical workspace and cross-view state validation.\nRepository: %s\n' "$ROOT"
