# Site Intelligence v4.11.0 — Underwater Observation & Visual Evidence

v4.11.0 extends the existing Earth Observation chain from seafloor terrain into source-attributed underwater visual observations without adding a new top-level route.
