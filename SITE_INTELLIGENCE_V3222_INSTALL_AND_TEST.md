# Site Intelligence v3.22.5 Installation and Test Guide
...
BUNDLE="$(ls -t sustainable-catalyst-site-intelligence-v3.22.5-release-bundle*.zip | head -1)"
...
3. Upload `sustainable-catalyst-site-intelligence-v3.22.5-wordpress-plugin.zip`.
