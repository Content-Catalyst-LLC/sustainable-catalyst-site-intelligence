# Site Intelligence v3.22.6 Installation and Test Guide
...
BUNDLE="$(ls -t sustainable-catalyst-site-intelligence-v3.22.6-release-bundle*.zip | head -1)"
...
3. Upload `sustainable-catalyst-site-intelligence-v3.22.6-wordpress-plugin.zip`.
