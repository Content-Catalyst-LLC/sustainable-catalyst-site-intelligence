# Site Intelligence v3.22.9 Installation and Test Guide
...
BUNDLE="$(ls -t sustainable-catalyst-site-intelligence-v3.22.9-release-bundle*.zip | head -1)"
...
```text
854 passed
SUCCESS: Site Intelligence v3.22.9 passed local validation.
```
...
3. Upload `sustainable-catalyst-site-intelligence-v3.22.9-wordpress-plugin.zip`.
