# Site Intelligence v3.22.4 Installation and Test Guide
...
BUNDLE="$(ls -t sustainable-catalyst-site-intelligence-v3.22.4-release-bundle*.zip | head -1)"
...
3. Upload `sustainable-catalyst-site-intelligence-v3.22.4-wordpress-plugin.zip`.
