...
printf '
==> Verifying v4.9.0 global country data truth and coverage matrix
'
...
printf '
SUCCESS: Site Intelligence v4.9.0 passed country selector hydration and global selection repair validation.
Repository: %s
' "$ROOT"
