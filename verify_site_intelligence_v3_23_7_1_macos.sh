...
printf '
==> Verifying v3.23.8 global country data truth and coverage matrix
'
...
printf '
SUCCESS: Site Intelligence v3.23.8 passed country selector hydration and global selection repair validation.
Repository: %s
' "$ROOT"
