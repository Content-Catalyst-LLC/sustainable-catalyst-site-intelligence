...
grep -q 'data-truth-v32371.js?v=3.23.7.1' "$BACKEND/public_app/index.html"
...
printf '\n==> Running mandatory v3.23.7.1 production-soak route and service-worker gate\n'
...
printf '
SUCCESS: Site Intelligence v3.23.7.1 passed country selector hydration and global selection repair validation.
Repository: %s
' "$ROOT"
