# Site Intelligence v4.39.0 R2 — Science Workspace Core-Decoupling & Ocean/Space Discovery Repair
...
- Runtime and WordPress plugin versions remain `4.39.0`; repaired release lineage is `v4.39.0`.
