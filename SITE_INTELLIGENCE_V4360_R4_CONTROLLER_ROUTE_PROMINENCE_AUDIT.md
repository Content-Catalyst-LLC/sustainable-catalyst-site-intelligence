# Site Intelligence v4.38.0 R4 — Controller, Route Ownership & Prominence Audit
...
- The main app controller and other ownership-critical assets use `4.38.0` cache lineage.
