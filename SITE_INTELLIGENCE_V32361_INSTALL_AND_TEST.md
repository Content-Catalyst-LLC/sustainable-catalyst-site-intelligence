...
- `/public/runtime-health`, `/public/performance-offline`, and `/public/bootstrap-recovery` report v3.23.6.1.

## Emergency browser reset

When upgrading from the failed v3.23.6 session, unregister the old Site Intelligence service worker and clear site data once. v3.23.6.1 then owns subsequent updates through the single bootstrap path.
