# Install and test Site Intelligence v3.23.6.4

1. Download the v3.23.6.4 release bundle and macOS installer into `~/Downloads`.
...
- `/public/runtime-health`, `/public/performance-offline`, and `/public/bootstrap-recovery` report v3.23.6.4.

## Emergency browser reset

When upgrading from the failed v3.23.6 session, unregister the old Site Intelligence service worker and clear site data once. v3.23.6.4 then owns subsequent updates through the single bootstrap path.
