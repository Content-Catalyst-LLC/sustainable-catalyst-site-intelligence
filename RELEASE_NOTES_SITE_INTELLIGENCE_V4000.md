...
v4.13.0 is a consolidation release. It reorganizes the accumulated Site Intelligence capability set into one public intelligence platform without deleting, renaming, or silently migrating the existing public workspaces.
...
v4.13.0 identifies six shared contract families:
