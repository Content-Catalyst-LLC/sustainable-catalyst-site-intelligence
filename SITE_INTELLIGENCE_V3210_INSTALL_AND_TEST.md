...
The installer verifies the repository checksum and immutable manifest, runs the v3.21.0 release gate, validates Python/JSON/HTML/JavaScript/PHP assets, regenerates the WordPress ZIP, commits locally, and pushes only when push is enabled and the configured remote is reachable.
