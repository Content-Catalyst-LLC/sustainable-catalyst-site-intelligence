...
## macOS deployment
Place the v4.35.14 release bundle and standalone installer in `~/Downloads`, then run:
...
No new server credential is required for the five v4.35.14 connector interfaces. EPA SDWIS/Envirofacts, bounded OSM/Overpass, NIDIS public drought files, NASA CMR GPM discovery, and GloFAS public product discovery are exposed without adding a new API-key requirement in this release.
