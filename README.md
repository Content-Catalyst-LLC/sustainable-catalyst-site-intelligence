...
**v3.23.6.3 — Fixed Application Viewport and WordPress Embed Isolation**

## Current release: v3.23.6.3
...
# Site Intelligence v3.23.6.3 — Browser Reliability, Mobile, and Accessibility
...
# Site Intelligence v3.23.6.3 — Analytical Workspace Completion
...
## v3.23.6.3 — Analytical Workspace Completion
...
## v3.23.6.3 — Cartographic Workspace and Application Presentation
...
**Current release:** v3.23.6.3 — Connected Public Intelligence and Evidence Platform

## v3.23.6.3 — Resume-Safe Promotion, Deployment Receipts, and Runtime-State Isolation
...
### v3.23.6.3 deployment highlights
...
## v3.23.6.3 — Production Truth and Workspace Completion
...
## v3.23.6.3 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
## v3.23.6.3 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Prior release:** v3.23.6.3 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v3.23.6.3 publication capabilities
...
## v3.23.6.3 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v3.23.6.3 collection capabilities
...
## v3.23.6.3 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v3.23.6.3 — Signal Context and Drill-Down
- v3.23.6.3 — Topic and Regional Channels
- v3.23.6.3 — Homepage Intelligence Gateway
- v3.23.6.3 — Signal Relevance and Rotation Intelligence
- v3.23.6.3 — Analytics and Public-Value Measurement
- v3.23.6.3 — Connected Live Intelligence Surface
- v3.23.6.3 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v3.23.6.3 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v3.23.6.3 — Editorial Workspace, Review Queues, and Publication Orchestration
- v3.23.6.3 — Publication Adapters, Institutional Handoffs, and Release Governance
- v3.23.6.3 — Release Monitoring, Rollback, and Post-Publication Governance
- v3.23.6.3 — Corrections, Retractions, and Public Change History
- v3.23.6.3 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v3.23.6.3 — Archive Verification, Preservation Audits, and Institutional Custody
- v3.23.6.3 — Preservation Interoperability, External Verification, and Institutional Exchange
- v3.23.6.3 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v3.23.6.3 — Registry Governance, Challenges, Revocation, and Appeals
- v3.23.6.3 — Public Registry Discovery, Evidence Search, and Institutional Profiles
