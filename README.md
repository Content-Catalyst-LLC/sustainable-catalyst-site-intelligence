# Current release: Site Intelligence v4.35.9 — Workspace Evidence Unification & Truth-Layer Repair

Site Intelligence v4.35.9 unifies country-workspace headline values, evidence metadata, and Record Truth around one canonical observation object. The same value, reporting period, source state, semantics, freshness, lineage, and canonical SHA-256 now flow through the workspace and Truth surfaces; a separate packaged-snapshot path can no longer make Truth disagree with the displayed card. Legacy Record Provenance shapes remain compatible, and external source health remains non-blocking for deployment.

# Current release: Site Intelligence v4.35.9 — Source Precedence, Metric Semantics & Freshness Intelligence

Site Intelligence v4.35.9 adds a deterministic evidence-selection layer above the authoritative connector catalog. It registers explicit metric concepts, jurisdiction-aware source precedence, cadence-aware freshness, semantic incompatibility guards, conflict disclosure, and source-selection fingerprints. Structural electricity access is now explicitly separated from current electricity availability, grid reliability, outage status, hours of service, and generator dependence. For Palestine structural electricity access, PCBS is the preferred national statistical authority when a compatible observation is available, with World Bank retained as a harmonized fallback/comparison source. Operational electricity conditions require operational evidence and cannot be answered by the World Bank access indicator.
...
# Current release: Site Intelligence v4.35.9 — Exoplanets, Habitability & Atmospheric Biosignature Intelligence

Site Intelligence v4.35.9 extends the existing Astronomy / Space environment with source-bounded SETI observations, radio-signal event metadata, published search coverage and exoplanet target context. Signal events and candidate labels are not confirmation of extraterrestrial intelligence; non-detections are not absence findings; and announcement authority is never inferred. The six-area / 35-route public architecture remains unchanged, and SETI assets lazy-load to preserve the inherited application-shell performance budget.


Site Intelligence v4.35.9 extends the Earth/infrastructure continuum with source-bounded solid-waste, hazardous-waste regulatory, recycling and circular-material statistics. Mapped infrastructure is not operating status; regulatory records are not new compliance findings; statistical recycling rates are not material-circularity certification; and projections are not observations. The six-area / 35-route public architecture remains unchanged.

# Site Intelligence v4.35.9

Current release: Global Industrial Facilities, Manufacturing & Trade-Flow Intelligence.


## Site Intelligence v4.35.9 — Digital Connectivity

v4.35.9 adds a source-aware digital-connectivity layer spanning telecommunications infrastructure, sampled Internet performance, national connectivity statistics, and provider-reported broadband availability while preserving the existing public architecture and evidence-truth boundaries.

# Site Intelligence v4.35.9 — Global Transportation Networks, Ports, Airports & Transit Intelligence
...
# Site Intelligence v4.35.9 — Global Human Settlements, Urbanization & Built Environment Intelligence
...
# Site Intelligence v4.35.9 — Agriculture, Crops & Food-System Conditions Intelligence

Site Intelligence v4.35.9 extends Earth Observation into agricultural statistics, crop-condition remote sensing and consensus crop assessments while preserving evidence type, provenance and non-inference boundaries.

# Site Intelligence v4.35.9 — Wetlands, Inland Waters & Aquatic Habitat Intelligence

Site Intelligence v4.35.9 adds Global Biodiversity, Species Distribution & Conservation Intelligence while preserving the six-area / 35-route public architecture.

# Site Intelligence v4.35.9 — Global Soils, Land Degradation & Desertification Intelligence
...
# Site Intelligence v4.35.9 — Global Geosphere, Earthquake & Volcano Intelligence
...
# Site Intelligence v4.35.9 — Global Hydrology, Rivers, Flood & Drought Intelligence
...
# Site Intelligence v4.35.9 — Global Cryosphere Intelligence & Frozen-Earth Conditions
...
# Site Intelligence v4.35.9 — Ocean Governance, Jurisdiction & Maritime Boundaries
...
# Site Intelligence v4.35.9 — Coastal Change, Sea Level & Blue-Carbon Intelligence
...
# Site Intelligence v4.35.9 — Marine Pollution, Debris & Water-Quality Intelligence
...
# Site Intelligence v4.35.9 — Ocean Missions, Vehicles & Observatory Network
...
# Site Intelligence v4.35.9 — Marine Biodiversity & Bioacoustic Intelligence
...
# Site Intelligence v4.35.9 — Unified Public Intelligence Platform

Site Intelligence v4.35.9 consolidates the existing 35 public workspaces into six primary areas while preserving legacy routes, deep links, Data Truth, record provenance, analytical state, assurance, human-reviewed publication, and production-governance boundaries. No legacy public route is removed in this release.

# Site Intelligence v4.35.9 — Security, Observability, Performance, and Scale Assurance
...
# Site Intelligence v4.35.9 — Global Data Truth Control Plane
...
# Current release: Site Intelligence v4.35.9
...
**v4.35.9 — Fixed Application Viewport and WordPress Embed Isolation**

## Current release: v4.35.9
...
# Site Intelligence v4.35.9 — Browser Reliability, Mobile, and Accessibility
...
# Site Intelligence v4.35.9 — Analytical Workspace Completion
...
## v4.35.9 — Analytical Workspace Completion
...
## v4.35.9 — Cartographic Workspace and Application Presentation
...
**Current release:** v4.35.9 — Connected Public Intelligence and Evidence Platform

## v4.35.9 — Resume-Safe Promotion, Deployment Receipts, and Runtime-State Isolation
...
## v4.35.9 — Global Energy Infrastructure, Power Systems & Electricity Intelligence
...
## v4.35.9 — Production Truth and Workspace Completion
...
## v4.35.9 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
## v4.35.9 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Prior release:** v4.35.9 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v4.35.9 publication capabilities
...
## v4.35.9 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v4.35.9 collection capabilities
...
## v4.35.9 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v4.35.9 — Signal Context and Drill-Down
- v4.35.9 — Topic and Regional Channels
- v4.35.9 — Homepage Intelligence Gateway
- v4.35.9 — Signal Relevance and Rotation Intelligence
- v4.35.9 — Analytics and Public-Value Measurement
- v4.35.9 — Connected Live Intelligence Surface
- v4.35.9 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v4.35.9 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v4.35.9 — Editorial Workspace, Review Queues, and Publication Orchestration
- v4.35.9 — Publication Adapters, Institutional Handoffs, and Release Governance
- v4.35.9 — Release Monitoring, Rollback, and Post-Publication Governance
- v4.35.9 — Corrections, Retractions, and Public Change History
- v4.35.9 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v4.35.9 — Archive Verification, Preservation Audits, and Institutional Custody
- v4.35.9 — Preservation Interoperability, External Verification, and Institutional Exchange
- v4.35.9 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v4.35.9 — Registry Governance, Challenges, Revocation, and Appeals
- v4.35.9 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
### v4.35.9 Underwater Observation & Visual Evidence
...
## v4.35.9 — Marine Human Activity, Protected Areas & Maritime Pressure
...
## v4.35.9 — Terrestrial Ecosystems, Vegetation & Wildfire Intelligence
