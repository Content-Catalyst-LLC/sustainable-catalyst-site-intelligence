# Site Intelligence v3.24.0 — Global Data Truth Control Plane
...
# Current release: Site Intelligence v3.24.0
...
**v3.24.0 — Fixed Application Viewport and WordPress Embed Isolation**
...
# Site Intelligence v3.24.0 — Browser Reliability, Mobile, and Accessibility
...
# Site Intelligence v3.24.0 — Analytical Workspace Completion
...
## v3.24.0 — Analytical Workspace Completion
...
## v3.24.0 — Cartographic Workspace and Application Presentation
...
**Current release:** v3.24.0 — Connected Public Intelligence and Evidence Platform

## v3.24.0 — Resume-Safe Promotion, Deployment Receipts, and Runtime-State Isolation
...
## v3.24.0 — Production Truth and Workspace Completion
...
## v3.24.0 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
## v3.24.0 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Prior release:** v3.24.0 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v3.24.0 publication capabilities
...
## v3.24.0 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v3.24.0 collection capabilities
...
## v3.24.0 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v3.24.0 — Signal Context and Drill-Down
- v3.24.0 — Topic and Regional Channels
- v3.24.0 — Homepage Intelligence Gateway
- v3.24.0 — Signal Relevance and Rotation Intelligence
- v3.24.0 — Analytics and Public-Value Measurement
- v3.24.0 — Connected Live Intelligence Surface
- v3.24.0 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v3.24.0 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v3.24.0 — Editorial Workspace, Review Queues, and Publication Orchestration
- v3.24.0 — Publication Adapters, Institutional Handoffs, and Release Governance
- v3.24.0 — Release Monitoring, Rollback, and Post-Publication Governance
- v3.24.0 — Corrections, Retractions, and Public Change History
- v3.24.0 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v3.24.0 — Archive Verification, Preservation Audits, and Institutional Custody
- v3.24.0 — Preservation Interoperability, External Verification, and Institutional Exchange
- v3.24.0 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v3.24.0 — Registry Governance, Challenges, Revocation, and Appeals
- v3.24.0 — Public Registry Discovery, Evidence Search, and Institutional Profiles
