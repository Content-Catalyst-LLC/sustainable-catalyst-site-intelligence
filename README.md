# Site Intelligence v3.23.7.1 — Country Selector Hydration and Global Selection Repair

The global country catalog now hydrates the main selector during every startup route, preserves valid URL-selected countries, and synchronizes selection with Global Data Truth.

# Current release: Site Intelligence v3.23.7.1
...
**v3.23.7.1 — Fixed Application Viewport and WordPress Embed Isolation**

## Current release: v3.23.7.1
...
# Site Intelligence v3.23.7.1 — Browser Reliability, Mobile, and Accessibility
...
# Site Intelligence v3.23.7.1 — Analytical Workspace Completion
...
## v3.23.7.1 — Analytical Workspace Completion
...
## v3.23.7.1 — Cartographic Workspace and Application Presentation
...
**Current release:** v3.23.7.1 — Connected Public Intelligence and Evidence Platform

## v3.23.7.1 — Resume-Safe Promotion, Deployment Receipts, and Runtime-State Isolation
...
### v3.23.7.1 deployment highlights
...
## v3.23.7.1 — Production Truth and Workspace Completion
...
## v3.23.7.1 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
## v3.23.7.1 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Prior release:** v3.23.7.1 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v3.23.7.1 publication capabilities
...
## v3.23.7.1 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v3.23.7.1 collection capabilities
...
## v3.23.7.1 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v3.23.7.1 — Signal Context and Drill-Down
- v3.23.7.1 — Topic and Regional Channels
- v3.23.7.1 — Homepage Intelligence Gateway
- v3.23.7.1 — Signal Relevance and Rotation Intelligence
- v3.23.7.1 — Analytics and Public-Value Measurement
- v3.23.7.1 — Connected Live Intelligence Surface
- v3.23.7.1 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v3.23.7.1 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v3.23.7.1 — Editorial Workspace, Review Queues, and Publication Orchestration
- v3.23.7.1 — Publication Adapters, Institutional Handoffs, and Release Governance
- v3.23.7.1 — Release Monitoring, Rollback, and Post-Publication Governance
- v3.23.7.1 — Corrections, Retractions, and Public Change History
- v3.23.7.1 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v3.23.7.1 — Archive Verification, Preservation Audits, and Institutional Custody
- v3.23.7.1 — Preservation Interoperability, External Verification, and Institutional Exchange
- v3.23.7.1 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v3.23.7.1 — Registry Governance, Challenges, Revocation, and Appeals
- v3.23.7.1 — Public Registry Discovery, Evidence Search, and Institutional Profiles
