# Site Intelligence v3.23.2 — Cartographic Interaction and Layer Control
...
## v3.23.2 — Cartographic Interaction and Layer Control
...
**Current release:** v3.23.2 — Connected Public Intelligence and Evidence Platform

## v3.23.2 — Resume-Safe Promotion, Deployment Receipts, and Runtime-State Isolation
...
## v3.23.2 — Production Truth and Workspace Completion
...
## v3.23.2 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
## v3.23.2 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Prior release:** v3.23.2 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v3.23.2 publication capabilities
...
## v3.23.2 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v3.23.2 collection capabilities
...
## v3.23.2 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v3.23.2 — Signal Context and Drill-Down
- v3.23.2 — Topic and Regional Channels
- v3.23.2 — Homepage Intelligence Gateway
- v3.23.2 — Signal Relevance and Rotation Intelligence
- v3.23.2 — Analytics and Public-Value Measurement
- v3.23.2 — Connected Live Intelligence Surface
- v3.23.2 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v3.23.2 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v3.23.2 — Editorial Workspace, Review Queues, and Publication Orchestration
- v3.23.2 — Publication Adapters, Institutional Handoffs, and Release Governance
- v3.23.2 — Release Monitoring, Rollback, and Post-Publication Governance
- v3.23.2 — Corrections, Retractions, and Public Change History
- v3.23.2 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v3.23.2 — Archive Verification, Preservation Audits, and Institutional Custody
- v3.23.2 — Preservation Interoperability, External Verification, and Institutional Exchange
- v3.23.2 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v3.23.2 — Registry Governance, Challenges, Revocation, and Appeals
- v3.23.2 — Public Registry Discovery, Evidence Search, and Institutional Profiles
