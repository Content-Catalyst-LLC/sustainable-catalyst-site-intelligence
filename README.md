...
Site Intelligence now preserves country, comparison, indicator, imagery, date, and spatial selections across Overview, Global Conditions, Country Intelligence, Compare, Spatial Evidence, and Earth Observation. Route-specific deep links remain portable and transparent without pretending to freeze live data.

The release adds a normalized public state contract, cross-workspace handoffs, browser-local persistence, a compact analytical-state bar, and mandatory direct/iframe browser validation while preserving Global Data Truth, Record Provenance, country-selector interaction, production soak, service-worker closure, and WordPress embed isolation.
...
# Current release: Site Intelligence v3.26.0
...
**v3.26.0 — Fixed Application Viewport and WordPress Embed Isolation**
...
# Site Intelligence v3.26.0 — Browser Reliability, Mobile, and Accessibility
...
# Site Intelligence v3.26.0 — Analytical Workspace Completion
...
## v3.26.0 — Analytical Workspace Completion
...
## v3.26.0 — Cartographic Workspace and Application Presentation
...
**Current release:** v3.26.0 — Connected Public Intelligence and Evidence Platform

## v3.26.0 — Resume-Safe Promotion, Deployment Receipts, and Runtime-State Isolation
...
## v3.26.0 — Production Truth and Workspace Completion
...
## v3.26.0 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
## v3.26.0 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Prior release:** v3.26.0 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v3.26.0 publication capabilities
...
## v3.26.0 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v3.26.0 collection capabilities
...
## v3.26.0 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v3.26.0 — Signal Context and Drill-Down
- v3.26.0 — Topic and Regional Channels
- v3.26.0 — Homepage Intelligence Gateway
- v3.26.0 — Signal Relevance and Rotation Intelligence
- v3.26.0 — Analytics and Public-Value Measurement
- v3.26.0 — Connected Live Intelligence Surface
- v3.26.0 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v3.26.0 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v3.26.0 — Editorial Workspace, Review Queues, and Publication Orchestration
- v3.26.0 — Publication Adapters, Institutional Handoffs, and Release Governance
- v3.26.0 — Release Monitoring, Rollback, and Post-Publication Governance
- v3.26.0 — Corrections, Retractions, and Public Change History
- v3.26.0 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v3.26.0 — Archive Verification, Preservation Audits, and Institutional Custody
- v3.26.0 — Preservation Interoperability, External Verification, and Institutional Exchange
- v3.26.0 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v3.26.0 — Registry Governance, Challenges, Revocation, and Appeals
- v3.26.0 — Public Registry Discovery, Evidence Search, and Institutional Profiles
