# Site Intelligence v3.23.8 — Record Provenance and Indicator Truth

Site Intelligence now exposes record-level truth for indicators, events, map layers, charts, and table records. Each disclosed record can show source, observation and retrieval dates, units, transformations, geographic context, limitations, and a deterministic SHA-256 fingerprint. The fingerprint detects changes to the disclosed canonical record; it is not a certification of upstream accuracy or authority.

The release adds a browser Record Truth drawer, country manifest export, and public record-truth endpoints while preserving Global Country Data Truth, the focus-safe country selector, service-worker stability, and WordPress embed isolation.

# Current release: Site Intelligence v3.23.8
...
**v3.23.8 — Fixed Application Viewport and WordPress Embed Isolation**

## Current release: v3.23.8
...
# Site Intelligence v3.23.8 — Browser Reliability, Mobile, and Accessibility
...
# Site Intelligence v3.23.8 — Analytical Workspace Completion
...
## v3.23.8 — Analytical Workspace Completion
...
## v3.23.8 — Cartographic Workspace and Application Presentation
...
**Current release:** v3.23.8 — Connected Public Intelligence and Evidence Platform

## v3.23.8 — Resume-Safe Promotion, Deployment Receipts, and Runtime-State Isolation
...
## v3.23.8 — Production Truth and Workspace Completion
...
## v3.23.8 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
## v3.23.8 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Prior release:** v3.23.8 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v3.23.8 publication capabilities
...
## v3.23.8 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v3.23.8 collection capabilities
...
## v3.23.8 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v3.23.8 — Signal Context and Drill-Down
- v3.23.8 — Topic and Regional Channels
- v3.23.8 — Homepage Intelligence Gateway
- v3.23.8 — Signal Relevance and Rotation Intelligence
- v3.23.8 — Analytics and Public-Value Measurement
- v3.23.8 — Connected Live Intelligence Surface
- v3.23.8 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v3.23.8 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v3.23.8 — Editorial Workspace, Review Queues, and Publication Orchestration
- v3.23.8 — Publication Adapters, Institutional Handoffs, and Release Governance
- v3.23.8 — Release Monitoring, Rollback, and Post-Publication Governance
- v3.23.8 — Corrections, Retractions, and Public Change History
- v3.23.8 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v3.23.8 — Archive Verification, Preservation Audits, and Institutional Custody
- v3.23.8 — Preservation Interoperability, External Verification, and Institutional Exchange
- v3.23.8 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v3.23.8 — Registry Governance, Challenges, Revocation, and Appeals
- v3.23.8 — Public Registry Discovery, Evidence Search, and Institutional Profiles
