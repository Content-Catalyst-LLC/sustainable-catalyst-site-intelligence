...
# Site Intelligence v3.23.6 — Browser Reliability, Mobile, and Accessibility
...
# Site Intelligence v3.23.6 — Analytical Workspace Completion
...
## v3.23.6 — Analytical Workspace Completion
...
**Current release:** v3.23.6 — Connected Public Intelligence and Evidence Platform

## v3.23.6 — Resume-Safe Promotion, Deployment Receipts, and Runtime-State Isolation
...
## v3.23.6 — Production Truth and Workspace Completion
...
## v3.23.6 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
## v3.23.6 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Prior release:** v3.23.6 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v3.23.6 publication capabilities
...
## v3.23.6 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v3.23.6 collection capabilities
...
## v3.23.6 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v3.23.6 — Signal Context and Drill-Down
- v3.23.6 — Topic and Regional Channels
- v3.23.6 — Homepage Intelligence Gateway
- v3.23.6 — Signal Relevance and Rotation Intelligence
- v3.23.6 — Analytics and Public-Value Measurement
- v3.23.6 — Connected Live Intelligence Surface
- v3.23.6 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v3.23.6 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v3.23.6 — Editorial Workspace, Review Queues, and Publication Orchestration
- v3.23.6 — Publication Adapters, Institutional Handoffs, and Release Governance
- v3.23.6 — Release Monitoring, Rollback, and Post-Publication Governance
- v3.23.6 — Corrections, Retractions, and Public Change History
- v3.23.6 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v3.23.6 — Archive Verification, Preservation Audits, and Institutional Custody
- v3.23.6 — Preservation Interoperability, External Verification, and Institutional Exchange
- v3.23.6 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v3.23.6 — Registry Governance, Challenges, Revocation, and Appeals
- v3.23.6 — Public Registry Discovery, Evidence Search, and Institutional Profiles
