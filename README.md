# Current release: Site Intelligence v4.35.2 — Authoritative API & Workspace Integrity Audit

**Current release:** v4.35.2 — Connected Public Intelligence and Evidence Platform (build focus: Authoritative API & Workspace Integrity Audit)

Site Intelligence v4.35.2 turns authoritative-data coverage into an explicit platform contract. It inventories registered source systems separately from implemented retrieval clients, classifies every registration as LIVE, DISCOVERY, REGISTERED, AUTH REQUIRED, BULK, STALE, or UNAVAILABLE, exposes workspace-level coverage through public audit endpoints and the Sources workspace, and migrates the ReliefWeb humanitarian connector from decommissioned V1 to V2 with an explicit server-side appname configuration gate.

# Current release: Site Intelligence v4.35.2 — Exoplanets, Habitability & Atmospheric Biosignature Intelligence

Site Intelligence v4.35.2 extends the existing Astronomy / Space environment with source-bounded SETI observations, radio-signal event metadata, published search coverage and exoplanet target context. Signal events and candidate labels are not confirmation of extraterrestrial intelligence; non-detections are not absence findings; and announcement authority is never inferred. The six-area / 35-route public architecture remains unchanged, and SETI assets lazy-load to preserve the inherited application-shell performance budget.


Site Intelligence v4.35.2 extends the Earth/infrastructure continuum with source-bounded solid-waste, hazardous-waste regulatory, recycling and circular-material statistics. Mapped infrastructure is not operating status; regulatory records are not new compliance findings; statistical recycling rates are not material-circularity certification; and projections are not observations. The six-area / 35-route public architecture remains unchanged.

# Site Intelligence v4.35.2

Current release: Global Industrial Facilities, Manufacturing & Trade-Flow Intelligence.


## Site Intelligence v4.35.2 — Digital Connectivity

v4.35.2 adds a source-aware digital-connectivity layer spanning telecommunications infrastructure, sampled Internet performance, national connectivity statistics, and provider-reported broadband availability while preserving the existing public architecture and evidence-truth boundaries.

# Site Intelligence v4.35.2 — Global Transportation Networks, Ports, Airports & Transit Intelligence
...
# Site Intelligence v4.35.2 — Global Human Settlements, Urbanization & Built Environment Intelligence
...
# Site Intelligence v4.35.2 — Agriculture, Crops & Food-System Conditions Intelligence

Site Intelligence v4.35.2 extends Earth Observation into agricultural statistics, crop-condition remote sensing and consensus crop assessments while preserving evidence type, provenance and non-inference boundaries.

# Site Intelligence v4.35.2 — Wetlands, Inland Waters & Aquatic Habitat Intelligence

Site Intelligence v4.35.2 adds Global Biodiversity, Species Distribution & Conservation Intelligence while preserving the six-area / 35-route public architecture.

# Site Intelligence v4.35.2 — Global Soils, Land Degradation & Desertification Intelligence
...
# Site Intelligence v4.35.2 — Global Geosphere, Earthquake & Volcano Intelligence
...
# Site Intelligence v4.35.2 — Global Hydrology, Rivers, Flood & Drought Intelligence
...
# Site Intelligence v4.35.2 — Global Cryosphere Intelligence & Frozen-Earth Conditions
...
# Site Intelligence v4.35.2 — Ocean Governance, Jurisdiction & Maritime Boundaries
...
# Site Intelligence v4.35.2 — Coastal Change, Sea Level & Blue-Carbon Intelligence
...
# Site Intelligence v4.35.2 — Marine Pollution, Debris & Water-Quality Intelligence
...
# Site Intelligence v4.35.2 — Ocean Missions, Vehicles & Observatory Network
...
# Site Intelligence v4.35.2 — Marine Biodiversity & Bioacoustic Intelligence
...
# Site Intelligence v4.35.2 — Unified Public Intelligence Platform

Site Intelligence v4.35.2 consolidates the existing 35 public workspaces into six primary areas while preserving legacy routes, deep links, Data Truth, record provenance, analytical state, assurance, human-reviewed publication, and production-governance boundaries. No legacy public route is removed in this release.

# Site Intelligence v4.35.2 — Security, Observability, Performance, and Scale Assurance
...
# Site Intelligence v4.35.2 — Global Data Truth Control Plane
...
# Current release: Site Intelligence v4.35.2
...
**v4.35.2 — Fixed Application Viewport and WordPress Embed Isolation**

## Current release: v4.35.2
...
# Site Intelligence v4.35.2 — Browser Reliability, Mobile, and Accessibility
...
# Site Intelligence v4.35.2 — Analytical Workspace Completion
...
## v4.35.2 — Analytical Workspace Completion
...
## v4.35.2 — Cartographic Workspace and Application Presentation
...
**Current release:** v4.35.2 — Connected Public Intelligence and Evidence Platform

## v4.35.2 — Resume-Safe Promotion, Deployment Receipts, and Runtime-State Isolation
...
## v4.35.2 — Global Energy Infrastructure, Power Systems & Electricity Intelligence
...
## v4.35.2 — Production Truth and Workspace Completion
...
## v4.35.2 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
## v4.35.2 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Prior release:** v4.35.2 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v4.35.2 publication capabilities
...
## v4.35.2 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v4.35.2 collection capabilities
...
## v4.35.2 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v4.35.2 — Signal Context and Drill-Down
- v4.35.2 — Topic and Regional Channels
- v4.35.2 — Homepage Intelligence Gateway
- v4.35.2 — Signal Relevance and Rotation Intelligence
- v4.35.2 — Analytics and Public-Value Measurement
- v4.35.2 — Connected Live Intelligence Surface
- v4.35.2 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v4.35.2 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v4.35.2 — Editorial Workspace, Review Queues, and Publication Orchestration
- v4.35.2 — Publication Adapters, Institutional Handoffs, and Release Governance
- v4.35.2 — Release Monitoring, Rollback, and Post-Publication Governance
- v4.35.2 — Corrections, Retractions, and Public Change History
- v4.35.2 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v4.35.2 — Archive Verification, Preservation Audits, and Institutional Custody
- v4.35.2 — Preservation Interoperability, External Verification, and Institutional Exchange
- v4.35.2 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v4.35.2 — Registry Governance, Challenges, Revocation, and Appeals
- v4.35.2 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
### v4.35.2 Underwater Observation & Visual Evidence
...
## v4.35.2 — Marine Human Activity, Protected Areas & Maritime Pressure
...
## v4.35.2 — Terrestrial Ecosystems, Vegetation & Wildfire Intelligence
