# Sustainable Catalyst Site Intelligence v4.37.0

**Current release:** v4.37.0 — Live Underwater Media Discovery, Imagery & Video Retrieval

Site Intelligence v4.37.0 turns Underwater Observation from a source-aware orientation scaffold into a live media-discovery workspace while preserving the six-area / 35-route architecture and the first-class Ocean + Space navigation introduced in v4.36.0 R4.

> **Live underwater media:** FathomNet is the default public image/annotation lane; NOAA Ocean Exploration provides public expedition/video/archive discovery; Ocean Networks Canada Oceans 3.0 provides token-authenticated camera/archive discovery through a server-side connector. Provider failures remain independent, missing media remains missing, and ONC credential material is never returned to the browser.

> **No fake 0,0 observation:** The Underwater workspace no longer presents 0,0 / 0 m as a meaningful default query. Location, depth and time remain unset unless supplied by the user or returned by a source record.
...
The hardened v4.35.3.1 deployment contract remains in force: first-party release identity/runtime/route integrity can block promotion, but transient upstream-source health cannot. `/public/authoritative-connectors` now exposes the combined ten-connector catalog, while `/public/source-health-policy` keeps operational-source state separate from release validity.

# Current release: Site Intelligence v4.35.15 — Exoplanets, Habitability & Atmospheric Biosignature Intelligence

Site Intelligence v4.35.15 extends the existing Astronomy / Space environment with source-bounded SETI observations, radio-signal event metadata, published search coverage and exoplanet target context. Signal events and candidate labels are not confirmation of extraterrestrial intelligence; non-detections are not absence findings; and announcement authority is never inferred. The six-area / 35-route public architecture remains unchanged, and SETI assets lazy-load to preserve the inherited application-shell performance budget.


Site Intelligence v4.35.15 extends the Earth/infrastructure continuum with source-bounded solid-waste, hazardous-waste regulatory, recycling and circular-material statistics. Mapped infrastructure is not operating status; regulatory records are not new compliance findings; statistical recycling rates are not material-circularity certification; and projections are not observations. The six-area / 35-route public architecture remains unchanged.

# Site Intelligence v4.35.15

Current release: Global Industrial Facilities, Manufacturing & Trade-Flow Intelligence.


## Site Intelligence v4.35.15 — Digital Connectivity

v4.35.15 adds a source-aware digital-connectivity layer spanning telecommunications infrastructure, sampled Internet performance, national connectivity statistics, and provider-reported broadband availability while preserving the existing public architecture and evidence-truth boundaries.

# Site Intelligence v4.35.15 — Global Transportation Networks, Ports, Airports & Transit Intelligence
...
# Site Intelligence v4.35.15 — Global Human Settlements, Urbanization & Built Environment Intelligence
...
# Site Intelligence v4.35.15 — Agriculture, Crops & Food-System Conditions Intelligence

Site Intelligence v4.35.15 extends Earth Observation into agricultural statistics, crop-condition remote sensing and consensus crop assessments while preserving evidence type, provenance and non-inference boundaries.

# Site Intelligence v4.35.15 — Wetlands, Inland Waters & Aquatic Habitat Intelligence

Site Intelligence v4.35.15 adds Global Biodiversity, Species Distribution & Conservation Intelligence while preserving the six-area / 35-route public architecture.

# Site Intelligence v4.35.15 — Global Soils, Land Degradation & Desertification Intelligence
...
# Site Intelligence v4.35.15 — Global Geosphere, Earthquake & Volcano Intelligence
...
# Site Intelligence v4.35.15 — Global Hydrology, Rivers, Flood & Drought Intelligence
...
# Site Intelligence v4.35.15 — Global Cryosphere Intelligence & Frozen-Earth Conditions
...
# Site Intelligence v4.35.15 — Ocean Governance, Jurisdiction & Maritime Boundaries
...
# Site Intelligence v4.35.15 — Coastal Change, Sea Level & Blue-Carbon Intelligence
...
# Site Intelligence v4.35.15 — Marine Pollution, Debris & Water-Quality Intelligence
...
# Site Intelligence v4.35.15 — Ocean Missions, Vehicles & Observatory Network
...
# Site Intelligence v4.35.15 — Marine Biodiversity & Bioacoustic Intelligence
...
# Site Intelligence v4.35.15 — Unified Public Intelligence Platform

Site Intelligence v4.35.15 consolidates the existing 35 public workspaces into six primary areas while preserving legacy routes, deep links, Data Truth, record provenance, analytical state, assurance, human-reviewed publication, and production-governance boundaries. No legacy public route is removed in this release.

# Site Intelligence v4.35.15 — Security, Observability, Performance, and Scale Assurance
...
Adds review-oriented watchlists, geographic monitoring areas, threshold and source-change evaluation, explicit alert-state history, modeled-warning separation, draft digests, and reviewed public-feed contracts. No automatic emergency dispatch or automatic publication is claimed.


Site Intelligence now turns selected countries, indicators, events, sources, and evidence into portable research context with retained source snapshots, deterministic record fingerprints, citation exports, evidence manifests, claim/evidence relationship maps, and explicit handoff previews for Research Librarian, Knowledge Library, Workbench, and Decision Studio.
...
# Site Intelligence v4.35.15 — Global Data Truth Control Plane
...
# Current release: Site Intelligence v4.35.15
...
**v4.35.15 — Fixed Application Viewport and WordPress Embed Isolation**

## Current release: v4.35.15
...
# Site Intelligence v4.35.15 — Browser Reliability, Mobile, and Accessibility
...
# Site Intelligence v4.35.15 — Analytical Workspace Completion
...
## v4.35.15 — Analytical Workspace Completion
...
## v4.35.15 — Cartographic Workspace and Application Presentation
...
**Current release:** v4.35.15 — Connected Public Intelligence and Evidence Platform

## v4.35.15 — Resume-Safe Promotion, Deployment Receipts, and Runtime-State Isolation
...
### v4.35.15 deployment highlights
...
- Atomic Git push for branch, release tag, and rollback tag.
- Resume-safe reruns reuse the original rollback tag and continue Render verification.
- Machine-readable local deployment receipt records preparing, GitHub-published, Render-pending, verified, or failed state.
- Runtime-state root isolates writable reliability state from immutable repository files.
- Deterministic validation runs inside a disposable runtime sandbox.

# Sustainable Catalyst Site Intelligence

## v4.35.15 — Global Energy Infrastructure, Power Systems & Electricity Intelligence
...
## v4.35.15 — Production Truth and Workspace Completion
...
## v4.35.15 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
- Stable release fingerprint derived from version, repository, branch, commit, and channel.
- WordPress parity checks every 15 minutes when healthy and every 45 seconds when blocked.
- WordPress diagnostics display gate state, Render commit, and release fingerprint.
- Promotion script preserves the previous Git commit as an annotated rollback tag.
- Render verification checks `install_allowed=true` at the exact pushed commit before exposing the WordPress ZIP.
- Exact Render rollback command printed for the prior commit.
- 873 passing automated tests.

## v3.22.1 — Map Runtime Reliability, Spatial Evidence Mapping, and Embed Repair

- Added a first-party static geographic-grid fallback for points, lines, and polygons.
- Added automatic CARTO basemap failover to OpenStreetMap.
- Added visible degraded-imagery diagnostics instead of silent blank maps.
- Added map-backed Spatial Evidence and corrected approved embed frame policies.
- 847 automated tests passed.

## v4.35.15 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Prior release:** v4.35.15 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v4.35.15 publication capabilities

- Approved public collection to research brief workflow.
- Separate preparation, review, and approval roles.
- Retained source collection, pathway, record, brief, citation, and package checksums.
- JSON, Markdown, BibTeX-like, and RIS-like citation packages.
...
## v4.35.15 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v4.35.15 collection capabilities

- Canonical saved discovery filter states and result checksums.
- Separate preparation, review, and approval roles.
- Public research collections over approved registry records only.
- Ordered evidence pathways with human-written rationale.
- Retained source snapshots and drift detection.
...
## v4.35.15 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v4.35.15 — Signal Context and Drill-Down
- v4.35.15 — Topic and Regional Channels
- v4.35.15 — Homepage Intelligence Gateway
- v4.35.15 — Signal Relevance and Rotation Intelligence
- v4.35.15 — Analytics and Public-Value Measurement
- v4.35.15 — Connected Live Intelligence Surface
- v4.35.15 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v4.35.15 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v4.35.15 — Editorial Workspace, Review Queues, and Publication Orchestration
- v4.35.15 — Publication Adapters, Institutional Handoffs, and Release Governance
- v4.35.15 — Release Monitoring, Rollback, and Post-Publication Governance
- v4.35.15 — Corrections, Retractions, and Public Change History
- v4.35.15 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v4.35.15 — Archive Verification, Preservation Audits, and Institutional Custody
- v4.35.15 — Preservation Interoperability, External Verification, and Institutional Exchange
- v4.35.15 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v4.35.15 — Registry Governance, Challenges, Revocation, and Appeals
- v4.35.15 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- Requires separation of duties for final approval.
...
- `POST /admin/live-intelligence/editorial/workspaces`
- `POST /admin/live-intelligence/editorial/workspaces/{workspace_id}/assign`
- `POST /admin/live-intelligence/editorial/workspaces/{workspace_id}/revisions`
- `POST /admin/live-intelligence/editorial/workspaces/{workspace_id}/submit`
- `POST /admin/live-intelligence/editorial/workspaces/{workspace_id}/review`
- `POST /admin/live-intelligence/editorial/workspaces/{workspace_id}/orchestrate`
- `GET /admin/live-intelligence/editorial/workspaces/{workspace_id}/history`
...
- Requires a documented human review decision before any public briefing is published.
...
- `GET /public/live-intelligence/briefings`
- `GET /public/live-intelligence/briefings/{briefing_id}`
- `GET /public/live-intelligence/briefings/{briefing_id}/export`
- `GET /admin/live-intelligence/briefings`
- `POST /admin/live-intelligence/briefings/drafts`
- `POST /admin/live-intelligence/briefings/{briefing_id}/review`
- `POST /admin/live-intelligence/briefings/{briefing_id}/handoff`

WordPress public surface:
...
- Preserves source, observation time, freshness, lineage, evidence, rotation, accessibility, and privacy controls on every surface.
- Prevents separate per-product ingestion pipelines, arbitrary signal injection, advertising, affiliate promotions, and freshness-rule bypasses.
...
- `GET /public/live-intelligence/surfaces/{surface_id}`
- `GET /public/live-intelligence/surfaces/{surface_id}/feed`
- `GET /public/live-intelligence/embed-manifest`

WordPress presets:

- `[sc_live_intelligence_static]`
- `[sc_live_intelligence_channel channel="weather-climate"]`
- `[sc_live_intelligence_publication]`
- `[sc_live_intelligence_library]`
- `[sc_live_intelligence_advisory]`
...
- Balances signal families, sources, and geographies while preserving deterministic fallback order.
- Records aggregate signal-display history only; no individual visitor profile is created.
- Adds human-approved boost, pin, and suppress overrides that cannot change source observations or evidence.
...
- Public diagnostics: `/public/production-governance/diagnostics`
- Admin control center: `/admin/production-governance/control-center`
- Public shortcode: `[sc_public_production_governance]`
- Admin shortcode: `[sc_production_governance_control_center]`

The release does not claim automatic compliance, unbreakable security, distributed rate limiting from a single process, an always-on queue worker, automatic restoration, or zero data loss without persistent storage and verified operational procedures.
...
### v4.35.15 Underwater Observation & Visual Evidence
...
## v4.35.15 — Marine Human Activity, Protected Areas & Maritime Pressure
...
- Current release:** v4.37.0 — Palestine-First Country Navigation Integrity Repair
- **Release:** v4.37.0 — Connected Public Intelligence and Evidence Platform
- Current release:** v4.37.0 — Connected Public Intelligence and Evidence Platform
- v4.37.0 — Analytics and Public-Value Measurement
- v4.37.0 — Archive Verification, Preservation Audits, and Institutional Custody
- v4.37.0 — Collection Publication, Citation Exports, and Research Brief Packages
- v4.37.0 — Connected Live Intelligence Surface
- v4.37.0 — Corrections, Retractions, and Public Change History
- v4.37.0 — Editorial Workspace, Review Queues, and Publication Orchestration
- v4.37.0 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v4.37.0 — Homepage Intelligence Gateway
- v4.37.0 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v4.37.0 — Live Intelligence presentation
- v4.37.0 — Preservation Interoperability, External Verification, and Institutional Exchange
- v4.37.0 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v4.37.0 — Public Registry Discovery, Evidence Search, and Institutional Profiles
- v4.37.0 — Publication Adapters, Institutional Handoffs, and Release Governance
- v4.37.0 — Registry Governance, Challenges, Revocation, and Appeals
- v4.37.0 — Release Monitoring, Rollback, and Post-Publication Governance
- v4.37.0 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
- v4.37.0 — Signal Context and Drill-Down
- v4.37.0 — Signal Relevance and Rotation Intelligence
- v4.37.0 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v4.37.0 — Topic and Regional Channels
