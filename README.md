...
## v3.22.5 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
## v3.22.5 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Current release:** v3.22.5 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v3.22.5 publication capabilities
...
## v3.22.5 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v3.22.5 collection capabilities
...
## v3.22.5 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v3.22.5 — Signal Context and Drill-Down
- v3.22.5 — Topic and Regional Channels
- v3.22.5 — Homepage Intelligence Gateway
- v3.22.5 — Signal Relevance and Rotation Intelligence
- v3.22.5 — Analytics and Public-Value Measurement
- v3.22.5 — Connected Live Intelligence Surface
- v3.22.5 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v3.22.5 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v3.22.5 — Editorial Workspace, Review Queues, and Publication Orchestration
- v3.22.5 — Publication Adapters, Institutional Handoffs, and Release Governance
- v3.22.5 — Release Monitoring, Rollback, and Post-Publication Governance
- v3.22.5 — Corrections, Retractions, and Public Change History
- v3.22.5 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v3.22.5 — Archive Verification, Preservation Audits, and Institutional Custody
- v3.22.5 — Preservation Interoperability, External Verification, and Institutional Exchange
- v3.22.5 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v3.22.5 — Registry Governance, Challenges, Revocation, and Appeals
- v3.22.5 — Public Registry Discovery, Evidence Search, and Institutional Profiles
