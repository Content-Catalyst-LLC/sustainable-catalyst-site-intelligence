...
# Site Intelligence v4.3.0 — Unified Public Intelligence Platform

Site Intelligence v4.3.0 consolidates the existing 35 public workspaces into six primary areas while preserving legacy routes, deep links, Data Truth, record provenance, analytical state, assurance, human-reviewed publication, and production-governance boundaries. No legacy public route is removed in this release.

# Site Intelligence v4.3.0 — Security, Observability, Performance, and Scale Assurance
...
# Site Intelligence v4.3.0 — Global Data Truth Control Plane
...
# Current release: Site Intelligence v4.3.0
...
**v4.3.0 — Fixed Application Viewport and WordPress Embed Isolation**
...
# Site Intelligence v4.3.0 — Browser Reliability, Mobile, and Accessibility
...
# Site Intelligence v4.3.0 — Analytical Workspace Completion
...
## v4.3.0 — Analytical Workspace Completion
...
## v4.3.0 — Cartographic Workspace and Application Presentation
...
**Current release:** v4.3.0 — Connected Public Intelligence and Evidence Platform

## v4.3.0 — Resume-Safe Promotion, Deployment Receipts, and Runtime-State Isolation
...
## v4.3.0 — Production Truth and Workspace Completion
...
## v4.3.0 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
## v4.3.0 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Prior release:** v4.3.0 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v4.3.0 publication capabilities
...
## v4.3.0 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v4.3.0 collection capabilities
...
## v4.3.0 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v4.3.0 — Signal Context and Drill-Down
- v4.3.0 — Topic and Regional Channels
- v4.3.0 — Homepage Intelligence Gateway
- v4.3.0 — Signal Relevance and Rotation Intelligence
- v4.3.0 — Analytics and Public-Value Measurement
- v4.3.0 — Connected Live Intelligence Surface
- v4.3.0 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v4.3.0 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v4.3.0 — Editorial Workspace, Review Queues, and Publication Orchestration
- v4.3.0 — Publication Adapters, Institutional Handoffs, and Release Governance
- v4.3.0 — Release Monitoring, Rollback, and Post-Publication Governance
- v4.3.0 — Corrections, Retractions, and Public Change History
- v4.3.0 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v4.3.0 — Archive Verification, Preservation Audits, and Institutional Custody
- v4.3.0 — Preservation Interoperability, External Verification, and Institutional Exchange
- v4.3.0 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v4.3.0 — Registry Governance, Challenges, Revocation, and Appeals
- v4.3.0 — Public Registry Discovery, Evidence Search, and Institutional Profiles
