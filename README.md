# Site Intelligence v4.30.0

Current release: Global Industrial Facilities, Manufacturing & Trade-Flow Intelligence.


## Site Intelligence v4.30.0 — Digital Connectivity

v4.30.0 adds a source-aware digital-connectivity layer spanning telecommunications infrastructure, sampled Internet performance, national connectivity statistics, and provider-reported broadband availability while preserving the existing public architecture and evidence-truth boundaries.

# Site Intelligence v4.30.0 — Global Transportation Networks, Ports, Airports & Transit Intelligence
...
# Site Intelligence v4.30.0 — Global Human Settlements, Urbanization & Built Environment Intelligence
...
# Site Intelligence v4.30.0 — Agriculture, Crops & Food-System Conditions Intelligence

Site Intelligence v4.30.0 extends Earth Observation into agricultural statistics, crop-condition remote sensing and consensus crop assessments while preserving evidence type, provenance and non-inference boundaries.

# Site Intelligence v4.30.0 — Wetlands, Inland Waters & Aquatic Habitat Intelligence

Site Intelligence v4.30.0 adds Global Biodiversity, Species Distribution & Conservation Intelligence while preserving the six-area / 35-route public architecture.

# Site Intelligence v4.30.0 — Global Soils, Land Degradation & Desertification Intelligence
...
# Site Intelligence v4.30.0 — Global Geosphere, Earthquake & Volcano Intelligence
...
# Site Intelligence v4.30.0 — Global Hydrology, Rivers, Flood & Drought Intelligence
...
# Site Intelligence v4.30.0 — Global Cryosphere Intelligence & Frozen-Earth Conditions
...
# Site Intelligence v4.30.0 — Ocean Governance, Jurisdiction & Maritime Boundaries
...
# Site Intelligence v4.30.0 — Coastal Change, Sea Level & Blue-Carbon Intelligence
...
# Site Intelligence v4.30.0 — Marine Pollution, Debris & Water-Quality Intelligence
...
# Site Intelligence v4.30.0 — Ocean Missions, Vehicles & Observatory Network
...
# Site Intelligence v4.30.0 — Marine Biodiversity & Bioacoustic Intelligence
...
# Site Intelligence v4.30.0 — Unified Public Intelligence Platform

Site Intelligence v4.30.0 consolidates the existing 35 public workspaces into six primary areas while preserving legacy routes, deep links, Data Truth, record provenance, analytical state, assurance, human-reviewed publication, and production-governance boundaries. No legacy public route is removed in this release.

# Site Intelligence v4.30.0 — Security, Observability, Performance, and Scale Assurance
...
# Site Intelligence v4.30.0 — Global Data Truth Control Plane
...
# Current release: Site Intelligence v4.30.0
...
**v4.30.0 — Fixed Application Viewport and WordPress Embed Isolation**

## Current release: v4.30.0
...
# Site Intelligence v4.30.0 — Browser Reliability, Mobile, and Accessibility
...
# Site Intelligence v4.30.0 — Analytical Workspace Completion
...
## v4.30.0 — Analytical Workspace Completion
...
## v4.30.0 — Cartographic Workspace and Application Presentation
...
**Current release:** v4.30.0 — Connected Public Intelligence and Evidence Platform

## v4.30.0 — Resume-Safe Promotion, Deployment Receipts, and Runtime-State Isolation
...
## v4.30.0 — Global Energy Infrastructure, Power Systems & Electricity Intelligence
...
## v4.30.0 — Production Truth and Workspace Completion
...
## v4.30.0 — Deployment Gate, Live Parity Lock, and Rollback Readiness
...
## v4.30.0 — Collection Publication, Citation Exports, and Research Brief Packages
...
**Prior release:** v4.30.0 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Collection Publication, Citation Exports, and Research Brief Packages

### Current v4.30.0 publication capabilities
...
## v4.30.0 — Saved Discovery Views, Public Research Collections, and Evidence Pathways
...
### Current v4.30.0 collection capabilities
...
## v4.30.0 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
- v4.30.0 — Signal Context and Drill-Down
- v4.30.0 — Topic and Regional Channels
- v4.30.0 — Homepage Intelligence Gateway
- v4.30.0 — Signal Relevance and Rotation Intelligence
- v4.30.0 — Analytics and Public-Value Measurement
- v4.30.0 — Connected Live Intelligence Surface
- v4.30.0 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v4.30.0 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v4.30.0 — Editorial Workspace, Review Queues, and Publication Orchestration
- v4.30.0 — Publication Adapters, Institutional Handoffs, and Release Governance
- v4.30.0 — Release Monitoring, Rollback, and Post-Publication Governance
- v4.30.0 — Corrections, Retractions, and Public Change History
- v4.30.0 — Public Record Archive, Provenance Ledger, and Long-Term Preservation
- v4.30.0 — Archive Verification, Preservation Audits, and Institutional Custody
- v4.30.0 — Preservation Interoperability, External Verification, and Institutional Exchange
- v4.30.0 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
- v4.30.0 — Registry Governance, Challenges, Revocation, and Appeals
- v4.30.0 — Public Registry Discovery, Evidence Search, and Institutional Profiles
...
### v4.30.0 Underwater Observation & Visual Evidence
...
## v4.30.0 — Marine Human Activity, Protected Areas & Maritime Pressure
...
## v4.30.0 — Terrestrial Ecosystems, Vegetation & Wildfire Intelligence
