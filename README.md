...
## v3.18.0 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification

Approved preservation institutions can now publish evidence-linked registry profiles and human-reported checksum attestations. Multi-party consensus counts unique institutions only and does not claim certification, accreditation, ranking, or endorsement.

**Current release:** v3.18.0 — Connected Public Intelligence and Evidence Platform

**Current Live Intelligence increment:** Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification

### Current integrated Live Intelligence capabilities

- v3.18.0 — Signal Context and Drill-Down
- v3.18.0 — Topic and Regional Channels
- v3.18.0 — Homepage Intelligence Gateway
- v3.18.0 — Signal Relevance and Rotation Intelligence
- v3.18.0 — Analytics and Public-Value Measurement
- v3.18.0 — Connected Live Intelligence Surface
- v3.18.0 — Signal Subscriptions, Alerts, and Scheduled Intelligence
- v3.18.0 — Live Intelligence Briefings, Narrative Context, and Publication Workflow
- v3.18.0 — Editorial Workspace, Review Queues, and Publication Orchestration
- v3.18.0 — Publication Adapters, Institutional Handoffs, and Release Governance
- v3.18.0 — Release Monitoring, Rollback, and Post-Publication Governance
- v3.18.0 — Corrections, Retractions, and Public Change History
...
- v3.18.0 — Preservation Interoperability, External Verification, and Institutional Exchange
- v3.18.0 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification
