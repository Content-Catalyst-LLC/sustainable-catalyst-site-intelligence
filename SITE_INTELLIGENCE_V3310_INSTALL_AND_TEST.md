...
Run `deploy_and_validate_site_intelligence_v3_31_0_macos.sh` with the v3.31.0 release bundle.
...
4. runs the complete v3.31.0 verifier, including static assurance, supply-chain checks, and all 1,079 Python tests;
