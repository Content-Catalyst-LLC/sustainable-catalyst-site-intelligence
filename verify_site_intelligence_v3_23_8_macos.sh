...
RUNTIME_SANDBOX="$(mktemp -d "${TMPDIR:-/tmp}/scsi-v3238-runtime.XXXXXX")"
...
printf '
==> Verifying v3.24.0 record provenance and indicator truth
'
...
printf '
SUCCESS: Site Intelligence v3.24.0 passed record provenance and indicator truth validation.
Repository: %s
' "$ROOT"
