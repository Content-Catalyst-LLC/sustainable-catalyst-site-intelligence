...
printf '
==> Verifying v3.23.8 record provenance and indicator truth
'
...
grep -q 'record-provenance-v3238.js?v=3.23.8' "$BACKEND/public_app/index.html"
...
printf '\n==> Running mandatory v3.23.8 record provenance and indicator-truth gate\n'
reset_runtime
...
printf '
SUCCESS: Site Intelligence v3.23.8 passed record provenance and indicator truth validation.
Repository: %s
' "$ROOT"
