...
printf '\n==> Verifying v3.28.0 release identity and source-truth contracts\n'
...
grep -q 'data-truth-v32371.js' "$BACKEND/public_app/index.html"
grep -q 'data-truth-v32371.css' "$BACKEND/public_app/index.html"
grep -q '/public/data-truth' "$BACKEND/app/main.py"
grep -q 'SCSIDataTruthV32371' "$BACKEND/public_app/assets/data-truth-v32371.js"
