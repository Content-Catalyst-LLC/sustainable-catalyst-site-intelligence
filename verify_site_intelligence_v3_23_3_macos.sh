...
printf '\n==> Verifying v3.23.7 release identity and source-truth contracts\n'
...
grep -q 'data-truth-v3237.js' "$BACKEND/public_app/index.html"
grep -q 'data-truth-v3237.css' "$BACKEND/public_app/index.html"
grep -q '/public/data-truth' "$BACKEND/app/main.py"
grep -q 'SCSIDataTruthV3237' "$BACKEND/public_app/assets/data-truth-v3237.js"
