...
Place the v4.16.0 installer and release bundle in `~/Downloads`, then run the commands in `SITE_INTELLIGENCE_V41200_TERMINAL_COMMANDS.txt`.
...
The WordPress ZIP should be installed only after Terminal reports the exact **v4.16.0 GitHub and Render live gate passed**.
