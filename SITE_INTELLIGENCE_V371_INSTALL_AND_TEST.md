# Site Intelligence v3.7.1 — Install and Test

1. Unzip `sustainable-catalyst-site-intelligence-v3.7.1-release-bundle.zip` in Downloads.
...
5. Upload `sustainable-catalyst-site-intelligence-v3.7.1-wordpress.zip` in WordPress.
6. Confirm `/public/build-info`, `/public/live-intelligence/rotation-policy`, and `/public/live-intelligence/homepage` report v3.7.1.
