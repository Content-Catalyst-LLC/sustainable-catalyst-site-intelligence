# Site Intelligence v4.39.0 R4 — Install and Test
...
After backend promotion, replace the WordPress plugin with the R4 plugin ZIP even though WordPress still reports semantic version `4.39.0`. R4 is release lineage and frontend cache/controller repair.
