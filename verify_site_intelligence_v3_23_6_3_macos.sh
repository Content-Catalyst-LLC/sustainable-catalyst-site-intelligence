...
printf '
==> Verifying v3.26.0 fixed application viewport and WordPress embed isolation
'
...
printf '
SUCCESS: Site Intelligence v3.26.0 passed fixed application viewport and WordPress embed isolation validation.
Repository: %s
' "$ROOT"
