...
printf '
==> Verifying v4.14.0 fixed application viewport and WordPress embed isolation
'
...
printf '
SUCCESS: Site Intelligence v4.14.0 passed fixed application viewport and WordPress embed isolation validation.
Repository: %s
' "$ROOT"
