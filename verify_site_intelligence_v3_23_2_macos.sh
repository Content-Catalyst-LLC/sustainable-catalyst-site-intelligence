...
printf '\n==> Verifying v3.23.7.1 release identity and cartographic interaction contracts\n'
...
assert manifest['release']=='3.23.7.1'; assert manifest['file_count']==len(manifest['files'])
