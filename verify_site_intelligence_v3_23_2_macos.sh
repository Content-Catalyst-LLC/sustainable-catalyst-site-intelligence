...
printf '\n==> Verifying v3.23.7.2 release identity and cartographic interaction contracts\n'
...
assert manifest['release']=='3.23.7.2'; assert manifest['file_count']==len(manifest['files'])
