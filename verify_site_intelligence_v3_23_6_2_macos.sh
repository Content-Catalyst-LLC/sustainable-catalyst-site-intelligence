...
printf '
==> Verifying v3.29.0 mutation observer recovery and complete-shell browser gate
'
...
printf '
SUCCESS: Site Intelligence v3.29.0 passed mutation observer recovery and complete-shell browser validation.
Repository: %s
' "$ROOT"
