...
printf '
==> Verifying v3.23.7 mutation observer recovery and complete-shell browser gate
'
...
printf '
SUCCESS: Site Intelligence v3.23.7 passed mutation observer recovery and complete-shell browser validation.
Repository: %s
' "$ROOT"
