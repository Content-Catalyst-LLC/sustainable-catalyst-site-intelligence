...
printf '
==> Verifying v4.11.0 mutation observer recovery and complete-shell browser gate
'
...
printf '
SUCCESS: Site Intelligence v4.11.0 passed mutation observer recovery and complete-shell browser validation.
Repository: %s
' "$ROOT"
