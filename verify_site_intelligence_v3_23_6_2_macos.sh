...
printf '
==> Verifying v3.23.6.2 mutation observer recovery and complete-shell browser gate
'
...
printf '
==> Running complete inherited and v3.23.6.2 test suite with process-isolated teardown
'
...
printf '
SUCCESS: Site Intelligence v3.23.6.2 passed mutation observer recovery and complete-shell browser validation.
Repository: %s
' "$ROOT"
