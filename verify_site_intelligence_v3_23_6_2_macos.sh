...
printf '
==> Verifying v3.28.0 mutation observer recovery and complete-shell browser gate
'
...
printf '
SUCCESS: Site Intelligence v3.28.0 passed mutation observer recovery and complete-shell browser validation.
Repository: %s
' "$ROOT"
