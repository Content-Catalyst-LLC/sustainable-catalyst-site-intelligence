...
printf '
==> Verifying v3.23.6.3 mutation observer recovery and complete-shell browser gate
'
...
printf '
SUCCESS: Site Intelligence v3.23.6.3 passed mutation observer recovery and complete-shell browser validation.
Repository: %s
' "$ROOT"
