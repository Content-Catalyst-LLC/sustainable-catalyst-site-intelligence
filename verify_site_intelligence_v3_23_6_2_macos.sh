...
printf '
==> Verifying v4.0.0 mutation observer recovery and complete-shell browser gate
'
...
printf '
SUCCESS: Site Intelligence v4.0.0 passed mutation observer recovery and complete-shell browser validation.
Repository: %s
' "$ROOT"
