...
v3.19.0 adds a preservation-assurance layer above the append-only public archive. It verifies retained record checksums, source snapshots, preservation manifests, and provenance-chain links; records findings; and creates human-approved custody packages for manual institutional transfer.
