...
final class SC_Site_Intelligence_Plugin {
    ...
    const VERSION = '4.35.18';
    const RELEASE_ID = 'site-intelligence-v4.35.18';
    ...
    public function maybe_upgrade() {
        ...
        // v4.35.18 preserves existing feed, freshness, and placement choices while adding presentation and accessibility controls.
