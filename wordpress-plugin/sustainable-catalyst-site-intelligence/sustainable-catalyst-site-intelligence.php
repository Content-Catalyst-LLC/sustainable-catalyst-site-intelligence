...
final class SC_Site_Intelligence_Plugin {
    ...
    const RELEASE_ID = 'site-intelligence-v3.23.7';
    ...
    public function maybe_upgrade() {
        ...
        // v3.23.7 preserves existing feed, freshness, and placement choices while adding presentation and accessibility controls.
    ...
    public function enqueue_assets() {
        ...
        wp_localize_script('sc-site-intelligence', 'SCSiteIntelligence', [
            ...
            'dataTruthCssUrl' => esc_url_raw($base . 'data-truth-v3237.css'),
            'dataTruthJsUrl' => esc_url_raw($base . 'data-truth-v3237.js'),
        ]);
    }
