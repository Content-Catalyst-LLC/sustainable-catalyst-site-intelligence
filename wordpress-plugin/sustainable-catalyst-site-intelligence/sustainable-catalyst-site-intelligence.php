...
final class SC_Site_Intelligence_Plugin {
    ...
    const RELEASE_ID = 'site-intelligence-v3.28.0';
    ...
    public function maybe_upgrade() {
        ...
        // v3.28.0 preserves existing feed, freshness, and placement choices while adding presentation and accessibility controls.
