...
final class SC_Site_Intelligence_Plugin {
    ...
    public function maybe_upgrade() {
        ...
        // v3.11.0 preserves existing feed, freshness, and placement choices while adding presentation and accessibility controls.
