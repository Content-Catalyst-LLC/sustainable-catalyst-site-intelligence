...
final class SC_Site_Intelligence_Plugin {
    ...
    const VERSION = '4.35.3.1';
    const RELEASE_ID = 'site-intelligence-v4.35.3.1';
    ...
    public function __construct() {
        ...
        add_shortcode('sc_live_intelligence_preservation_registry', [$this, 'live_intelligence_preservation_registry_shortcode']);
        add_shortcode('sc_live_intelligence_registry_governance', [$this, 'live_intelligence_registry_governance_shortcode']);
        add_shortcode('sc_live_intelligence_registry_discovery', [$this, 'live_intelligence_registry_discovery_shortcode']);
        add_shortcode('sc_live_intelligence_registry_collections', [$this, 'live_intelligence_registry_collections_shortcode']);
        add_shortcode('sc_live_intelligence_registry_publications', [$this, 'live_intelligence_registry_publications_shortcode']);
    ...
    public static function defaults() {
        return [
            ...
            'live_intelligence_presentation_mode' => 'ticker',
            'live_intelligence_reduced_motion_mode' => 'static',
            'live_intelligence_max_visible' => '8',
            'live_intelligence_announcement_mode' => 'manual',
    ...
    public function maybe_upgrade() {
        ...
        // v4.35.3.1 preserves existing feed, freshness, and placement choices while adding presentation and accessibility controls.
        ...
        if (is_array($stored_options)) {
            ...
            foreach (['live_intelligence_presentation_mode', 'live_intelligence_reduced_motion_mode', 'live_intelligence_max_visible', 'live_intelligence_announcement_mode', 'live_intelligence_mobile_speed', 'live_intelligence_mobile_mode', 'live_intelligence_mobile_interval', 'live_intelligence_spacing', 'live_intelligence_text_limit', 'live_intelligence_compact_sources'] as $key) {
    ...
    public function sanitize_options($input) {
        ...
        $presentation_mode = sanitize_key((string) ($input['live_intelligence_presentation_mode'] ?? 'ticker'));
        $output['live_intelligence_presentation_mode'] = in_array($presentation_mode, ['ticker', 'static', 'manual'], true) ? $presentation_mode : 'ticker';
        $reduced_motion_mode = sanitize_key((string) ($input['live_intelligence_reduced_motion_mode'] ?? 'static'));
        $output['live_intelligence_reduced_motion_mode'] = in_array($reduced_motion_mode, ['static', 'manual'], true) ? $reduced_motion_mode : 'static';
        $output['live_intelligence_max_visible'] = (string) max(1, min(12, absint($input['live_intelligence_max_visible'] ?? 8)));
        $announcement_mode = sanitize_key((string) ($input['live_intelligence_announcement_mode'] ?? 'manual'));
        $output['live_intelligence_announcement_mode'] = in_array($announcement_mode, ['manual', 'status', 'off'], true) ? $announcement_mode : 'manual';
        ...
        $output['live_intelligence_mobile_mode'] = in_array($mobile_mode, ['rotator', 'stacked', 'marquee', 'hidden'], true) ? $mobile_mode : 'rotator';
    ...
    public function handle_reset_live_intelligence_readability() {
        ...
        $defaults = self::defaults();
        $keys = [
            'live_intelligence_presentation_mode', 'live_intelligence_reduced_motion_mode', 'live_intelligence_max_visible', 'live_intelligence_announcement_mode',
    ...
    public function register_rest_routes() {
        ...
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/editorial/policy', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_editorial_policy'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/editorial/status', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_editorial_status'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/publication-releases/policy', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_publication_release_policy'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/publication-releases/adapters', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_publication_release_adapters'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/publication-releases/status', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_publication_release_status'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/release-operations/policy', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_release_operations_policy'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/release-operations/status', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_release_operations_status'],
            'permission_callback' => '__return_true',
        ]);
        ...
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/archive/policy', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_public_archive_policy'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/archive/status', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_public_archive_status'],
            'permission_callback' => '__return_true',
        ]);
        ...
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/preservation-registry/policy', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_preservation_registry_policy'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/preservation-registry/status', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_preservation_registry_status'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/preservation-registry/institutions', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_preservation_registry_institutions'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/preservation-registry/attestations', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_preservation_registry_attestations'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-governance/policy', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_governance_policy'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-governance/status', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_governance_status'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-governance/challenges', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_governance_challenges'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-governance/appeals', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_governance_appeals'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-discovery/policy', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_discovery_policy'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-discovery/status', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_discovery_status'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-discovery/facets', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_discovery_facets'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-discovery/search', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_discovery_search'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-discovery/institutions/(?P<institution_id>[a-zA-Z0-9:_-]+)', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_discovery_institution'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-collections/policy', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_collections_policy'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-collections/status', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_collections_status'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-collections/views', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_collections_views'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-collections', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_collections'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-collections/(?P<collection_id>[a-zA-Z0-9:_-]+)/pathway', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_collection_pathway'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-publications/policy', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_publications_policy'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-publications/status', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_publications_status'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-publications/briefs', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_publications_briefs'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-publications/briefs/(?P<brief_id>[a-zA-Z0-9:_-]+)', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_publication_brief'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/registry-publications/briefs/(?P<brief_id>[a-zA-Z0-9:_-]+)/citations', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_registry_publication_citations'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/archive-audits/policy', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_archive_audit_policy'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/archive-audits/status', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_archive_audit_status'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/archive-audits', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_archive_audits'],
            'permission_callback' => '__return_true',
        ]);
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/archive-audits/custody', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_archive_custody'],
            'permission_callback' => '__return_true',
        ]);
        ...
        register_rest_route(self::REST_NAMESPACE, '/live-intelligence/presentation-policy', [
            'methods' => WP_REST_Server::READABLE,
            'callback' => [$this, 'rest_live_intelligence_presentation_policy'],
            'permission_callback' => '__return_true',
        ]);
    ...
    public function rest_live_intelligence_editorial_policy(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/editorial/policy');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_editorial_status(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/editorial/status');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_publication_release_policy(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/publication-releases/policy');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_publication_release_adapters(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/publication-releases/adapters');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_publication_release_status(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/publication-releases/status');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_release_operations_policy(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/release-operations/policy');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_release_operations_status(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/release-operations/status');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_release_operations_corrections(WP_REST_Request $request) {
        $limit = max(1, min(100, (int) $request->get_param('limit')));
        $result = $this->backend_request('public/live-intelligence/release-operations/corrections?limit=' . $limit);
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }
    ...
    public function rest_live_intelligence_public_archive_policy(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/archive/policy');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_public_archive_status(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/archive/status');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_public_archive(WP_REST_Request $request) {
        $limit = max(1, min(100, (int) $request->get_param('limit')));
        $result = $this->backend_request('public/live-intelligence/archive?limit=' . $limit);
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }
    ...
    public function rest_live_intelligence_preservation_registry_policy(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/preservation-registry/policy');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_preservation_registry_status(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/preservation-registry/status');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_preservation_registry_institutions(WP_REST_Request $request) {
        $limit = max(1, min(100, (int) $request->get_param('limit')));
        $result = $this->backend_request('public/live-intelligence/preservation-registry/institutions?limit=' . $limit);
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_preservation_registry_attestations(WP_REST_Request $request) {
        $limit = max(1, min(100, (int) $request->get_param('limit')));
        $result = $this->backend_request('public/live-intelligence/preservation-registry/attestations?limit=' . $limit);
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_governance_policy(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/registry-governance/policy');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_governance_status(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/registry-governance/status');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_governance_challenges(WP_REST_Request $request) {
        $limit = max(1, min(100, (int) $request->get_param('limit')));
        $result = $this->backend_request('public/live-intelligence/registry-governance/challenges?limit=' . $limit);
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_governance_appeals(WP_REST_Request $request) {
        $limit = max(1, min(100, (int) $request->get_param('limit')));
        $result = $this->backend_request('public/live-intelligence/registry-governance/appeals?limit=' . $limit);
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_discovery_policy(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/registry-discovery/policy');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_discovery_status(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/registry-discovery/status');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_discovery_facets(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/registry-discovery/facets');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_discovery_search(WP_REST_Request $request) {
        $allowed = ['q', 'record_type', 'institution_type', 'trust_profile', 'jurisdiction', 'exchange_profile', 'verification_method', 'governance_status', 'sort', 'offset', 'limit'];
        $params = [];
        ...
        $result = $this->backend_request('public/live-intelligence/registry-discovery/search' . ($query ? '?' . $query : ''));
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_discovery_institution(WP_REST_Request $request) {
        $institution_id = sanitize_text_field((string) $request->get_param('institution_id'));
        $result = $this->backend_request('public/live-intelligence/registry-discovery/institutions/' . rawurlencode($institution_id));
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_collections_policy(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/registry-collections/policy');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_collections_status(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/registry-collections/status');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_collections_views(WP_REST_Request $request) {
        $limit = max(1, min(100, (int) $request->get_param('limit')));
        $result = $this->backend_request('public/live-intelligence/registry-collections/views?limit=' . $limit);
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_collections(WP_REST_Request $request) {
        $limit = max(1, min(100, (int) $request->get_param('limit')));
        $result = $this->backend_request('public/live-intelligence/registry-collections?limit=' . $limit);
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_collection_pathway(WP_REST_Request $request) {
        $collection_id = sanitize_text_field((string) $request->get_param('collection_id'));
        $result = $this->backend_request('public/live-intelligence/registry-collections/' . rawurlencode($collection_id) . '/pathway');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_publications_policy(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/registry-publications/policy');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_publications_status(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/registry-publications/status');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_publications_briefs(WP_REST_Request $request) {
        $limit = max(1, min(100, (int) $request->get_param('limit')));
        $result = $this->backend_request('public/live-intelligence/registry-publications/briefs?limit=' . $limit);
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_publication_brief(WP_REST_Request $request) {
        $brief_id = sanitize_text_field((string) $request->get_param('brief_id'));
        $result = $this->backend_request('public/live-intelligence/registry-publications/briefs/' . rawurlencode($brief_id));
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_registry_publication_citations(WP_REST_Request $request) {
        $brief_id = sanitize_text_field((string) $request->get_param('brief_id'));
        $result = $this->backend_request('public/live-intelligence/registry-publications/briefs/' . rawurlencode($brief_id) . '/citations');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }
    ...
    public function rest_live_intelligence_archive_audit_status(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/archive-audits/status');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_archive_audits(WP_REST_Request $request) {
        $limit = max(1, min(100, (int) $request->get_param('limit')));
        $result = $this->backend_request('public/live-intelligence/archive-audits?limit=' . $limit);
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }

    public function rest_live_intelligence_archive_custody(WP_REST_Request $request) {
        $limit = max(1, min(100, (int) $request->get_param('limit')));
        $result = $this->backend_request('public/live-intelligence/archive-audits/custody?limit=' . $limit);
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }
    ...
    public function rest_live_intelligence_presentation_policy(WP_REST_Request $request) {
        $result = $this->backend_request('public/live-intelligence/presentation-policy');
        return is_wp_error($result) ? $result : rest_ensure_response($result);
    }
    ...
    public function live_intelligence_shortcode($atts = []) {
        ...
        $atts = shortcode_atts([
            ...
            'presentation' => (string) ($options['live_intelligence_presentation_mode'] ?? 'ticker'),
            'reduced_motion' => (string) ($options['live_intelligence_reduced_motion_mode'] ?? 'static'),
            'max_visible' => (string) ($options['live_intelligence_max_visible'] ?? '8'),
            'announce' => (string) ($options['live_intelligence_announcement_mode'] ?? 'manual'),
            'motion' => 'slow',
            'theme' => 'electronic',
        ...
        $presentation = in_array(sanitize_key((string) $atts['presentation']), ['ticker', 'static', 'manual'], true) ? sanitize_key((string) $atts['presentation']) : 'ticker';
        $reduced_motion_mode = in_array(sanitize_key((string) $atts['reduced_motion']), ['static', 'manual'], true) ? sanitize_key((string) $atts['reduced_motion']) : 'static';
        $max_visible = max(1, min(12, absint($atts['max_visible'])));
        $announcement_mode = in_array(sanitize_key((string) $atts['announce']), ['manual', 'status', 'off'], true) ? sanitize_key((string) $atts['announce']) : 'manual';
        ...
        $mobile_mode = in_array(sanitize_key((string) $atts['mobile_mode']), ['rotator', 'stacked', 'marquee', 'hidden'], true) ? sanitize_key((string) $atts['mobile_mode']) : 'rotator';
        ...
        <section class="<?php echo esc_attr($classes); ?>" data-scsi-live-intelligence data-presentation="<?php echo esc_attr($presentation); ?>" data-reduced-motion="<?php echo esc_attr($reduced_motion_mode); ?>" data-max-visible="<?php echo esc_attr((string) $max_visible); ?>" data-announcement-mode="<?php echo esc_attr($announcement_mode); ?>" data-surface="<?php echo esc_attr($surface); ?>" data-category="<?php echo esc_attr($category); ?>" data-channel="<?php echo esc_attr($channel); ?>" data-region="<?php echo esc_attr($region); ?>" data-country="<?php echo esc_attr($country); ?>" data-limit="<?php echo esc_attr((string) $limit); ?>" data-feeds="<?php echo esc_attr(implode(',', $feeds)); ?>" data-exclude="<?php echo esc_attr(implode(',', $exclude)); ?>" data-max-per-source="<?php echo esc_attr((string) $max_per_source); ?>" data-motion="<?php echo esc_attr($motion); ?>" data-mobile-mode="<?php echo esc_attr($mobile_mode); ?>" data-mobile-interval="<?php echo esc_attr((string) $mobile_interval); ?>" data-show-sources="<?php echo esc_attr((string) $atts['show_sources']); ?>" data-show-updated="<?php echo esc_attr((string) $atts['show_updated']); ?>" data-show-cluster-sources="<?php echo esc_attr((string) $atts['show_cluster_sources']); ?>" data-selection-context="<?php echo esc_attr((string) $atts['selection_context']); ?>" data-detail-links="<?php echo esc_attr($detail_links); ?>" data-show-freshness="<?php echo esc_attr($show_freshness); ?>" data-refresh-seconds="<?php echo esc_attr((string) $refresh_seconds); ?>" data-context-base="<?php echo esc_url($context_base); ?>" data-compact-sources="<?php echo esc_attr($compact_sources); ?>" data-text-limit="<?php echo esc_attr((string) $text_limit); ?>" data-category-labels="<?php echo esc_attr(wp_json_encode($category_labels)); ?>" style="--scsi-live-duration:<?php echo esc_attr((string) $speed); ?>s;--scsi-live-mobile-duration:<?php echo esc_attr((string) $mobile_speed); ?>s" aria-label="<?php echo esc_attr($label); ?>">
            ...
            <nav class="scsi-live-intelligence__mobile-controls scsi-live-intelligence__controls" aria-label="Live Intelligence signal navigation" hidden>
            ...
            <p class="scsi-live-intelligence__announcer screen-reader-text" data-scsi-live-announcer role="status" aria-live="polite" aria-atomic="true"></p>
            <noscript><p class="scsi-live-intelligence__noscript">Live Intelligence motion and signal controls require JavaScript. <a href="<?php echo esc_url(rest_url(self::REST_NAMESPACE . '/live-intelligence/status')); ?>">Open the public feed status.</a></p></noscript>
        </section>
        <?php
        return ob_get_clean();
    }
    ...
    public function live_intelligence_editorial_workspace_shortcode($atts = []) {
        $atts = shortcode_atts([
            'title' => 'Live Intelligence Editorial Workflow',
        ], is_array($atts) ? $atts : [], 'sc_live_intelligence_editorial_workspace');
        $policy_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/editorial/policy');
        $status_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/editorial/status');
        ob_start();
        ?>
        <section class="scsi-card scsi-live-editorial" data-scsi-live-editorial data-policy-endpoint="<?php echo esc_url($policy_endpoint); ?>" data-status-endpoint="<?php echo esc_url($status_endpoint); ?>">
            <p class="scsi-eyebrow">Live Intelligence · Editorial governance</p>
            <h2><?php echo esc_html(sanitize_text_field((string) $atts['title'])); ?></h2>
            <p class="scsi-muted">Loading the governed review queue and publication-readiness summary…</p>
            <div class="scsi-live-editorial__output" aria-live="polite" aria-busy="true"></div>
            <p class="scsi-live-subscriptions__boundary">Copy revisions cannot rewrite canonical evidence, claim-source links, observed values, or provenance. Final approval requires separation of duties, and publication adapters perform no automatic WordPress write.</p>
            <noscript><p><a href="<?php echo esc_url($status_endpoint); ?>">Open the public editorial status endpoint.</a></p></noscript>
        </section>
        <?php
        return ob_get_clean();
    }

    public function live_intelligence_publication_releases_shortcode($atts = []) {
        $atts = shortcode_atts(['title' => 'Live Intelligence Publication Releases'], $atts, 'sc_live_intelligence_publication_releases');
        $policy_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/publication-releases/policy');
        $adapters_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/publication-releases/adapters');
        $status_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/publication-releases/status');
        ob_start(); ?>
        <section class="scsi-card scsi-live-editorial scsi-live-publication-releases" data-scsi-live-publication-releases data-policy-endpoint="<?php echo esc_url($policy_endpoint); ?>" data-adapters-endpoint="<?php echo esc_url($adapters_endpoint); ?>" data-status-endpoint="<?php echo esc_url($status_endpoint); ?>">
            <p class="scsi-eyebrow">Live Intelligence · Release governance</p>
            <h2><?php echo esc_html(sanitize_text_field((string) $atts['title'])); ?></h2>
            <p class="scsi-muted">Loading release packages, validation gates, and manual destination handoff status…</p>
            <div class="scsi-live-publication-releases__output" aria-live="polite" aria-busy="true"></div>
            <p class="scsi-live-subscriptions__boundary">Approved release packages carry evidence and package checksums. Separate release approval is required, and every adapter uses manual destination handoff with no automatic WordPress or institutional write.</p>
            <noscript><p><a href="<?php echo esc_url($status_endpoint); ?>">Open the public publication release status endpoint.</a></p></noscript>
        </section>
        <?php return ob_get_clean();
    }

    public function live_intelligence_release_operations_shortcode($atts = []) {
        $atts = shortcode_atts(['title' => 'Live Intelligence Release Operations'], $atts, 'sc_live_intelligence_release_operations');
        $policy_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/release-operations/policy');
        $status_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/release-operations/status');
        $corrections_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/release-operations/corrections?limit=12');
        ob_start(); ?>
        <section class="scsi-card scsi-live-editorial scsi-live-release-operations" data-scsi-live-release-operations data-policy-endpoint="<?php echo esc_url($policy_endpoint); ?>" data-status-endpoint="<?php echo esc_url($status_endpoint); ?>" data-corrections-endpoint="<?php echo esc_url($corrections_endpoint); ?>">
            <p class="scsi-eyebrow">Live Intelligence · Post-publication governance</p>
            <h2><?php echo esc_html(sanitize_text_field((string) $atts['title'])); ?></h2>
            <p class="scsi-muted">Loading deployment verification, correction, and rollback governance status…</p>
            <div class="scsi-live-release-operations__output" aria-live="polite" aria-busy="true"></div>
            <p class="scsi-live-subscriptions__boundary">Deployment receipts are externally reported and manually verified against release checksums. Site Intelligence prepares correction and rollback packages but performs no deployment, rollback, deletion, network verification, or destination write.</p>
            <noscript><p><a href="<?php echo esc_url($status_endpoint); ?>">Open the public release operations status endpoint.</a></p></noscript>
        </section>
        <?php return ob_get_clean();
    }
    ...
    public function live_intelligence_public_archive_shortcode($atts = []) {
        $atts = shortcode_atts(['title' => 'Live Intelligence Public Record Archive'], $atts, 'sc_live_intelligence_public_archive');
        $policy_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/archive/policy');
        $status_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/archive/status');
        $records_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/archive?limit=12');
        ob_start(); ?>
        <section class="scsi-card scsi-live-editorial scsi-live-public-archive" data-scsi-live-public-archive data-policy-endpoint="<?php echo esc_url($policy_endpoint); ?>" data-status-endpoint="<?php echo esc_url($status_endpoint); ?>" data-records-endpoint="<?php echo esc_url($records_endpoint); ?>">
            <p class="scsi-eyebrow">Live Intelligence · Long-term public record</p>
            <h2><?php echo esc_html(sanitize_text_field((string) $atts['title'])); ?></h2>
            <p class="scsi-muted">Loading checksum-bound archive records and preservation lineage…</p>
            <div class="scsi-live-public-archive__output" aria-live="polite" aria-busy="true"></div>
            <p class="scsi-live-subscriptions__boundary">Approved public records are retained in an append-only provenance ledger. Site Intelligence performs no archive deletion, destination write, or remote institutional deposit.</p>
            <noscript><p><a href="<?php echo esc_url($records_endpoint); ?>">Open the public Live Intelligence archive.</a></p></noscript>
        </section>
        <?php return ob_get_clean();
    }

    public function live_intelligence_archive_audits_shortcode($atts = []) {
        $atts = shortcode_atts(['title' => 'Archive Verification and Institutional Custody'], $atts, 'sc_live_intelligence_archive_audits');
        $policy_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/archive-audits/policy');
        $status_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/archive-audits/status');
        $audits_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/archive-audits?limit=12');
        $custody_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/archive-audits/custody?limit=12');
        ob_start(); ?>
        <section class="scsi-card scsi-live-editorial scsi-live-archive-audits" data-scsi-live-archive-audits data-policy-endpoint="<?php echo esc_url($policy_endpoint); ?>" data-status-endpoint="<?php echo esc_url($status_endpoint); ?>" data-audits-endpoint="<?php echo esc_url($audits_endpoint); ?>" data-custody-endpoint="<?php echo esc_url($custody_endpoint); ?>">
            <p class="scsi-eyebrow">Live Intelligence · Preservation assurance</p>
            <h2><?php echo esc_html(sanitize_text_field((string) $atts['title'])); ?></h2>
            <p class="scsi-muted">Loading preservation audit and custody status…</p>
            <div class="scsi-live-archive-audits__output" aria-live="polite" aria-busy="true"></div>
            <p class="scsi-live-subscriptions__boundary">Checksum audits and custody packages are human-governed and append-only. Site Intelligence performs no automatic scheduling, remote deposit, archive mutation, or destination write.</p>
            <noscript><p><a href="<?php echo esc_url($audits_endpoint); ?>">Open public preservation audit reports.</a></p></noscript>
        </section>
        <?php return ob_get_clean();
    }
    ...
    public function live_intelligence_preservation_registry_shortcode($atts = []) {
        $atts = shortcode_atts(['title' => 'Federated Preservation Registry'], $atts, 'sc_live_intelligence_preservation_registry');
        $policy_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/preservation-registry/policy');
        $status_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/preservation-registry/status');
        $institutions_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/preservation-registry/institutions?limit=12');
        $attestations_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/preservation-registry/attestations?limit=12');
        ob_start(); ?>
        <section class="scsi-card scsi-live-editorial scsi-live-preservation-registry" data-scsi-live-preservation-registry data-policy-endpoint="<?php echo esc_url($policy_endpoint); ?>" data-status-endpoint="<?php echo esc_url($status_endpoint); ?>" data-institutions-endpoint="<?php echo esc_url($institutions_endpoint); ?>" data-attestations-endpoint="<?php echo esc_url($attestations_endpoint); ?>">
            <p class="scsi-eyebrow">Live Intelligence · Federated preservation</p>
            <h2><?php echo esc_html(sanitize_text_field((string) $atts['title'])); ?></h2>
            <p class="scsi-muted">Loading institutional trust profiles and checksum attestations…</p>
            <div class="scsi-live-preservation-registry__output" aria-live="polite" aria-busy="true"></div>
            <p class="scsi-live-subscriptions__boundary">Registry profiles are evidence-linked governance declarations, not certifications or endorsements. Attestations are human-reported and perform no network verification, remote deposit, archive mutation, or destination write.</p>
            <noscript><p><a href="<?php echo esc_url($institutions_endpoint); ?>">Open the public preservation registry.</a></p></noscript>
        </section>
        <?php return ob_get_clean();
    }

    public function live_intelligence_registry_governance_shortcode($atts = []) {
        $atts = shortcode_atts(['title' => 'Preservation Registry Governance'], $atts, 'sc_live_intelligence_registry_governance');
        $policy_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-governance/policy');
        $status_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-governance/status');
        $challenges_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-governance/challenges?limit=12');
        $appeals_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-governance/appeals?limit=12');
        ob_start(); ?>
        <section class="scsi-card scsi-live-editorial scsi-live-registry-governance" data-scsi-live-registry-governance data-policy-endpoint="<?php echo esc_url($policy_endpoint); ?>" data-status-endpoint="<?php echo esc_url($status_endpoint); ?>" data-challenges-endpoint="<?php echo esc_url($challenges_endpoint); ?>" data-appeals-endpoint="<?php echo esc_url($appeals_endpoint); ?>">
            <p class="scsi-eyebrow">Live Intelligence · Registry governance</p>
            <h2><?php echo esc_html(sanitize_text_field((string) $atts['title'])); ?></h2>
            <p class="scsi-muted">Loading public challenges, status decisions, and appeal outcomes…</p>
            <div class="scsi-live-registry-governance__output" aria-live="polite" aria-busy="true"></div>
            <p class="scsi-live-subscriptions__boundary">Governance records are append-only. Suspension, revocation, or reinstatement never deletes prior registry states or attestations, and Site Intelligence performs no automatic enforcement or remote-system write.</p>
            <noscript><p><a href="<?php echo esc_url($challenges_endpoint); ?>">Open public registry governance records.</a></p></noscript>
        </section>
        <?php return ob_get_clean();
    }

    public function live_intelligence_registry_discovery_shortcode($atts = []) {
        $atts = shortcode_atts(['title' => 'Preservation Registry Discovery', 'limit' => 12], $atts, 'sc_live_intelligence_registry_discovery');
        $limit = max(1, min(50, (int) $atts['limit']));
        $policy_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-discovery/policy');
        $status_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-discovery/status');
        $facets_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-discovery/facets');
        $search_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-discovery/search');
        $profile_base = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-discovery/institutions/');
        ob_start(); ?>
        <section class="scsi-card scsi-live-editorial scsi-live-registry-discovery" data-scsi-live-registry-discovery data-policy-endpoint="<?php echo esc_url($policy_endpoint); ?>" data-status-endpoint="<?php echo esc_url($status_endpoint); ?>" data-facets-endpoint="<?php echo esc_url($facets_endpoint); ?>" data-search-endpoint="<?php echo esc_url($search_endpoint); ?>" data-profile-base="<?php echo esc_url($profile_base); ?>" data-limit="<?php echo esc_attr((string) $limit); ?>">
            <p class="scsi-eyebrow">Live Intelligence · Public registry discovery</p>
            <h2><?php echo esc_html(sanitize_text_field((string) $atts['title'])); ?></h2>
            <p class="scsi-muted">Search approved institutions, exchanges, attestations, challenges, and appeals.</p>
            <form class="scsi-live-registry-discovery__form" role="search">
                <label><span>Search the registry</span><input type="search" name="q" maxlength="200" placeholder="Institution, jurisdiction, evidence, profile…"></label>
                <label><span>Record type</span><select name="record_type"><option value="">All public records</option><option value="institution">Institutions</option><option value="exchange">Exchanges</option><option value="attestation">Attestations</option><option value="challenge">Challenges</option><option value="appeal">Appeals</option></select></label>
                <button type="submit">Search</button>
            </form>
            <div class="scsi-live-registry-discovery__status" aria-live="polite"></div>
            <div class="scsi-live-registry-discovery__output" aria-live="polite" aria-busy="true"></div>
            <p class="scsi-live-subscriptions__boundary">Evidence-linked profiles only. Queries are not stored. No staff identities, visitor profiles, internal review reasons, certifications, network verification, or remote-system writes.</p>
            <noscript><p><a href="<?php echo esc_url($search_endpoint); ?>">Open the public registry search API.</a></p></noscript>
        </section>
        <?php return ob_get_clean();
    }

    public function live_intelligence_registry_collections_shortcode($atts = []) {
        $atts = shortcode_atts(['title' => 'Public Registry Research Collections', 'limit' => 12], $atts, 'sc_live_intelligence_registry_collections');
        $limit = max(1, min(50, (int) $atts['limit']));
        $policy_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-collections/policy');
        $status_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-collections/status');
        $views_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-collections/views');
        $collections_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-collections');
        $pathway_base = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-collections/');
        ob_start(); ?>
        <section class="scsi-card scsi-live-editorial scsi-live-registry-collections" data-scsi-live-registry-collections data-policy-endpoint="<?php echo esc_url($policy_endpoint); ?>" data-status-endpoint="<?php echo esc_url($status_endpoint); ?>" data-views-endpoint="<?php echo esc_url($views_endpoint); ?>" data-collections-endpoint="<?php echo esc_url($collections_endpoint); ?>" data-pathway-base="<?php echo esc_url($pathway_base); ?>" data-limit="<?php echo esc_attr((string) $limit); ?>">
            <p class="scsi-eyebrow">Live Intelligence · Research collections</p>
            <h2><?php echo esc_html(sanitize_text_field((string) $atts['title'])); ?></h2>
            <p class="scsi-muted">Loading approved saved views, curated collections, and checksum-bound evidence pathways…</p>
            <div class="scsi-live-registry-collections__status" aria-live="polite"></div>
            <div class="scsi-live-registry-collections__output" aria-live="polite" aria-busy="true"></div>
            <p class="scsi-live-subscriptions__boundary">Human-curated public records only. Filter states are reproducible, approved snapshots remain retained, visitor queries and profiles are not stored, and no source record or external system is modified.</p>
            <noscript><p><a href="<?php echo esc_url($collections_endpoint); ?>">Open public registry research collections.</a></p></noscript>
        </section>
        <?php return ob_get_clean();
    }

    public function live_intelligence_registry_publications_shortcode($atts = []) {
        $atts = shortcode_atts(['title' => 'Public Registry Research Briefs', 'limit' => 12], $atts, 'sc_live_intelligence_registry_publications');
        $limit = max(1, min(50, (int) $atts['limit']));
        $policy_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-publications/policy');
        $status_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-publications/status');
        $briefs_endpoint = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-publications/briefs');
        $brief_base = rest_url(self::REST_NAMESPACE . '/live-intelligence/registry-publications/briefs/');
        ob_start(); ?>
        <section class="scsi-card scsi-live-editorial scsi-live-registry-publications" data-scsi-live-registry-publications data-policy-endpoint="<?php echo esc_url($policy_endpoint); ?>" data-status-endpoint="<?php echo esc_url($status_endpoint); ?>" data-briefs-endpoint="<?php echo esc_url($briefs_endpoint); ?>" data-brief-base="<?php echo esc_url($brief_base); ?>" data-limit="<?php echo esc_attr((string) $limit); ?>">
            <p class="scsi-eyebrow">Live Intelligence · Research briefs</p>
            <h2><?php echo esc_html(sanitize_text_field((string) $atts['title'])); ?></h2>
            <p class="scsi-muted">Loading approved, checksum-bound research briefs and source-linked citation bundles…</p>
            <div class="scsi-live-registry-publications__status" aria-live="polite"></div>
            <div class="scsi-live-registry-publications__output" aria-live="polite" aria-busy="true"></div>
            <p class="scsi-live-subscriptions__boundary">Human-authored and reviewed. No automatic publication, remote-system write, visitor profiling, recipient identity storage, credential storage, or source-record mutation.</p>
            <noscript><p><a href="<?php echo esc_url($briefs_endpoint); ?>">Open public registry research briefs.</a></p></noscript>
        </section>
        <?php return ob_get_clean();
    }
        ...
        <div class="wrap scsi-admin-wrap">
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table" role="presentation">
                    ...
                    <tr><th scope="row">Automatic Live Intelligence surface</th><td><label><input type="checkbox" name="<?php echo esc_attr(self::OPTION_KEY); ?>[show_top_live_intelligence]" value="1" <?php checked($options['show_top_live_intelligence'], '1'); ?> /> Automatically place the governed Live Intelligence strip using the selected location.</label></td></tr>
                    ...
                    <tr><th scope="row"><label for="scsi_live_presentation_mode">Desktop presentation</label></th><td><select id="scsi_live_presentation_mode" name="<?php echo esc_attr(self::OPTION_KEY); ?>[live_intelligence_presentation_mode]"><option value="ticker" <?php selected($options['live_intelligence_presentation_mode'], 'ticker'); ?>>Slow moving ticker</option><option value="static" <?php selected($options['live_intelligence_presentation_mode'], 'static'); ?>>Fully static strip</option><option value="manual" <?php selected($options['live_intelligence_presentation_mode'], 'manual'); ?>>One signal with previous / next controls</option></select><p class="description">Motion is never required. Static and manual modes use the same validated signal feed and evidence links.</p></td></tr>
                    <tr><th scope="row"><label for="scsi_live_reduced_motion_mode">Reduced-motion presentation</label></th><td><select id="scsi_live_reduced_motion_mode" name="<?php echo esc_attr(self::OPTION_KEY); ?>[live_intelligence_reduced_motion_mode]"><option value="static" <?php selected($options['live_intelligence_reduced_motion_mode'], 'static'); ?>>Static strip</option><option value="manual" <?php selected($options['live_intelligence_reduced_motion_mode'], 'manual'); ?>>Manual previous / next viewer</option></select><p class="description">Applied automatically when the visitor requests reduced motion through their operating system or browser.</p></td></tr>
                    <tr><th scope="row"><label for="scsi_live_max_visible">Maximum visible signals</label></th><td><input id="scsi_live_max_visible" type="number" min="1" max="12" name="<?php echo esc_attr(self::OPTION_KEY); ?>[live_intelligence_max_visible]" value="<?php echo esc_attr($options['live_intelligence_max_visible']); ?>" /> signals<p class="description">The backend may return more records for ranking, but the public surface remains intentionally selective.</p></td></tr>
                    <tr><th scope="row"><label for="scsi_live_announcement_mode">Assistive announcements</label></th><td><select id="scsi_live_announcement_mode" name="<?php echo esc_attr(self::OPTION_KEY); ?>[live_intelligence_announcement_mode]"><option value="manual" <?php selected($options['live_intelligence_announcement_mode'], 'manual'); ?>>Manual navigation and pause actions only</option><option value="status" <?php selected($options['live_intelligence_announcement_mode'], 'status'); ?>>Manual actions plus delivery-state changes</option><option value="off" <?php selected($options['live_intelligence_announcement_mode'], 'off'); ?>>No dynamic announcements</option></select><p class="description">Animated content is never itself a live region, preventing repetitive screen-reader output.</p></td></tr>
    ...
    public function enqueue_assets() {
        ...
        wp_localize_script('sc-site-intelligence', 'SCSiteIntelligence', [
            ...
            'mapEngineUrl' => esc_url_raw($base . 'vector-cartography-v3230.js'),
            'mapWorldUrl' => esc_url_raw($base . 'world-cartography-v3230.geojson'),
            'mapEngineCssUrl' => esc_url_raw($base . 'vector-cartography-v3230.css'),
            ...
            'browserReliabilityCssUrl' => esc_url_raw($base . 'browser-reliability-v3235.css'),
            'browserReliabilityJsUrl' => esc_url_raw($base . 'browser-reliability-v3235.js'),
            'performanceOfflineCssUrl' => esc_url_raw($base . 'performance-offline-v3236.css'),
            'performanceOfflineJsUrl' => esc_url_raw($base . 'performance-offline-v3236.js'),
            'dataTruthCssUrl' => esc_url_raw($base . 'data-truth-v32371.css'),
            'dataTruthJsUrl' => esc_url_raw($base . 'data-truth-v32371.js'),
            'dataTruthControlPlaneCssUrl' => esc_url_raw($base . 'data-truth-control-plane-v3240.css'),
            'dataTruthControlPlaneJsUrl' => esc_url_raw($base . 'data-truth-control-plane-v3240.js'),
        ]);
    }
