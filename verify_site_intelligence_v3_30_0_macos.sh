...
printf '\n==> Validating v4.4.0 Institutional Workspaces and Review Governance contracts\n'
...
printf '\nSUCCESS: Site Intelligence v4.4.0 passed Institutional Workspaces and Review Governance validation.\nRepository: %s\n' "$ROOT"
