# Install and Test Site Intelligence v3.22.7
...
```bash
curl -fsS "https://sustainable-catalyst-site-intelligence.onrender.com/public/release-gate?plugin_version=3.22.7"
```
