# Site Intelligence v4.35.22 — Credential Configuration Audit
...
v4.35.22 adds canonical settings and deployment declarations for Copernicus Marine and Global Fishing Watch and aligns EPA AQS declarations across the root and backend Render blueprints. `backend/.env.example` now documents the complete environment-variable surface.
