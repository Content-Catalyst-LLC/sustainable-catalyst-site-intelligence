...
class Settings(BaseSettings):
    ...
    # Site Intelligence v4.35.4 — ReliefWeb V2 requires a pre-approved
    ...
    # Site Intelligence v4.35.4 — first authoritative connector expansion.
    ...
    # Site Intelligence v4.35.4 — Event Clustering and Intelligence Ranking.
    ...
    # Site Intelligence v4.35.4 — Signal Context and Drill-Down.
    ...
    # Site Intelligence v4.35.4 — Topic and Regional Channels.
    ...
    # Site Intelligence v4.35.4 — Live Intelligence reliability and freshness.
    ...
    # Site Intelligence v4.35.4 — Signal Relevance and Rotation Intelligence.
    ...
    # Site Intelligence v4.35.4 — Analytics and Public-Value Measurement.
    ...
    # Site Intelligence v4.35.4 — Signal Subscriptions, Alerts, and Scheduled Intelligence.
    ...
    # Site Intelligence v4.35.4 — Live Intelligence Briefings and Publication Workflow.
    ...
    # Site Intelligence v4.35.4 — Editorial Workspace, Review Queues, and Publication Orchestration.
    ...
    # Site Intelligence v4.35.4 — Publication Adapters, Institutional Handoffs, and Release Governance.
    ...
    # Site Intelligence v4.35.4 — Release Monitoring, Rollback, and Post-Publication Governance.
    ...
    # Site Intelligence v4.35.4 — Corrections, Retractions, and Public Change History.
    ...
    # Site Intelligence v4.35.4 — Public Record Archive, Provenance Ledger, and Long-Term Preservation.
    ...
    # Site Intelligence v4.35.4 — Archive Verification, Preservation Audits, and Institutional Custody.
    ...
    # Site Intelligence v4.35.4 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification.
    ...
    # Site Intelligence v4.35.4 — Registry Governance, Challenges, Revocation, and Appeals.
    ...
    # Site Intelligence v4.35.4 — Public Registry Discovery, Evidence Search, and Institutional Profiles.
    ...
    # Site Intelligence v4.35.4 — Saved Discovery Views, Public Research Collections, and Evidence Pathways.
    ...
    # Site Intelligence v4.35.4 — Collection Publication, Citation Exports, and Research Brief Packages.
    ...
    # Site Intelligence v4.35.4 — Scheduled Monitoring, Digests, and Public Intelligence Feeds.
    ...
    # Site Intelligence v4.35.4 — Institutional Workspaces, Collaboration, and Review.
    ...
    # Open Standards, Federation, and Institutional Data Exchange v4.35.4.
    ...
    # Site Intelligence v4.35.4 — Connected Public Intelligence and Evidence Platform.
