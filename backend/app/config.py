...
class Settings(BaseSettings):
    ...
    # Site Intelligence v3.8.0 — Event Clustering and Intelligence Ranking.
    ...
    # Site Intelligence v3.8.0 — Signal Context and Drill-Down.
    ...
    # Site Intelligence v3.8.0 — Topic and Regional Channels.
    ...
    # Site Intelligence v3.8.0 — Live Intelligence reliability and freshness.
    ...
    # Site Intelligence v3.8.0 — Scheduled Monitoring, Digests, and Public Intelligence Feeds.
    ...
    # Site Intelligence v3.8.0 — Institutional Workspaces, Collaboration, and Review.
    ...
    # Open Standards, Federation, and Institutional Data Exchange v3.8.0.
    ...
    # Site Intelligence v3.8.0 — Connected Public Intelligence and Evidence Platform.
