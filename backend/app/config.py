...
class Settings(BaseSettings):
    ...
    # Site Intelligence v4.35.17 — process-local upstream resilience. Provider
    # response headers remain authoritative; these are conservative client bounds,
    # not claims about provider contractual quotas.
    external_resilience_enabled: bool = True
    external_retry_attempts: int = Field(default=3, ge=1, le=4)
    external_backoff_base_ms: int = Field(default=250, ge=50, le=2000)
    external_backoff_max_seconds: int = Field(default=4, ge=1, le=8)
    external_circuit_failure_threshold: int = Field(default=3, ge=2, le=10)
    external_circuit_open_seconds: int = Field(default=60, ge=10, le=600)
    external_cache_max_entries: int = Field(default=256, ge=32, le=4096)
    ...
    ecmwf_cds_catalogue_base_url: str = "https://cds.climate.copernicus.eu/api/catalogue/v1"
    ecmwf_ads_catalogue_base_url: str = "https://ads.atmosphere.copernicus.eu/api/catalogue/v1"
    ...
    # Site Intelligence v4.35.17 — ReliefWeb V2 requires a pre-approved
    ...
    # Site Intelligence v4.35.17 — first authoritative connector expansion.
    ...
    usgs_water_api_key: str = ""
    noaa_erddap_base_url: str = "https://coastwatch.noaa.gov/erddap"
    ...
    # Site Intelligence v4.35.17 — Authoritative Connector Expansion II.
    ...
    ncei_access_base_url: str = "https://www.ncei.noaa.gov/access/services/data/v1"
    ...
    # Site Intelligence v4.35.17 — Authoritative Connector Expansion III.
    ...
    usda_nass_quickstats_url: str = "https://quickstats.nass.usda.gov/api/api_GET/"
    ...
    # Site Intelligence v4.35.17 — Authoritative Connector Expansion IV.
    faostat_api_base_url: str = "https://fenixservices.fao.org/faostat/api/v1"
    ilostat_api_base_url: str = "https://rplumber.ilo.org/data/indicator"
    oecd_sdmx_base_url: str = "https://sdmx.oecd.org/public/rest"
    epa_frs_base_url: str = "https://ofmpub.epa.gov/frs_public2/frs_rest_services.get_facilities"
    usgs_volcano_hans_base_url: str = "https://volcanoes.usgs.gov/vsc/api/hansApi"


    # Site Intelligence v4.35.17 — Agriculture, Food Security & Humanitarian connector closure.
    gdacs_api_base_url: str = "https://www.gdacs.org/gdacsapi/api"
    hdx_ckan_base_url: str = "https://data.humdata.org/api/action"
    hdx_hapi_base_url: str = "https://hapi.humdata.org/api/v2"
    hdx_hapi_app_identifier: str = ""
    ipc_api_base_url: str = "https://api.ipcinfo.org"
    ipc_api_key: str = ""
    fews_net_api_base_url: str = "https://fdw.fews.net/api"


    # Site Intelligence v4.35.17 — canonical authenticated-source configuration.
    # These values remain server-side and are never returned by public diagnostics.
    ...
    # Site Intelligence v3.2.0 — Live Intelligence Signal Source Operations.
    # The immutable registry ships with the release; source configuration, health,
    # test receipts, and retrieval history are writable runtime state.
    live_source_operations_enabled: bool = True
    live_source_operations_registry_path: str = "backend/data/live_intelligence_source_registry_v320.json"
    live_source_operations_state_path: str = "backend/data/live_intelligence_source_operations_state_v320.json"
    ...
    # Site Intelligence v4.35.17 — Event Clustering and Intelligence Ranking.
    ...
    live_intelligence_ranking_enabled: bool = True
    live_intelligence_cluster_time_window_hours: int = Field(default=72, ge=1, le=720)
    ...
    # Site Intelligence v4.35.17 — Signal Context and Drill-Down.
    ...
    # Site Intelligence v4.35.17 — Topic and Regional Channels.
    ...
    # Site Intelligence v4.35.17 — Live Intelligence reliability and freshness.
    ...
    live_intelligence_fresh_minutes: int = Field(default=30, ge=1, le=1440)
    live_intelligence_delayed_hours: int = Field(default=6, ge=1, le=168)
    live_intelligence_stale_hours: int = Field(default=24, ge=2, le=720)
    live_intelligence_max_signal_age_hours: int = Field(default=720, ge=24, le=8760)
    live_intelligence_suppress_expired_signals: bool = True
    live_intelligence_last_known_good_path: str = "backend/data/live_intelligence_last_known_good_v361.json"
    ...
    # Site Intelligence v4.35.17 — Signal Relevance and Rotation Intelligence.
    ...
    live_intelligence_rotation_state_path: str = "backend/data/live_intelligence_rotation_state_v371.json"
    live_intelligence_rotation_window_hours: int = Field(default=168, ge=1, le=2160)
    ...
    # Site Intelligence v4.35.17 — Analytics and Public-Value Measurement.
    ...
    # Site Intelligence v4.35.17 — Signal Subscriptions, Alerts, and Scheduled Intelligence.
    ...
    live_intelligence_subscriptions_enabled: bool = True
    live_intelligence_watchlists_path: str = "backend/data/live_intelligence_subscriptions_v390/watchlists_v390.jsonl"
    live_intelligence_subscription_evaluations_path: str = "backend/data/live_intelligence_subscriptions_v390/evaluations_v390.jsonl"
    live_intelligence_subscription_alerts_path: str = "backend/data/live_intelligence_subscriptions_v390/alerts_v390.jsonl"
    live_intelligence_subscription_digests_path: str = "backend/data/live_intelligence_subscriptions_v390/digests_v390.jsonl"
    live_intelligence_subscription_handoffs_path: str = "backend/data/live_intelligence_subscriptions_v390/handoffs_v390.jsonl"
    live_intelligence_subscriptions_max_records: int = Field(default=20000, ge=100, le=200000)
    live_intelligence_subscriptions_max_rules: int = Field(default=20, ge=1, le=100)
    ...
    # Site Intelligence v4.35.17 — Live Intelligence Briefings and Publication Workflow.
    ...
    live_intelligence_briefing_handoffs_path: str = "backend/data/live_intelligence_briefings_v3100/handoffs_v3100.jsonl"
    ...
    # Site Intelligence v4.35.17 — Editorial Workspace, Review Queues, and Publication Orchestration.
    ...
    live_intelligence_editorial_workspaces_path: str = "backend/data/live_intelligence_editorial_v3110/workspaces_v3110.jsonl"
    live_intelligence_editorial_events_path: str = "backend/data/live_intelligence_editorial_v3110/events_v3110.jsonl"
    live_intelligence_editorial_orchestration_path: str = "backend/data/live_intelligence_editorial_v3110/orchestration_v3110.jsonl"
    ...
    # Site Intelligence v4.35.17 — Publication Adapters, Institutional Handoffs, and Release Governance.
    ...
    live_intelligence_publication_release_events_path: str = "backend/data/live_intelligence_publication_v3120/events_v3120.jsonl"
    live_intelligence_publication_handoffs_path: str = "backend/data/live_intelligence_publication_v3120/handoffs_v3120.jsonl"
    ...
    # Site Intelligence v4.35.17 — Release Monitoring, Rollback, and Post-Publication Governance.
    ...
    live_intelligence_release_deployments_path: str = "backend/data/live_intelligence_release_operations_v3130/deployments_v3130.jsonl"
    live_intelligence_release_operation_events_path: str = "backend/data/live_intelligence_release_operations_v3130/events_v3130.jsonl"
    live_intelligence_release_issues_path: str = "backend/data/live_intelligence_release_operations_v3130/issues_v3130.jsonl"
    live_intelligence_release_corrections_path: str = "backend/data/live_intelligence_release_operations_v3130/corrections_v3130.jsonl"
    live_intelligence_release_rollbacks_path: str = "backend/data/live_intelligence_release_operations_v3130/rollbacks_v3130.jsonl"
    live_intelligence_release_operation_handoffs_path: str = "backend/data/live_intelligence_release_operations_v3130/handoffs_v3130.jsonl"
    ...
    # Site Intelligence v4.35.17 — Corrections, Retractions, and Public Change History.
    ...
    live_intelligence_change_history_notices_path: str = "backend/data/live_intelligence_change_history_v3140/notices_v3140.jsonl"
    live_intelligence_change_history_events_path: str = "backend/data/live_intelligence_change_history_v3140/events_v3140.jsonl"
    live_intelligence_change_history_handoffs_path: str = "backend/data/live_intelligence_change_history_v3140/handoffs_v3140.jsonl"
    ...
    # Site Intelligence v4.35.17 — Public Record Archive, Provenance Ledger, and Long-Term Preservation.
    ...
    live_intelligence_public_archive_records_path: str = "backend/data/live_intelligence_public_archive_v3150/records_v3150.jsonl"
    live_intelligence_public_archive_events_path: str = "backend/data/live_intelligence_public_archive_v3150/events_v3150.jsonl"
    live_intelligence_public_archive_handoffs_path: str = "backend/data/live_intelligence_public_archive_v3150/handoffs_v3150.jsonl"
    ...
    # Site Intelligence v4.35.17 — Archive Verification, Preservation Audits, and Institutional Custody.
    ...
    live_intelligence_archive_audits_path: str = "backend/data/live_intelligence_archive_audits_v3160/audits_v3160.jsonl"
    live_intelligence_archive_audit_events_path: str = "backend/data/live_intelligence_archive_audits_v3160/events_v3160.jsonl"
    live_intelligence_archive_custody_path: str = "backend/data/live_intelligence_archive_audits_v3160/custody_v3160.jsonl"
    live_intelligence_archive_audit_max_records: int = Field(default=20000, ge=100, le=200000)
    live_intelligence_archive_audit_require_separation_of_duties: bool = True
    live_intelligence_preservation_exchange_enabled: bool = True
    live_intelligence_preservation_exchange_path: str = "backend/data/live_intelligence_preservation_exchange_v3170/exchanges_v3170.jsonl"
    live_intelligence_preservation_exchange_verifications_path: str = "backend/data/live_intelligence_preservation_exchange_v3170/verifications_v3170.jsonl"
    live_intelligence_preservation_exchange_events_path: str = "backend/data/live_intelligence_preservation_exchange_v3170/events_v3170.jsonl"
    ...
    # Site Intelligence v4.35.17 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification.
    ...
    live_intelligence_preservation_registry_institutions_path: str = "backend/data/live_intelligence_preservation_registry_v3180/institutions_v3180.jsonl"
    live_intelligence_preservation_registry_attestations_path: str = "backend/data/live_intelligence_preservation_registry_v3180/attestations_v3180.jsonl"
    live_intelligence_preservation_registry_events_path: str = "backend/data/live_intelligence_preservation_registry_v3180/events_v3180.jsonl"
    live_intelligence_preservation_registry_max_records: int = Field(default=20000, ge=100, le=200000)
    ...
    # Site Intelligence v4.35.17 — Registry Governance, Challenges, Revocation, and Appeals.
    ...
    live_intelligence_registry_governance_appeals_path: str = "backend/data/live_intelligence_registry_governance_v3190/appeals_v3190.jsonl"
    live_intelligence_registry_governance_events_path: str = "backend/data/live_intelligence_registry_governance_v3190/events_v3190.jsonl"
    ...
    # Site Intelligence v4.35.17 — Public Registry Discovery, Evidence Search, and Institutional Profiles.
    ...
    # Site Intelligence v4.35.17 — Saved Discovery Views, Public Research Collections, and Evidence Pathways.
    ...
    live_intelligence_registry_collections_path: str = "backend/data/live_intelligence_registry_collections_v3210/collections_v3210.jsonl"
    live_intelligence_registry_collections_events_path: str = "backend/data/live_intelligence_registry_collections_v3210/events_v3210.jsonl"
    live_intelligence_registry_collections_max_records: int = Field(default=20000, ge=100, le=200000)
    ...
    # Site Intelligence v4.35.17 — Collection Publication, Citation Exports, and Research Brief Packages.
    ...
    live_intelligence_registry_publications_events_path: str = "backend/data/live_intelligence_registry_publications_v3220/events_v3220.jsonl"
    live_intelligence_registry_publications_handoffs_path: str = "backend/data/live_intelligence_registry_publications_v3220/handoffs_v3220.jsonl"
    live_intelligence_registry_publications_max_records: int = Field(default=20000, ge=100, le=200000)
    live_intelligence_registry_publications_require_separation_of_duties: bool = True
    ...
    # Site Intelligence v4.35.17 — Statistical Harmonization and Comparable-Series Engine.
    ...
    # Site Intelligence v4.35.17 — Model Registry, Forecast Evaluation, and Early-Warning Indicators.
    ...
    # Site Intelligence v4.35.17 — Evidence Synthesis, Claims, and Contradiction Review.
    ...
    # Site Intelligence v4.35.17 — Intelligence Publishing and Story Map Studio.
    ...
    # Site Intelligence v4.35.17 — Scheduled Monitoring, Digests, and Public Intelligence Feeds.
    ...
    # Site Intelligence v4.35.17 — Institutional Workspaces, Collaboration, and Review.
    ...
    # Site Intelligence v4.35.17 — Typed Cross-Platform Intelligence Workflows.
    ...
    # Open Standards, Federation, and Institutional Data Exchange v4.35.17.
    ...
    # Site Intelligence v4.35.17 — Security, Privacy, Governance, and Production Scale.
    ...
    # Site Intelligence v4.35.17 — Connected Public Intelligence and Evidence Platform.
