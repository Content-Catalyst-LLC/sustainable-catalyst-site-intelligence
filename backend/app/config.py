...
class Settings(BaseSettings):
    ...
    # Site Intelligence v4.35.22 — process-local upstream resilience. Provider
    ...
    # Site Intelligence v4.35.22 — ReliefWeb V2 requires a pre-approved
    ...
    # Site Intelligence v4.35.22 — first authoritative connector expansion.
    ...
    # Site Intelligence v4.35.22 — Authoritative Connector Expansion II.
    ...
    # Site Intelligence v4.35.22 — Authoritative Connector Expansion III.
    ...
    # Site Intelligence v4.35.22 — Agriculture, Food Security & Humanitarian connector closure.
    ...
    # Site Intelligence v4.35.22 — canonical authenticated-source configuration.
    ...
    # Site Intelligence v4.35.22 — Event Clustering and Intelligence Ranking.
    ...
    # Site Intelligence v4.35.22 — Signal Context and Drill-Down.
    ...
    # Site Intelligence v4.35.22 — Topic and Regional Channels.
    ...
    # Site Intelligence v4.35.22 — Live Intelligence reliability and freshness.
    ...
    # Site Intelligence v4.35.22 — Signal Relevance and Rotation Intelligence.
    ...
    # Site Intelligence v4.35.22 — Analytics and Public-Value Measurement.
    ...
    # Site Intelligence v4.35.22 — Signal Subscriptions, Alerts, and Scheduled Intelligence.
    ...
    # Site Intelligence v4.35.22 — Live Intelligence Briefings and Publication Workflow.
    ...
    # Site Intelligence v4.35.22 — Editorial Workspace, Review Queues, and Publication Orchestration.
    ...
    # Site Intelligence v4.35.22 — Publication Adapters, Institutional Handoffs, and Release Governance.
    ...
    # Site Intelligence v4.35.22 — Release Monitoring, Rollback, and Post-Publication Governance.
    ...
    # Site Intelligence v4.35.22 — Corrections, Retractions, and Public Change History.
    ...
    # Site Intelligence v4.35.22 — Public Record Archive, Provenance Ledger, and Long-Term Preservation.
    ...
    # Site Intelligence v4.35.22 — Archive Verification, Preservation Audits, and Institutional Custody.
    ...
    # Site Intelligence v4.35.22 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification.
    ...
    # Site Intelligence v4.35.22 — Registry Governance, Challenges, Revocation, and Appeals.
    ...
    # Site Intelligence v4.35.22 — Public Registry Discovery, Evidence Search, and Institutional Profiles.
    ...
    # Site Intelligence v4.35.22 — Saved Discovery Views, Public Research Collections, and Evidence Pathways.
    ...
    # Site Intelligence v4.35.22 — Collection Publication, Citation Exports, and Research Brief Packages.
    ...
    # Site Intelligence v4.35.22 — Statistical Harmonization and Comparable-Series Engine.
    ...
    # Site Intelligence v4.35.22 — Model Registry, Forecast Evaluation, and Early-Warning Indicators.
    ...
    # Site Intelligence v4.35.22 — Evidence Synthesis, Claims, and Contradiction Review.
    ...
    # Site Intelligence v4.35.22 — Intelligence Publishing and Story Map Studio.
    ...
    # Site Intelligence v4.35.22 — Scheduled Monitoring, Digests, and Public Intelligence Feeds.
    ...
    # Site Intelligence v4.35.22 — Institutional Workspaces, Collaboration, and Review.
    ...
    # Site Intelligence v4.35.22 — Typed Cross-Platform Intelligence Workflows.
    ...
    # Open Standards, Federation, and Institutional Data Exchange v4.35.22.
    ...
    # Site Intelligence v4.35.22 — Security, Privacy, Governance, and Production Scale.
    ...
    # Site Intelligence v4.35.22 — Connected Public Intelligence and Evidence Platform.
