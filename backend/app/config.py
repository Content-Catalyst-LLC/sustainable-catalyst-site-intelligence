...
class Settings(BaseSettings):
    ...
    # Site Intelligence v4.1.0 — Event Clustering and Intelligence Ranking.
    ...
    # Site Intelligence v4.1.0 — Signal Context and Drill-Down.
    ...
    # Site Intelligence v4.1.0 — Topic and Regional Channels.
    ...
    # Site Intelligence v4.1.0 — Live Intelligence reliability and freshness.
    ...
    # Site Intelligence v4.1.0 — Signal Relevance and Rotation Intelligence.
    ...
    # Site Intelligence v4.1.0 — Analytics and Public-Value Measurement.
    ...
    # Site Intelligence v4.1.0 — Signal Subscriptions, Alerts, and Scheduled Intelligence.
    ...
    # Site Intelligence v4.1.0 — Live Intelligence Briefings and Publication Workflow.
    ...
    # Site Intelligence v4.1.0 — Editorial Workspace, Review Queues, and Publication Orchestration.
    ...
    # Site Intelligence v4.1.0 — Publication Adapters, Institutional Handoffs, and Release Governance.
    ...
    # Site Intelligence v4.1.0 — Release Monitoring, Rollback, and Post-Publication Governance.
    ...
    # Site Intelligence v4.1.0 — Corrections, Retractions, and Public Change History.
    ...
    # Site Intelligence v4.1.0 — Public Record Archive, Provenance Ledger, and Long-Term Preservation.
    ...
    # Site Intelligence v4.1.0 — Archive Verification, Preservation Audits, and Institutional Custody.
    ...
    # Site Intelligence v4.1.0 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification.
    ...
    # Site Intelligence v4.1.0 — Registry Governance, Challenges, Revocation, and Appeals.
    ...
    # Site Intelligence v4.1.0 — Public Registry Discovery, Evidence Search, and Institutional Profiles.
    ...
    # Site Intelligence v4.1.0 — Saved Discovery Views, Public Research Collections, and Evidence Pathways.
    ...
    # Site Intelligence v4.1.0 — Collection Publication, Citation Exports, and Research Brief Packages.
    ...
    # Site Intelligence v4.1.0 — Statistical Harmonization and Comparable-Series Engine.
    ...
    # Site Intelligence v4.1.0 — Model Registry, Forecast Evaluation, and Early-Warning Indicators.
    ...
    # Site Intelligence v4.1.0 — Evidence Synthesis, Claims, and Contradiction Review.
    ...
    # Site Intelligence v4.1.0 — Intelligence Publishing and Story Map Studio.
    ...
    # Site Intelligence v4.1.0 — Scheduled Monitoring, Digests, and Public Intelligence Feeds.
    ...
    # Site Intelligence v4.1.0 — Institutional Workspaces, Collaboration, and Review.
    ...
    # Site Intelligence v4.1.0 — Typed Cross-Platform Intelligence Workflows.
    ...
    # Open Standards, Federation, and Institutional Data Exchange v4.1.0.
    ...
    # Site Intelligence v4.1.0 — Security, Privacy, Governance, and Production Scale.
    ...
    # Site Intelligence v4.1.0 — Connected Public Intelligence and Evidence Platform.
