...
class Settings(BaseSettings):
    ...
    # Site Intelligence v4.35.23 — process-local upstream resilience. Provider
    ...
    # Site Intelligence v4.35.23 — ReliefWeb V2 requires a pre-approved
    ...
    # Site Intelligence v4.35.23 — first authoritative connector expansion.
    ...
    # Site Intelligence v4.35.23 — Authoritative Connector Expansion II.
    ...
    # Site Intelligence v4.35.23 — Authoritative Connector Expansion III.
    ...
    # Site Intelligence v4.35.23 — Agriculture, Food Security & Humanitarian connector closure.
    ...
    # Site Intelligence v4.35.23 — canonical authenticated-source configuration.
    ...
    # Site Intelligence v4.38.0 — Live Space Observation & Archive Retrieval.
    ...
    # Site Intelligence v4.35.23 — Event Clustering and Intelligence Ranking.
    ...
    # Site Intelligence v4.35.23 — Signal Context and Drill-Down.
    ...
    # Site Intelligence v4.35.23 — Topic and Regional Channels.
    ...
    # Site Intelligence v4.35.23 — Live Intelligence reliability and freshness.
    ...
    # Site Intelligence v4.35.23 — Signal Relevance and Rotation Intelligence.
    ...
    # Site Intelligence v4.35.23 — Analytics and Public-Value Measurement.
    ...
    # Site Intelligence v4.35.23 — Signal Subscriptions, Alerts, and Scheduled Intelligence.
    ...
    # Site Intelligence v4.35.23 — Live Intelligence Briefings and Publication Workflow.
    ...
    # Site Intelligence v4.35.23 — Editorial Workspace, Review Queues, and Publication Orchestration.
    ...
    # Site Intelligence v4.35.23 — Publication Adapters, Institutional Handoffs, and Release Governance.
    ...
    # Site Intelligence v4.35.23 — Release Monitoring, Rollback, and Post-Publication Governance.
    ...
    # Site Intelligence v4.35.23 — Corrections, Retractions, and Public Change History.
    ...
    # Site Intelligence v4.35.23 — Public Record Archive, Provenance Ledger, and Long-Term Preservation.
    ...
    # Site Intelligence v4.35.23 — Archive Verification, Preservation Audits, and Institutional Custody.
    ...
    # Site Intelligence v4.35.23 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification.
    ...
    # Site Intelligence v4.35.23 — Registry Governance, Challenges, Revocation, and Appeals.
    ...
    # Site Intelligence v4.35.23 — Public Registry Discovery, Evidence Search, and Institutional Profiles.
    ...
    # Site Intelligence v4.35.23 — Saved Discovery Views, Public Research Collections, and Evidence Pathways.
    ...
    # Site Intelligence v4.35.23 — Collection Publication, Citation Exports, and Research Brief Packages.
    ...
    # Site Intelligence v4.35.23 — Scheduled Monitoring, Digests, and Public Intelligence Feeds.
    ...
    # Site Intelligence v4.35.23 — Institutional Workspaces, Collaboration, and Review.
    ...
    # Open Standards, Federation, and Institutional Data Exchange v4.35.23.
    ...
    # Site Intelligence v4.35.23 — Connected Public Intelligence and Evidence Platform.
