...
def crisis_map() -> Dict[str, Any]:
    return {
        ...
        "layers": [
            ...
            {"id":"unhcr-displacement","label":"UNHCR displacement context","source_id":"unhcr-refugee-statistics","geometry":"country_or_subnational_where_available","status":"live_periodic_statistics_connector"},
        ],
        "events": [],
