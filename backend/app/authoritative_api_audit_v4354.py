...
PRIORITY_CONNECTOR_TARGETS = (
    {"id":"usfws-nwi","workspace":"Wetlands & Inland Waters","reason":"Connect official National Wetlands Inventory map/data services.","target_state":"LIVE"},
    {"id":"epa-echo","workspace":"Waste / Water / Industrial pressure","reason":"Connect EPA ECHO regulatory and facility web services with administrative-record boundaries.","target_state":"LIVE"},
    {"id":"nasa-firms","workspace":"Terrestrial Ecosystems & Wildfire","reason":"Connect FIRMS fire detections with server-side credential/configuration handling.","target_state":"AUTH_REQUIRED"},
    {"id":"usda-nass-quickstats","workspace":"Agriculture, Crops & Food Systems","reason":"Connect official agricultural statistics with API-key configuration gating.","target_state":"AUTH_REQUIRED"},
    {"id":"nasa-cmr-graphql","workspace":"Earth / Science / Space discovery","reason":"Extend CMR discovery with GraphQL where cross-resource queries materially benefit.","target_state":"DISCOVERY"},
)
...
def audit_readiness(settings: Any = None) -> dict[str, Any]:
    ...
    checks = {
        ...
        "connector_expansions_i_and_ii_complete": len(COMPLETED_CONNECTOR_TARGETS) == 10,
