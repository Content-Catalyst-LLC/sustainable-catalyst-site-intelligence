...
def launch_readiness() -> dict[str, Any]:
    ...
    return {
        ...
        "production_actions": [
            "Deploy the v1.12.5 backend and confirm the root endpoint reports version 1.12.5.",
            "Install the v1.12.5 WordPress plugin and clear WordPress and Cloudflare caches.",
