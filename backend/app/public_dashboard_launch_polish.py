...
def launch_readiness() -> dict[str, Any]:
    ...
    return {
        ...
        "production_actions": [
            "Deploy the v1.15.2 backend and confirm the root endpoint reports version 1.15.2.",
            "Install the v1.15.2 WordPress plugin and clear WordPress and Cloudflare caches.",
