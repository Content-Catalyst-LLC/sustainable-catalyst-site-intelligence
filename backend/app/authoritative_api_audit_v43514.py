...
COMPLETED_CONNECTOR_TARGETS=tuple(prior.COMPLETED_CONNECTOR_TARGETS)+(
 {'id':'gdacs-events-v1','workspace':'Humanitarian Intelligence','state':'LIVE','completed_in':'4.35.14'},
 {'id':'hdx-ckan-discovery','workspace':'Conflict & Human Security','state':'DISCOVERY','completed_in':'4.35.14'},
 {'id':'hdx-hapi-food-security','workspace':'Humanitarian Intelligence','state':'AUTH_REQUIRED','completed_in':'4.35.14'},
 {'id':'ipc-food-security-api','workspace':'Agriculture, Crops & Food Systems','state':'AUTH_REQUIRED','completed_in':'4.35.14'},
 {'id':'fews-net-data-platform','workspace':'Agriculture, Crops & Food Systems','state':'LIVE','completed_in':'4.35.14'},
)
