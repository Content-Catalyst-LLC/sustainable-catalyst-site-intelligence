...
COMPLETED_CONNECTOR_TARGETS=tuple(prior.COMPLETED_CONNECTOR_TARGETS)+(
 {'id':'osm-mining-overpass','workspace':'Mining & Critical Materials','state':'LIVE','completed_in':'4.35.16'},
 {'id':'usgs-usmin-sdc','workspace':'Mining & Critical Materials','state':'DISCOVERY','completed_in':'4.35.16'},
 {'id':'usgs-mcs-2026-sdc','workspace':'Mining & Critical Materials','state':'DISCOVERY','completed_in':'4.35.16'},
 {'id':'osm-industrial-overpass','workspace':'Industrial Manufacturing & Trade','state':'LIVE','completed_in':'4.35.16'},
 {'id':'world-bank-wits-trade-stats','workspace':'Industrial Manufacturing & Trade','state':'LIVE','completed_in':'4.35.16'},
)
