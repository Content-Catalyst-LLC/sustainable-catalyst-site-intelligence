...
RELEASE_LEDGER = [
    ...
    {"version": "2.24.0", "title": "Institutional Workspaces, Collaboration, and Review", "audit_contribution": "Shared workspaces, explicit role permissions, assignments, comments, evidence review, public/private boundaries, activity receipts, preview-first retention, and account-free public publication summaries."},
    {"version": "2.24.0", "title": "Typed Cross-Platform Intelligence Workflows", "audit_contribution": "Typed bidirectional handoff packets, schema validation, provenance, receipts, linkbacks, bounded recovery queues, and explicit no-remote-write boundaries across the Sustainable Catalyst platform."},
