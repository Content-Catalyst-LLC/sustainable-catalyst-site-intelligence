...
RELEASE_LEDGER = [
    ...
    {"version": "2.23.0", "title": "Institutional Workspaces, Collaboration, and Review", "audit_contribution": "Shared workspaces, explicit role permissions, assignments, comments, evidence review, public/private boundaries, activity receipts, preview-first retention, and account-free public publication summaries."},
