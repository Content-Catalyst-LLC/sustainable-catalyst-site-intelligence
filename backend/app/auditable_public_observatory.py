...
PUBLIC_WORKSPACES: list[dict[str, str]] = [
    ...
    {
        "id": "alerts",
        "title": "Alerts, Monitoring, and Live Intelligence Streams",
        "route": "/app/?view=alerts",
...
AUDIT_ARTIFACTS: list[dict[str, Any]] = [
    ...
    {
        "id": "alerts-monitoring-live-streams",
        "title": "Alerts, Monitoring, and Live Intelligence Streams",
        "artifact_type": "workspace",
        "route": "/app/?view=alerts",
        "schema": "sc-site-intelligence-alerts-monitoring/1.0",
        "source_ids": ["platform-core", "world-bank", "usgs-earthquakes", "nasa-eonet", "reliefweb"],
        "methodology_ids": ["delivery-states", "optional-source-failures", "missing-values", "event-deduplication"],
        "verification_level": "public-stream-and-rule-contract-linked",
        "limitations": [
            "Stream snapshots and rule matches are public research prompts, not emergency instructions or operational alerts.",
            "Rules remain browser-local and matches do not create risk scores, legal conclusions, investment signals, eligibility decisions, or targeting recommendations.",
        ],
    },
    {
...
RELEASE_LEDGER = [
    ...
    {"version": "2.22.0", "title": "Institutional Workspaces, Collaboration, and Review", "audit_contribution": "Shared workspaces, explicit role permissions, assignments, comments, evidence review, public/private boundaries, activity receipts, preview-first retention, and account-free public publication summaries."},
    {"version": "2.23.0", "title": "Typed Cross-Platform Intelligence Workflows", "audit_contribution": "Typed bidirectional handoff packets, schema validation, provenance, receipts, linkbacks, bounded recovery queues, and explicit no-remote-write boundaries across the Sustainable Catalyst platform."},
    {"version": "2.24.0", "title": "Open Standards, Federation, and Institutional Data Exchange", "audit_contribution": "DCAT-compatible catalogs, linked-data and GeoJSON exchange, provenance and licensing, signed manifests, explicit trust policies, preview-first imports, and clear hosted, mirrored, and referenced record boundaries."},
    {"version": "2.25.0", "title": "Security, Privacy, Governance, and Production Scale", "audit_contribution": "Versioned persistent storage migrations, scoped hashed API keys, hash-chained audit events, privacy-request workflows, preview-first retention, verified backups, persistent jobs, deployment receipts, and explicit production-scale boundaries."},
    {"version": "4.35.23", "title": "Connected Public Intelligence and Evidence Platform", "audit_contribution": "Unified public discovery across countries, regions, events, indicators, datasets, sources, claims, models, investigations, publications, and workflows; shared context and provenance chains; complete source-to-publication lifecycle visibility; account-free public access; and explicit no-causation, no-hidden-ranking, no-private-record, and no-automatic-remote-delivery boundaries."},
    {"version": "4.35.25", "title": "Palestine-First Country Navigation Integrity Repair", "audit_contribution": "Makes first-party canonical country identity authoritative across Overview, Country, and cartographic focus; external country catalogs are enrichment-only; hostile or mismatched cross-identity responses are blocked; Palestine remains PSE/PS/Palestine independently of Israel ISR/IL/Israel."},
    {"version": "4.36.1", "title": "Global Ocean Intelligence II — Ocean Observation & Marine Systems", "audit_contribution": "Composes eleven inherited ocean systems into one first-class Ocean Intelligence workspace, adds a visible Ocean navigation entry without changing the six-area/35-route contract, and preserves measurement, model, media, biodiversity, hazard, human-activity, coastal, and maritime-governance evidence boundaries."},
]
