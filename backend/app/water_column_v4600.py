...
def overview():
    p = {
        ...
        "truth_boundaries": [
            ...
            "Site Intelligence does not interpolate between profile samples unless a future method explicitly requests and discloses an interpolation method; v4.15.0 performs no interpolation.",
...
def resolve_depth(request: dict[str, Any]):
    ...
    if exact is not None:
        ...
        result = {
            ...
            "reason": "No exact source sample exists at the requested depth; v4.15.0 does not interpolate or substitute the nearest sample.",
        }
