...
from .data_truth_v3233 import public_data_truth as build_public_data_truth, public_data_truth_source as build_public_data_truth_source
...
async def public_experience_headers(request, call_next):
    ...
    if path in {"/health", "/public/build-info", "/public/deployment-status", "/public/deployment-receipt", "/public/release-gate"}:
        ...
        response.headers["X-SC-Release-Gate"] = "v3.23.6.2"
...
def public_data_truth_endpoint(settings: Settings = Depends(get_settings)):
    try:
        return build_public_data_truth(settings)
...
# Site Intelligence v3.23.6.2 — Open Standards, Federation, and Institutional Data Exchange.
...
# Site Intelligence v3.23.6.2 — Connected Live Intelligence Surface.
