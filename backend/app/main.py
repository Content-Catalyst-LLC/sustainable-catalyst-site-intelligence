...
async def public_experience_headers(request, call_next):
    ...
    if path in {"/health", "/public/build-info", "/public/deployment-status", "/public/deployment-receipt", "/public/release-gate"}:
        ...
        response.headers["X-SC-Release-Gate"] = "v3.23.1"
...
# Site Intelligence v3.23.1 — Open Standards, Federation, and Institutional Data Exchange.
...
# Site Intelligence v3.23.1 — Connected Live Intelligence Surface.
