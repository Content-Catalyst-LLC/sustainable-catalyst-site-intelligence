...
from .release_health_v43516 import (
...
async def public_experience_headers(request, call_next):
    ...
    if path in {"/health", "/public/build-info", "/public/deployment-status", "/public/deployment-receipt", "/public/release-gate"}:
        ...
        response.headers["X-SC-Release-Gate"] = "v4.35.16"
...
# Site Intelligence v4.35.16 — Open Standards, Federation, and Institutional Data Exchange.
...
# Site Intelligence v4.35.16 — Connected Live Intelligence Surface.
