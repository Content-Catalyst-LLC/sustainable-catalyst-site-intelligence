...
SOURCES={
'noaa-ncei-cdo':{
 'title':'NOAA NCEI Climate Data Online','organization':'NOAA National Centers for Environmental Information','url':'https://www.ncei.noaa.gov/cdo-web/','api_url':'https://www.ncei.noaa.gov/cdo-web/api/v2/','recognized_hosts':['www.ncei.noaa.gov','ncei.noaa.gov'],'indicator_types':['air-temperature','precipitation','temperature-normal','precipitation-normal','heating-degree-days','cooling-degree-days'],'evidence_classes':['station-climate-observation','climate-normal'],'coverage':'Historical weather and climate observations, station metadata, monthly/annual summaries and 30-year Climate Normals.','limitations':'Station records and climate normals retain station, period-of-record, quality-control and baseline context. A climate normal is a reference climatology, not a forecast or a guarantee of future conditions. API v2 requires a user token and publishes request limits.'},
'copernicus-era5':{
