...
def _shortcodes() -> List[Dict[str, Any]]:
    return [
        ...
        {"shortcode": "[sc_site_intelligence_release_status]", "category": "release", "visibility": "private", "endpoint": "/release/status", "purpose": "v1.3.1 public flagship release status, checklist, smoke-test guidance, and launch metadata."},
    ]
...
def module_catalog(settings: Settings) -> List[Dict[str, Any]]:
    return [
        ...
        {"id": "public-topic-dashboards", "name": "Public Topic Dashboards", "status": "active" if settings.public_dashboards_enabled else "disabled", "visibility": "public", "shortcodes": ["[sc_public_dashboard_directory]", "[sc_public_dashboard_navigation]", "[sc_public_climate_energy_dashboard]", "[sc_public_environmental_monitoring_dashboard]", "[sc_public_biodiversity_land_use_dashboard]", "[sc_public_knowledge_system_dashboard]", "[sc_public_search_discovery_dashboard]", "[sc_public_source_methodology]"], "endpoints": ["/public/dashboards", "/public/navigation", "/public/page-templates", "/public/topic-page-visual-qa", "/public/source-methodology"], "notes": "v1.3.1 public topic page system with canonical /platform/site-intelligence/ paths, reusable navigation, templates, and QA."},
        {"id": "public-api-source-layer", "name": "Public API Source Layer", "status": "active" if settings.public_dashboards_enabled else "disabled", "visibility": "public", "shortcodes": ["[sc_public_api_sources]", "[sc_public_source_health]", "[sc_public_development_indicators]", "[sc_public_research_metadata]", "[sc_public_publication_metadata]", "[sc_public_repository_intelligence]", "[sc_public_indicator_overview]", "[sc_public_sustainability_indicators]"], "endpoints": ["/public/sources", "/public/sources/health", "/public/sources/development-indicators", "/public/sources/research-metadata", "/public/sources/publications", "/public/sources/repositories", "/public/indicators/overview", "/public/indicators/sustainability"], "notes": "v1.3.1 public API source expansion with source-health, development indicators, research/publication metadata, repository intelligence, and live/cached/fallback labels."},
        {"id": "public-source-pages", "name": "Public Source Pages", "status": "active" if settings.public_dashboards_enabled else "disabled", "visibility": "public", "shortcodes": ["[sc_public_source_page_directory]", "[sc_public_source_navigation]", "[sc_public_source_page_templates]", "[sc_public_source_page_visual_qa]"], "endpoints": ["/public/source-pages", "/public/source-pages/navigation", "/public/source-pages/templates", "/public/source-pages/visual-qa"], "notes": "v1.3.1 integration polish layer for source/indicator page templates, active navigation, visual QA, and public-safe source-page boundaries."},
        {"id": "public-live-connectors", "name": "Live API Connectors and Public Source Status", "status": "active" if settings.public_dashboards_enabled else "disabled", "visibility": "public", "shortcodes": ["[sc_public_connector_status]", "[sc_public_cache_status]", "[sc_public_source_freshness]", "[sc_public_world_bank_connector]", "[sc_public_openalex_connector]", "[sc_public_crossref_connector]", "[sc_public_github_connector]", "[sc_public_environmental_connectors]"], "endpoints": ["/public/connectors/status", "/public/connectors/cache", "/public/connectors/freshness", "/public/connectors/world-bank", "/public/connectors/openalex", "/public/connectors/crossref", "/public/connectors/github", "/public/connectors/environmental"], "notes": "v1.3.1 public connector status layer with cache, freshness, live/cached/fallback labels, and connector detail panels."},
