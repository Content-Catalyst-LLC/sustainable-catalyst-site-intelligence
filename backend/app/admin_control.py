...
def source_control_tools(settings: Settings) -> Dict[str, Any]:
    return {
        ...
        "managed_files": [
            ...
            {"path": "backend/data/evidence_synthesis_policy_v2180.json", "purpose": "v3.1.0 claims, evidence, contradiction, synthesis, and human-review governance", "editable_in_v090": False},
            {"path": "backend/data/knowledge_graph_policy_v2190.json", "purpose": "v3.1.0 knowledge graph and relationship governance", "editable_in_v090": False},
            {"path": "backend/data/knowledge_graph_relationship_registry_v2190.json", "purpose": "v3.1.0 entity and relationship type registry", "editable_in_v090": False},
            {"path": "backend/data/model_governance_policy_v2170.json", "purpose": "v3.1.0 model, forecast, and warning governance", "editable_in_v090": False},
            {"path": "backend/data/model_metric_registry_v2170.json", "purpose": "v3.1.0 forecast evaluation metrics", "editable_in_v090": False},
            {"path": "backend/data/unit_registry_v2160.json", "purpose": "v3.1.0 unit and currency registry", "editable_in_v090": False},
            {"path": "backend/data/geography_compatibility_registry_v2160.json", "purpose": "v3.1.0 geographic compatibility rules", "editable_in_v090": False},
