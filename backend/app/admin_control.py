...
def module_catalog(settings: Settings) -> List[Dict[str, Any]]:
    return [
        ...
        {"id": "public-dashboard", "name": "Public Dashboard Framework", "status": "active" if settings.public_dashboards_enabled else "disabled", "visibility": "public", "shortcodes": ["[sc_site_intelligence_public_landing]", "[sc_public_site_intelligence]", "[sc_public_knowledge_overview]", "[sc_public_climate_energy_summary]", "[sc_public_methodology]"], "endpoints": ["/public/landing-page", "/public/dashboard", "/public/knowledge-overview", "/public/climate-energy-summary", "/public/methodology"], "notes": "Sanitized public output only."},
