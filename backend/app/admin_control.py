...
def _shortcodes() -> List[Dict[str, Any]]:
    return [
        ...
        {"shortcode": "[sc_site_intelligence_release_status]", "category": "release", "visibility": "private", "endpoint": "/release/status", "purpose": "v1.1.1 public flagship release status, checklist, smoke-test guidance, and launch metadata."},
    ]
