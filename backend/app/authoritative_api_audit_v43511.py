...
COMPLETED_CONNECTOR_TARGETS=tuple(prior.COMPLETED_CONNECTOR_TARGETS)+(
 {'id':'osm-power-overpass','workspace':'Energy Infrastructure & Power Systems','state':'LIVE','completed_in':'4.35.14'},
 {'id':'ember-electricity-data','workspace':'Energy Infrastructure & Power Systems','state':'AUTH_REQUIRED','completed_in':'4.35.14'},
 {'id':'entsoe-transparency','workspace':'Energy Infrastructure & Power Systems','state':'AUTH_REQUIRED','completed_in':'4.35.14'},
 {'id':'openstreetmap-telecom','workspace':'Digital Connectivity','state':'LIVE','completed_in':'4.35.14'},
 {'id':'mlab-network-performance','workspace':'Digital Connectivity','state':'DISCOVERY','completed_in':'4.35.14'},
 {'id':'fcc-broadband-data','workspace':'Digital Connectivity','state':'DISCOVERY','completed_in':'4.35.14'},
)
