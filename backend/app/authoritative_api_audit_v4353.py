...
"""Site Intelligence v4.35.3.1 authoritative API/workspace integrity audit and connector coverage.
...
VERIFIED_MACHINE_INTERFACES = (
    ...
    },
    {
        ...
        "status": "implemented-live-v4.35.3.1",
        "audit_date": AUDIT_DATE,
    },
    {
    ...
    },
    {
        ...
        "status": "implemented-discovery-v4.35.3.1",
        "audit_date": AUDIT_DATE,
    },
    {
        "id": "nasa-cmr-graphql",
...
COMPLETED_CONNECTOR_TARGETS = (
    {"id":"usgs-water-ogc-v0","workspace":"Hydrology, Rivers, Flood & Drought","state":"LIVE","completed_in":"4.35.3.1"},
    {"id":"noaa-coastwatch-erddap","workspace":"Ocean Surface","state":"LIVE","completed_in":"4.35.3.1"},
    {"id":"nasa-exoplanet-tap","workspace":"Exoplanets, Habitability & Biosignatures","state":"LIVE","completed_in":"4.35.3.1"},
    {"id":"unhcr-refugee-statistics-v1","workspace":"Humanitarian Intelligence","state":"LIVE","completed_in":"4.35.3.1"},
    {"id":"nasa-cmr-search","workspace":"Earth / Science / Space discovery","state":"DISCOVERY","completed_in":"4.35.3.1"},
)

# The backlog remains intentionally evidence-driven.  A later connector build
# should promote only sources whose current machine interface has been verified.
PRIORITY_CONNECTOR_TARGETS = (
    {"id":"nasa-cmr-graphql","workspace":"Earth / Science / Space discovery","reason":"Extend CMR discovery with the official GraphQL interface where it materially improves cross-resource queries.","target_state":"DISCOVERY"},
)
...
def audit_readiness(settings: Any = None) -> dict[str, Any]:
    ...
    checks = {
        ...
        "connector_expansion_i_complete": len(COMPLETED_CONNECTOR_TARGETS) == 5,
