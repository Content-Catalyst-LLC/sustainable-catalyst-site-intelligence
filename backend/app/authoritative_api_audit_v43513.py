...
COMPLETED_CONNECTOR_TARGETS=tuple(prior.COMPLETED_CONNECTOR_TARGETS)+(
 {'id':'osm-water-infrastructure','workspace':'Water, Wastewater & Sanitation','state':'LIVE','completed_in':'4.35.22'},
 {'id':'epa-sdwis-drinking-water','workspace':'Water, Wastewater & Sanitation','state':'LIVE','completed_in':'4.35.22'},
 {'id':'drought-gov','workspace':'Hydrology, Rivers, Flood & Drought','state':'LIVE','completed_in':'4.35.22'},
 {'id':'nasa-gpm-imerg','workspace':'Hydrology, Rivers, Flood & Drought','state':'DISCOVERY','completed_in':'4.35.22'},
 {'id':'copernicus-glofas','workspace':'Hydrology, Rivers, Flood & Drought','state':'DISCOVERY','completed_in':'4.35.22'},
)
