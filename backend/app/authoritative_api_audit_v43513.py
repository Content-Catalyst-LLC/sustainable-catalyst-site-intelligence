...
COMPLETED_CONNECTOR_TARGETS=tuple(prior.COMPLETED_CONNECTOR_TARGETS)+(
 {'id':'osm-water-infrastructure','workspace':'Water, Wastewater & Sanitation','state':'LIVE','completed_in':'4.35.15'},
 {'id':'epa-sdwis-drinking-water','workspace':'Water, Wastewater & Sanitation','state':'LIVE','completed_in':'4.35.15'},
 {'id':'drought-gov','workspace':'Hydrology, Rivers, Flood & Drought','state':'LIVE','completed_in':'4.35.15'},
 {'id':'nasa-gpm-imerg','workspace':'Hydrology, Rivers, Flood & Drought','state':'DISCOVERY','completed_in':'4.35.15'},
 {'id':'copernicus-glofas','workspace':'Hydrology, Rivers, Flood & Drought','state':'DISCOVERY','completed_in':'4.35.15'},
)
