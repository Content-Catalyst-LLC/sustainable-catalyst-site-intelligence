...
def build_homepage_summary(
    ...
    *,
    registered_source_count: int | None = None,
    ...
    static_source_count, static_enabled_source_count = _source_counts()
    source_count = static_source_count if registered_source_count is None else max(0, int(registered_source_count))
    enabled_count = static_enabled_source_count if enabled_source_count is None else max(0, int(enabled_source_count))
    ...
    return {
        ...
        "metrics": [
            ...
            {"id": "registered_sources", "value": source_count, "label": "registered live feeds", "basis": "active Live Intelligence runtime feed registry"},
            {"id": "enabled_sources", "value": enabled_count, "label": "enabled by default", "basis": "active Live Intelligence default feed registry"},
