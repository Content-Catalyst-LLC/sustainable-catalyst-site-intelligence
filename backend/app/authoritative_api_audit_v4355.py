...
IMPLEMENTED_HOSTS = {
    ...
    "api.waterdata.usgs.gov": ("LIVE", "authoritative_connectors_v4353 USGS Water Data OGC latest-continuous retrieval"),
    "coastwatch.noaa.gov": ("LIVE", "authoritative_connectors_v4353 NOAA CoastWatch ERDDAP search and constrained tabledap retrieval"),
    "exoplanetarchive.ipac.caltech.edu": ("LIVE", "authoritative_connectors_v4353 NASA Exoplanet Archive TAP/ADQL retrieval"),
    "api.unhcr.org": ("LIVE", "authoritative_connectors_v4353 UNHCR Refugee Statistics population retrieval"),
    "cmr.earthdata.nasa.gov": ("DISCOVERY", "authoritative_connectors_v4353 NASA CMR collection discovery; observations remain source-dataset dependent"),
    "api.tidesandcurrents.noaa.gov": ("LIVE", "authoritative_connectors_v4354 NOAA CO-OPS station observations/predictions retrieval"),
    "api.obis.org": ("LIVE", "authoritative_connectors_v4354 IOC-UNESCO OBIS occurrence retrieval"),
    "ec.europa.eu": ("LIVE", "authoritative_connectors_v4354 Eurostat Statistics API JSON-stat retrieval"),
    "sdmdataaccess.sc.egov.usda.gov": ("LIVE", "authoritative_connectors_v4354 USDA-NRCS Soil Data Access bounded mapunit retrieval"),
    "fwspublicservices.wim.usgs.gov": ("LIVE", "authoritative_connectors_v4355 USFWS National Wetlands Inventory bounded feature retrieval"),
    "echodata.epa.gov": ("LIVE", "authoritative_connectors_v4355 EPA ECHO bounded facility/regulatory retrieval"),
    "firms.modaps.eosdis.nasa.gov": ("AUTH_REQUIRED", "authoritative_connectors_v4355 NASA FIRMS area retrieval; free server-side MAP_KEY required"),
    "quickstats.nass.usda.gov": ("AUTH_REQUIRED", "authoritative_connectors_v4355 USDA NASS Quick Stats retrieval; server-side API key required"),
    "graphql.earthdata.nasa.gov": ("DISCOVERY", "authoritative_connectors_v4355 NASA CMR GraphQL bounded metadata discovery"),
}

IMPLEMENTED_URL_PREFIXES = {
    "https://www.ncei.noaa.gov/access/services/data/v1": ("LIVE", "authoritative_connectors_v4354 NOAA NCEI bounded Access Data Service retrieval"),
}
...
VERIFIED_MACHINE_INTERFACES = (
    ...
    },
    {
        ...
        "status": "implemented-live-v4.35.3",
        "audit_date": AUDIT_DATE,
    },
    {
    ...
    },
    {
        ...
        "status": "implemented-discovery-v4.35.3",
        "audit_date": AUDIT_DATE,
    },
    {
        "id": "nasa-cmr-graphql",
    ...
    },
    {
        ...
        "authentication": "public Access Data Service",
        "status": "implemented-live-v4.35.4",
        "audit_date": AUDIT_DATE,
    },
    {
        "id": "obis-api-v3",
        "provider": "IOC-UNESCO Ocean Biodiversity Information System",
        "host": "api.obis.org",
        "protocol": "REST / JSON / Darwin Core",
        "current_version": "v3",
        "documentation_url": "https://manual.obis.org/access",
    ...
    },
    {
        ...
        "provider": "Eurostat",
        "host": "ec.europa.eu",
        "protocol": "REST / JSON-stat 2.0 / SDMX",
        "current_version": "Statistics API 1.0",
        "documentation_url": "https://ec.europa.eu/eurostat/web/user-guides/data-browser/api-data-access/api-introduction",
    ...
    },
    {
        ...
        "protocol": "REST/POST / JSON / WFS / WMS",
        "current_version": "current Soil Data Access service",
    ...
    },
    {
        ...
        "host": "fwspublicservices.wim.usgs.gov",
        "protocol": "ArcGIS REST / GeoJSON",
        "current_version": "ArcGIS REST 11.5 service",
        "documentation_url": "https://www.fws.gov/program/national-wetlands-inventory/web-mapping-services",
        "authentication": "public",
        "status": "implemented-live-v4.35.5",
        "audit_date": AUDIT_DATE,
    },
    {
        "id": "epa-echo-web-services",
        "provider": "U.S. EPA Enforcement and Compliance History Online",
        "host": "echodata.epa.gov",
        "protocol": "REST-like / JSON",
        "current_version": "current ECHO web services",
        "documentation_url": "https://echo.epa.gov/tools/web-services",
        "authentication": "public query-only services",
        "status": "implemented-live-v4.35.5",
        "audit_date": AUDIT_DATE,
    },
    {
        ...
        "protocol": "REST / CSV",
        "current_version": "FIRMS API 4.x",
        "documentation_url": "https://firms.modaps.eosdis.nasa.gov/api/area/",
        "authentication": "free MAP_KEY required",
        "status": "implemented-auth-required-v4.35.5",
        "audit_date": AUDIT_DATE,
    },
    {
        ...
        "protocol": "REST / JSON",
        "current_version": "current Quick Stats API",
...
COMPLETED_CONNECTOR_TARGETS = (
    {"id":"usgs-water-ogc-v0","workspace":"Hydrology, Rivers, Flood & Drought","state":"LIVE","completed_in":"4.35.3"},
    {"id":"noaa-coastwatch-erddap","workspace":"Ocean Surface","state":"LIVE","completed_in":"4.35.3"},
    {"id":"nasa-exoplanet-tap","workspace":"Exoplanets, Habitability & Biosignatures","state":"LIVE","completed_in":"4.35.3"},
    {"id":"unhcr-refugee-statistics-v1","workspace":"Humanitarian Intelligence","state":"LIVE","completed_in":"4.35.3"},
    {"id":"nasa-cmr-search","workspace":"Earth / Science / Space discovery","state":"DISCOVERY","completed_in":"4.35.3"},
    {"id":"noaa-coops-data-api","workspace":"Coastal Change, Sea Level & Blue Carbon","state":"LIVE","completed_in":"4.35.4"},
    {"id":"noaa-ncei-access-data-v1","workspace":"Climate / NCEI data access","state":"LIVE","completed_in":"4.35.4"},
    {"id":"obis-api-v3","workspace":"Marine Biodiversity & Biodiversity Conservation","state":"LIVE","completed_in":"4.35.4"},
    {"id":"eurostat-statistics-api","workspace":"Solid Waste & Circular Materials","state":"LIVE","completed_in":"4.35.4"},
    {"id":"usda-nrcs-soil-data-access","workspace":"Soils & Land Degradation","state":"LIVE","completed_in":"4.35.4"},
    {"id":"usfws-nwi-rest","workspace":"Wetlands & Inland Waters","state":"LIVE","completed_in":"4.35.5"},
    {"id":"epa-echo-web-services","workspace":"Waste / Water / Industrial pressure","state":"LIVE","completed_in":"4.35.5"},
    {"id":"nasa-firms-area-api","workspace":"Terrestrial Ecosystems & Wildfire","state":"AUTH_REQUIRED","completed_in":"4.35.5"},
    {"id":"usda-nass-quick-stats","workspace":"Agriculture, Crops & Food Systems","state":"AUTH_REQUIRED","completed_in":"4.35.5"},
    {"id":"nasa-cmr-graphql","workspace":"Earth / Science / Space discovery","state":"DISCOVERY","completed_in":"4.35.5"},
)

# Next targets remain evidence-driven and prioritize authoritative public systems.
PRIORITY_CONNECTOR_TARGETS = (
    {"id":"fao-statistical-api","workspace":"Agriculture / Food Security","reason":"Connect FAO statistical interfaces with indicator/unit semantics preserved.","target_state":"LIVE"},
    {"id":"ilo-stat-sdmx","workspace":"Economics / Labor","reason":"Connect ILOSTAT SDMX for official labor statistics.","target_state":"LIVE"},
    {"id":"oecd-sdmx","workspace":"Economics / Development","reason":"Connect OECD SDMX API with bounded comparable-series retrieval.","target_state":"LIVE"},
    {"id":"epa-frs-api","workspace":"Industrial / Facilities","reason":"Connect EPA Facility Registry Service for canonical facility identity and linkage.","target_state":"LIVE"},
    {"id":"usgs-volcano-notifications","workspace":"Geosphere","reason":"Connect authoritative USGS volcano machine feeds where stable public access is available.","target_state":"LIVE"},
)
...
def _primary_host(raw: dict[str, Any]) -> str:
    for key in ("api_url", "base_url", "endpoint", "url", "official_url", "documentation_url"):
...
def _primary_url(raw: dict[str, Any]) -> str:
    for key in ("api_url", "base_url", "endpoint", "url", "documentation_url"):
...
def _configured_state(host: str, settings: Any = None) -> tuple[str | None, str | None]:
    ...
    if host == "firms.modaps.eosdis.nasa.gov":
        configured = bool(str(getattr(settings, "nasa_firms_map_key", "") or "").strip())
        return ("configured" if configured else "configuration-required", "SC_SI_NASA_FIRMS_MAP_KEY")
    if host == "quickstats.nass.usda.gov":
        configured = bool(str(getattr(settings, "usda_nass_api_key", "") or "").strip())
        return ("configured" if configured else "configuration-required", "SC_SI_USDA_NASS_API_KEY")
    return None, None
...
def _classify(raw: dict[str, Any], protocol: str, host: str, settings: Any = None, source_id: str = "") -> tuple[str, str]:
    ...
    primary_url = _primary_url(raw)
    for prefix, (base_state, evidence) in IMPLEMENTED_URL_PREFIXES.items():
        if primary_url.startswith(prefix):
            return base_state, evidence
...
def audit_readiness(settings: Any = None) -> dict[str, Any]:
    ...
    checks = {
        ...
        "connector_expansions_i_through_iii_complete": len(COMPLETED_CONNECTOR_TARGETS) == 15,
        "noaa_coops_live_client_classified": IMPLEMENTED_HOSTS.get("api.tidesandcurrents.noaa.gov", (None,))[0] == "LIVE",
        "ncei_access_live_client_classified": IMPLEMENTED_URL_PREFIXES.get("https://www.ncei.noaa.gov/access/services/data/v1", (None,))[0] == "LIVE",
        "obis_live_client_classified": IMPLEMENTED_HOSTS.get("api.obis.org", (None,))[0] == "LIVE",
        "eurostat_live_client_classified": IMPLEMENTED_HOSTS.get("ec.europa.eu", (None,))[0] == "LIVE",
        "usda_soil_live_client_classified": IMPLEMENTED_HOSTS.get("sdmdataaccess.sc.egov.usda.gov", (None,))[0] == "LIVE",
        "usfws_nwi_live_client_classified": IMPLEMENTED_HOSTS.get("fwspublicservices.wim.usgs.gov", (None,))[0] == "LIVE",
        "epa_echo_live_client_classified": IMPLEMENTED_HOSTS.get("echodata.epa.gov", (None,))[0] == "LIVE",
        "nasa_firms_credential_gated": IMPLEMENTED_HOSTS.get("firms.modaps.eosdis.nasa.gov", (None,))[0] == "AUTH_REQUIRED",
        "usda_nass_credential_gated": IMPLEMENTED_HOSTS.get("quickstats.nass.usda.gov", (None,))[0] == "AUTH_REQUIRED",
        "nasa_cmr_graphql_discovery_only": IMPLEMENTED_HOSTS.get("graphql.earthdata.nasa.gov", (None,))[0] == "DISCOVERY",
        "usgs_water_live_client_classified": counts["LIVE"] > 0 and IMPLEMENTED_HOSTS.get("api.waterdata.usgs.gov", (None,))[0] == "LIVE",
        "noaa_erddap_live_client_classified": IMPLEMENTED_HOSTS.get("coastwatch.noaa.gov", (None,))[0] == "LIVE",
        "exoplanet_tap_live_client_classified": IMPLEMENTED_HOSTS.get("exoplanetarchive.ipac.caltech.edu", (None,))[0] == "LIVE",
        "unhcr_live_client_classified": IMPLEMENTED_HOSTS.get("api.unhcr.org", (None,))[0] == "LIVE",
        "nasa_cmr_kept_discovery_only": IMPLEMENTED_HOSTS.get("cmr.earthdata.nasa.gov", (None,))[0] == "DISCOVERY",
        "connector_backlog_preserved": len(PRIORITY_CONNECTOR_TARGETS) >= 1,
    }
    return {
        ...
        "configuration": {
            ...
            "nasa_firms_map_key_configured": bool(str(getattr(settings, "nasa_firms_map_key", "") or "").strip()) if settings is not None else False,
            "nasa_firms_required_environment": "SC_SI_NASA_FIRMS_MAP_KEY=<free FIRMS MAP_KEY>",
            "usda_nass_api_key_configured": bool(str(getattr(settings, "usda_nass_api_key", "") or "").strip()) if settings is not None else False,
            "usda_nass_required_environment": "SC_SI_USDA_NASS_API_KEY=<NASS API key>",
        },
        "generated_at": _now(),
    }
