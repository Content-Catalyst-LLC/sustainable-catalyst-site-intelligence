...
COMPLETED_CONNECTOR_TARGETS=tuple(prior.COMPLETED_CONNECTOR_TARGETS)+(
 {'id':'airnow','workspace':'Atmosphere, Air Quality & Aerosols','state':'AUTH_REQUIRED','completed_in':'4.35.16'},
 {'id':'copernicus-era5','workspace':'Climate Baselines, Anomalies & Extremes','state':'DISCOVERY','completed_in':'4.35.16'},
 {'id':'cams-global','workspace':'Atmosphere, Air Quality & Aerosols','state':'DISCOVERY','completed_in':'4.35.16'},
)
