...
def public_source_page_visual_qa() -> Dict[str, Any]:
    checks = [
        ...
        {"id": "visual_wrapping", "label": "Navigation and button wrapping", "status": "pass", "detail": "v1.5.0 CSS adds compact source page grids, active links, and nowrap helpers for public navigation labels."},
    ]
    ...
    return {
        ...
        "summary": "Visual and integration QA for v1.5.0 public source and indicator pages.",
        "version_scope": "v1.5.0",
        "score": score,
        "checks": checks,
