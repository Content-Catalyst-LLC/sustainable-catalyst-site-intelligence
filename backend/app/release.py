...
def release_checklist(settings: Settings) -> Dict[str, Any]:
    ...
    return {
        ...
        "release_stage": "v2.17.0_model_registry_forecast_evaluation_early_warning",
...
def release_public_summary(settings: Settings) -> Dict[str, Any]:
    return {
        ...
        "subtitle": "A public intelligence application with governed models and forecasts, managed connector operations, historical evidence, temporal change, geospatial, economic, sustainability, legal, scientific, humanitarian, resource-security, country, monitoring, comparison, briefing, source, methodology, and saved-research workflows.",
