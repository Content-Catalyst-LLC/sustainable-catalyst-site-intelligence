...
def release_checklist(settings: Settings) -> Dict[str, Any]:
    checks = [
        ...
        {"id": "comparison_exports", "label": "Comparison briefs and exports are available", "status": "pass", "detail": "JSON, CSV, and print-ready HTML exports preserve source IDs, URLs, data states, warnings, and methodological context.", "action": "Download all three export formats after deployment."},
    ...
    return {
        ...
        "release_stage": "v1.19.1_comparison_reliability",
