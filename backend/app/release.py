...
def release_checklist(settings: Settings) -> Dict[str, Any]:
    ...
    return {
        ...
        "release_stage": "v1.22.0_source_methodology_studio",
...
def release_public_summary(settings: Settings) -> Dict[str, Any]:
    return {
        ...
        "subtitle": "A public geospatial, country, comparative, thematic, briefing, source, and methodology application.",
        "summary": "Site Intelligence connects Earth observation, global country indicators, public events, dashboards, source records, methodology, diagnostics, and exports through one standalone public application.",
        "public_value": [
