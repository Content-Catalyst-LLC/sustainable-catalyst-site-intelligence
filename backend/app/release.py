...
def release_checklist(settings: Settings) -> Dict[str, Any]:
    checks: List[Dict[str, Any]] = [
        {
            "id": "backend_version",
            "label": "Backend version is v1.15.2",
            "status": "pass" if settings.version == "1.15.2" else "review",
            "detail": f"Current backend version: {settings.version}.",
            "action": "Confirm Render root endpoint returns version 1.15.2 after deployment.",
        },
        {
            "id": "public_defaults",
        ...
        },
        {
            ...
            "detail": "Install the v1.15.2 WordPress plugin ZIP after Render deploy completes.",
        ...
        },
        {
            ...
            "status": "pass",
            "detail": "v1.15.2 includes recommended title, excerpt, and meta description for the flagship page.",
        ...
        },
        {
            ...
            "action": "Run the smoke-test endpoint after deploying v1.15.2.",
        },
    ]
    counts = {
    ...
    return {
        ...
        "title": "Site Intelligence v1.15.2 Public Flagship Release Checklist",
...
def smoke_test(settings: Settings) -> Dict[str, Any]:
    ...
    return {
        ...
        "wordpress_checks": [
            ...
            "Clear WordPress cache and Cloudflare cache after installing the v1.15.2 plugin ZIP.",
        ],
    }
...
def release_status(settings: Settings) -> Dict[str, Any]:
    ...
    return {
        ...
        "generated_at": _now(),
        "version": settings.version,
        "title": "Site Intelligence v1.15.2 Public Flagship Release Status",
        "summary": "Release-hardening status for the Sustainable Catalyst Site Intelligence public flagship dashboard.",
        "release_stage": "v1.15.2_public_source_status_release",
        ...
        "launch_notes": [
            "Deploy the v1.15.2 backend to Render and confirm the root endpoint returns version 1.15.2.",
            "Install the v1.15.2 WordPress plugin ZIP and place [sc_site_intelligence_public_flagship] on the public page.",
