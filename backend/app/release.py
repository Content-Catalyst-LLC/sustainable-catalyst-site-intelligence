...
def release_checklist(settings: Settings) -> Dict[str, Any]:
    checks = [
        ...
        {"id": "comparison_contract", "label": "Comparative Intelligence uses explicit compatibility rules", "status": "pass", "detail": "Indicator IDs, units, reporting years, source states, and missing values remain visible before differences are calculated.", "action": "Verify Kenya–Ghana in table, chart, map, brief, and export views."},
        {"id": "comparison_exports", "label": "Comparison briefs and exports are available", "status": "pass", "detail": "JSON, CSV, and print-ready HTML exports preserve source and methodological context.", "action": "Download all three export formats after deployment."},
    ...
    return {
        ...
        "release_stage": "v1.19.0_comparative_intelligence",
...
def release_public_summary(settings: Settings) -> Dict[str, Any]:
    return {
        ...
        "subtitle": "A public geospatial, country, and comparative-intelligence application with source-aware briefing and export workflows.",
