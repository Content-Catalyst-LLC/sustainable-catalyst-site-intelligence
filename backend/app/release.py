...
def release_checklist(settings: Settings) -> Dict[str, Any]:
    ...
    return {
        ...
        "release_stage": "v2.18.0_evidence_synthesis_claims_contradiction_review",
...
def release_public_summary(settings: Settings) -> Dict[str, Any]:
    return {
        ...
        "subtitle": "A public intelligence application with structured claims, contradiction review, governed models and forecasts, managed connector operations, historical evidence, temporal change, geospatial, economic, sustainability, legal, scientific, humanitarian, resource-security, country, monitoring, comparison, briefing, source, methodology, and saved-research workflows.",
