...
def release_checklist(settings: Settings) -> Dict[str, Any]:
    ...
    return {
        ...
        "release_stage": "v1.21.0_thematic_intelligence_dashboards",
...
def release_public_summary(settings: Settings) -> Dict[str, Any]:
    return {
        ...
        "subtitle": "A public geospatial, country, comparative, and thematic-intelligence application with source-aware briefing and export workflows.",
