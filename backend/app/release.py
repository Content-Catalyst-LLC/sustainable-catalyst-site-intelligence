...
def release_public_summary(settings: Settings) -> Dict[str, Any]:
    return {
        ...
        "subtitle": "A public intelligence application with typed cross-platform workflows, a cross-domain knowledge graph, structured claims, contradiction review, governed models and forecasts, managed connector operations, historical evidence, temporal change, geospatial, economic, sustainability, legal, scientific, humanitarian, resource-security, country, monitoring, comparison, briefing, source, methodology, and saved-research workflows.",
