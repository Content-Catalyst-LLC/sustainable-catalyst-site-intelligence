...
def release_checklist(settings: Settings) -> Dict[str, Any]:
    ...
    return {
        ...
        "release_stage": "v2.19.0_cross_domain_knowledge_graph_relationship_explorer",
