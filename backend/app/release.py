...
def release_checklist(settings: Settings) -> Dict[str, Any]:
    checks = [
        ...
        {"id": "public_record_archive", "label": "Public Record Archive and provenance ledger are available", "status": "pass", "detail": "Approved public briefings, publication releases, and change notices can be preserved as checksum-bound, chain-linked, append-only archive records with retention metadata and manual custody handoffs.", "action": "Verify /public/live-intelligence/archive/policy, archive status, one public record, and its verification result."},
    ...
    return {
        ...
        "release_stage": "v3.23.6.2_archive_verification_custody",
...
def release_public_summary(settings: Settings) -> Dict[str, Any]:
    return {
        ...
        "public_value": [
            "Preserves approved public briefings, publication releases, and change notices as checksum-bound, append-only archival records with provenance-chain links, retention classes, and manual custody packages.",
