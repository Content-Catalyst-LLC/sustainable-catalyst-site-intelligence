...
def test_v3110_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.35.4", "sc_live_intelligence_editorial_workspace",
            "rest_live_intelligence_editorial_policy", "rest_live_intelligence_editorial_status",
        ],
        "README.md": ["v4.35.4 — Editorial Workspace, Review Queues, and Publication Orchestration"],
        ...
        "docs/RELEASE_MANIFEST_V3110.json": [
            '"version": "4.35.4"', '"automatic_publication": false',
