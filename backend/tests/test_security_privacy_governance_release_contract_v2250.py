...
def test_v2250_release_contract_markers():
    checks = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 4.4.0", "sc_public_production_governance", "sc_production_governance_control_center"],
