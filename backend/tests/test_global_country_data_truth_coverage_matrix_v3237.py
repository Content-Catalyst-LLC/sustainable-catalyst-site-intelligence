...
from app.data_truth_v3237 import GlobalCountryDataTruth, COVERAGE_STATES
...
def test_global_truth_assets_and_service_worker_contract_are_shipped():
    ...
    assert 'data-truth-v3237.css?v=3.23.7' in html and 'data-truth-v3237.js?v=3.23.7' in html
    assert 'data-truth-v3237.js' in worker and 'data-truth-v3237.css' in worker
    for token in ('SCSIDataTruthV3237','Coverage matrix','eligibility','scsi:data-truth-country-ready'):
        assert token in js
