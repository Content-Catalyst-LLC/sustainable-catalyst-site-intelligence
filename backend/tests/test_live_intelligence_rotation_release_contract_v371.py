...
def test_v371_release_contract_markers():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 3.16.0", "rest_live_intelligence_rotation_policy", "rest_live_intelligence_rotation_status",
        ],
        ...
        "README.md": ["v3.16.0 — Signal Relevance and Rotation Intelligence"],
        "docs/RELEASE_MANIFEST_V371.json": [
            '"version": "3.16.0"', '"individual_user_tracking": false',
