...
def test_release_contract_markers():
    checks = {
        "backend/app/version.py": ["4.15.0", "Connected Public Intelligence and Evidence Platform"],
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 4.15.0", "sc_public_institutional_data_exchange", "sc_institutional_data_exchange_control_center"],
