...
def test_release_contract_markers():
    checks = {
        "backend/app/version.py": ["3.7.1", "Connected Public Intelligence and Evidence Platform"],
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 3.7.1", "sc_public_institutional_data_exchange", "sc_institutional_data_exchange_control_center"],
