...
def test_release_contract_markers():
    checks = {
        "backend/app/version.py": ["3.23.4", "Connected Public Intelligence and Evidence Platform"],
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 3.23.4", "sc_public_institutional_data_exchange", "sc_institutional_data_exchange_control_center"],
