...
def test_v3150_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.39.1", "sc_live_intelligence_public_archive",
        ...
        "README.md": ["v4.39.1 — Public Record Archive, Provenance Ledger, and Long-Term Preservation"],
        "RELEASE_NOTES_SITE_INTELLIGENCE_V3150.md": ["Public Record Archive", "append-only", "preservation"],
        "docs/RELEASE_MANIFEST_V3150.json": ['"version": "4.39.1"', '"archive_record_deleted": false'],
