...
def test_v3200_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.35.21", "sc_live_intelligence_registry_discovery",
        ...
        "README.md": ["v4.35.21 — Public Registry Discovery, Evidence Search, and Institutional Profiles"],
        "RELEASE_NOTES_SITE_INTELLIGENCE_V3200.md": [
            "Registry Discovery", "institutional profiles", "search queries", "staff identities",
        ],
        "docs/RELEASE_MANIFEST_V3200.json": ['"version": "4.35.21"', '"search_queries_stored": false'],
