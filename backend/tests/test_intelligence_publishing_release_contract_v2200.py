...
def test_release_contract_files_and_markers():
    checks = {
        ...
        "backend/app/intelligence_publishing_v2200.py": ['RELEASE_VERSION = "3.17.0"', "def create_project(", "def add_block(", "def decide_review(", "def publish_project(", "def story_map(", "def export_publication(", "def wordpress_handoff("],
        ...
        "backend/data/intelligence_publishing_policy_v2200.json": ['"version": "3.17.0"', "human editorial approval", "does not establish causation", "read-only"],
    }
