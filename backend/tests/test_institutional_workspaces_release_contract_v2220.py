...
def test_release_contract_markers():
    checks = {
        "backend/app/version.py": ['APP_VERSION = "3.23.7.2"', 'RELEASE_NAME = "Connected Public Intelligence and Evidence Platform"'],
        "backend/app/institutional_workspaces_v2220.py": ['RELEASE_VERSION = "3.23.7.2"', "def create_workspace(", "def add_member(", "def review_evidence(", "def export_workspace("],
        "backend/public_app/index.html": ['data-route="workspaces"', 'id="institutionalWorkspaceStudio"'],
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ['Version: 3.23.7.2', 'sc_public_institutional_workspaces', 'sc_institutional_workspaces_control_center'],
        "README.md": ["Current release:** v3.23.7.2 — Connected Public Intelligence and Evidence Platform"],
    }
...
def test_service_worker_and_app_include_workspace_assets():
    ...
    assert 'const RELEASE="3.23.7.2"' in sw
