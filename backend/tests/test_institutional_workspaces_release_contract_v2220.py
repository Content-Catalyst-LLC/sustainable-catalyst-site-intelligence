...
def test_release_contract_markers():
    checks = {
        ...
        "backend/app/institutional_workspaces_v2220.py": ['RELEASE_VERSION = "4.18.0"', "def create_workspace(", "def add_member(", "def review_evidence(", "def export_workspace("],
        "backend/public_app/index.html": ['data-route="workspaces"', 'id="institutionalWorkspaceStudio"'],
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ['Version: 4.18.0', 'sc_public_institutional_workspaces', 'sc_institutional_workspaces_control_center'],
        "README.md": ["Current release:** v4.18.0 — Connected Public Intelligence and Evidence Platform"],
    }
...
def test_service_worker_and_app_include_workspace_assets():
    ...
    assert 'const RELEASE="4.18.0"' in sw
