...
def test_app_shell_orders_browser_reliability_inside_the_application():
    ...
    assert "/app/assets/browser-reliability-v3235.css?v=3.23.6.4" in html
    assert "/app/assets/browser-reliability-v3235.js?v=3.23.6.4" in html
    assert html.index("analytical-workspaces-v3234.js") < html.index("browser-reliability-v3235.js") < html.index("data-truth-v3233.js")
