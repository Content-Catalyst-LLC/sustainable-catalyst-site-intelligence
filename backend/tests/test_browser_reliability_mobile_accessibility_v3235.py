...
def test_app_shell_orders_browser_reliability_inside_the_application():
    ...
    assert "/app/assets/browser-reliability-v3235.css?v=3.23.5" in html
    assert "/app/assets/browser-reliability-v3235.js?v=3.23.5" in html
...
def test_service_worker_runtime_health_and_wordpress_package_assets():
    ...
    assert 'const RELEASE="3.23.5"' in worker
