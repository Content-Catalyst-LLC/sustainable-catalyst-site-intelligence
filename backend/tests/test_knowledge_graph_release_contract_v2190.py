...
def test_release_contract_files_and_markers():
    checks = {
        "backend/app/version.py": ['APP_VERSION = "4.35.4"', 'RELEASE_NAME = "Connected Public Intelligence and Evidence Platform"'],
        ...
        "backend/app/knowledge_graph_v2190.py": ['RELEASE_VERSION = "4.35.4"', "def register_entity(", "def register_relationship(", "def traverse(", "def shortest_path(", "def preview_reconciliation(", "def platform_core_handoff("],
        ...
        "backend/data/knowledge_graph_policy_v2190.json": ['"version": "4.35.4"', "No causation inferred", "No automatic entity merging", "No individual tracking"],
        "backend/data/knowledge_graph_relationship_registry_v2190.json": ['"version": "4.35.4"', '"entity_types"', '"relationship_types"', '"supports"', '"conflicts_with"'],
    }
