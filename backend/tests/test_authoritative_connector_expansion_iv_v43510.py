...
def test_public_catalog_and_readiness_routes_use_43510():
    ...
    assert client.get('/public/authoritative-connectors').json()['connector_count']==40
    assert client.get('/public/authoritative-connectors/readiness').json()['version']=='4.35.13'
