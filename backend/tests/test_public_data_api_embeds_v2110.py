...
def test_catalog_and_workspace_manifests_are_versioned_and_read_only():
    ...
    assert catalog["version"] == "4.35.23"
...
def test_public_routes_frontend_and_wordpress_contract():
    ...
    assert 'const APP_VERSION="4.35.23"' in appjs
    assert "Version: 4.35.23" in php and "sc_site_intelligence_embed" in php and "sc_public_data_api_integration" in php
