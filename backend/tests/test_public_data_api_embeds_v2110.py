...
def test_public_routes_frontend_and_wordpress_contract():
    ...
    assert 'const APP_VERSION="2.13.0"' in appjs
    assert "Version: 2.13.0" in php and "sc_site_intelligence_embed" in php and "sc_public_data_api_integration" in php
