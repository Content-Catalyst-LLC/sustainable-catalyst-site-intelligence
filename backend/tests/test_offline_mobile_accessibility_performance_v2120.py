...
def test_overview_and_cache_plan_preserve_offline_limits():
    ...
    assert out["version"]=="4.8.0" and out["privacy"]["server_profile_storage_added"] is False
...
def test_frontend_and_wordpress_contract():
    ...
    assert "Version: 4.8.0" in php and "sc_offline_mobile_accessibility_performance" in php
