...
def test_v3120_release_contract():
    requirements={
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 4.38.0","sc_live_intelligence_publication_releases","rest_live_intelligence_publication_release_policy","rest_live_intelligence_publication_release_status","manual destination handoff"],
        ...
        "README.md": ["v4.38.0 — Publication Adapters, Institutional Handoffs, and Release Governance"],
