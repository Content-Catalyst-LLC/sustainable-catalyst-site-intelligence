...
def test_v340_release_markers_and_wordpress_context_routes():
    checks = {
        "backend/app/version.py": ['APP_VERSION = "3.6.2"'],
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 3.6.2", "scsi_live_signal", "render_live_intelligence_signal_page",
        ...
        "README.md": ["v3.6.2 — Signal Context and Drill-Down"],
