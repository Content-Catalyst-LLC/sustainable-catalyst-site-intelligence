...
def test_governance_schema_has_bounded_institutional_contract():
    ...
    assert p["version"]=="4.35.18" and p["contract"]=="institutional-workspaces-review-governance"
...
def test_assets_and_service_worker_ship_governance_layer():
    ...
    assert "institutional-governance-v3300.js?v=4.35.18" in html and "institutional-governance-v3300.js" in sw and "SCSIInstitutionalGovernanceV3300" in js
