...
def test_v3190_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.35.3.1", "sc_live_intelligence_registry_governance",
        ...
        "README.md": ["v4.35.3.1 — Registry Governance, Challenges, Revocation, and Appeals"],
        "RELEASE_NOTES_SITE_INTELLIGENCE_V3190.md": [
            "Registry Governance", "revocation", "appeals", "append-only",
        ],
        "docs/RELEASE_MANIFEST_V3190.json": ['"version": "4.35.3.1"', '"automatic_enforcement_performed": false'],
