...
def test_v3130_release_contract():
    requirements={
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.37.0", "sc_live_intelligence_release_operations",
        ...
        "README.md": ["v4.37.0 — Release Monitoring, Rollback, and Post-Publication Governance"],
        "RELEASE_NOTES_SITE_INTELLIGENCE_V3130.md": ["Release Monitoring", "Human verification", "rollback"],
        "docs/RELEASE_MANIFEST_V3130.json": ['"version": "4.37.0"','"destination_write_performed": false'],
