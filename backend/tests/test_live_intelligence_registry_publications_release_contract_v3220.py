...
def test_v3220_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.35.6", "sc_live_intelligence_registry_publications",
        ...
        "README.md": ["v4.35.6 — Collection Publication, Citation Exports, and Research Brief Packages"],
        "RELEASE_NOTES_SITE_INTELLIGENCE_V3220.md": ["Collection Publication", "Citation exports", "No automatic publication"],
        "docs/RELEASE_MANIFEST_V3220.json": ['"version": "4.35.6"', '"automatic_publication_performed": false'],
