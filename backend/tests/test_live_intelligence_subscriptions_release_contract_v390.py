...
def test_v390_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.35.1", "sc_live_intelligence_watchlists", "sc_live_intelligence_alerts",
            "sc_live_intelligence_digests", "rest_live_intelligence_subscription_policy",
        ],
        "README.md": ["v4.35.1 — Signal Subscriptions, Alerts, and Scheduled Intelligence"],
        ...
        "docs/RELEASE_MANIFEST_V390.json": [
            '"version": "4.35.1"', '"subscriber_profiles_stored": false',
