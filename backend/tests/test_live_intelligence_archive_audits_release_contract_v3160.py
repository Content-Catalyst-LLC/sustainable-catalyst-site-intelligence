...
def test_v3160_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.35.1", "sc_live_intelligence_archive_audits",
        ...
        "README.md": ["v4.35.1 — Archive Verification, Preservation Audits, and Institutional Custody"],
        "RELEASE_NOTES_SITE_INTELLIGENCE_V3160.md": ["Archive Verification", "custody", "checksum"],
        "docs/RELEASE_MANIFEST_V3160.json": ['"version": "4.35.1"', '"automatic_scheduler_claimed": false'],
