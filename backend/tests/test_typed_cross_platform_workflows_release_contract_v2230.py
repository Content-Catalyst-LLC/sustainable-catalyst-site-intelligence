...
def test_release_contract_markers():
    checks={
      ...
      "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php":["Version: 4.14.0","sc_public_cross_platform_workflows","sc_cross_platform_workflows_control_center"],
