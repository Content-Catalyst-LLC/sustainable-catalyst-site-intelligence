...
def test_v3170_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 3.29.0", "sc_live_intelligence_preservation_exchange",
        ...
        "README.md": ["v3.29.0 — Preservation Interoperability, External Verification, and Institutional Exchange"],
        "RELEASE_NOTES_SITE_INTELLIGENCE_V3170.md": ["Preservation Interoperability", "external verification", "exchange"],
        "docs/RELEASE_MANIFEST_V3170.json": ['"version": "3.29.0"', '"network_verification_performed": false'],
