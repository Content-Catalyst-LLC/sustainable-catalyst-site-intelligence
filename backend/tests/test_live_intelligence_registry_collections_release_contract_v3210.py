...
def test_v3210_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.35.16", "sc_live_intelligence_registry_collections",
        ...
        "README.md": ["v4.35.16 — Saved Discovery Views, Public Research Collections, and Evidence Pathways"],
        ...
        "docs/RELEASE_MANIFEST_V3210.json": ['"version": "4.35.16"', '"visitor_queries_stored": false'],
