...
def test_v3210_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.28.0", "sc_live_intelligence_registry_collections",
        ...
        "README.md": ["v4.28.0 — Saved Discovery Views, Public Research Collections, and Evidence Pathways"],
        ...
        "docs/RELEASE_MANIFEST_V3210.json": ['"version": "4.28.0"', '"visitor_queries_stored": false'],
