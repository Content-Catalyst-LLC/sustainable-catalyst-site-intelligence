...
def test_v372_release_contract_markers():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.35.10", "rest_live_intelligence_analytics_events",
        ...
        "README.md": ["v4.35.10 — Analytics and Public-Value Measurement"],
        ...
        "docs/RELEASE_MANIFEST_V372.json": [
            '"version": "4.35.10"', '"raw_events_stored": false',
