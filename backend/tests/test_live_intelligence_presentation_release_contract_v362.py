...
def test_v362_release_contract_files_and_markers():
    checks = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": ["Version: 4.28.0", "live_intelligence_reduced_motion_mode", "data-scsi-live-announcer"],
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/assets/sc-site-intelligence.css": ["v4.28.0 — Live Intelligence presentation", "is-mobile-stacked", "min-height:44px"],
