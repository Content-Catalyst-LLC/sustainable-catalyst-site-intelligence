...
def test_release_contract_files_and_markers():
    checks = {
        ...
        "backend/app/model_forecast_early_warning_v2170.py": ['RELEASE_VERSION = "2.20.0"', "def register_model(", "def ingest_forecast(", "def evaluate_forecast(", "def evaluate_warning("],
        ...
        "backend/data/model_governance_policy_v2170.json": ['"version": "2.20.0"', "No individual-level targeting", "No hidden model substitution"],
        "backend/data/model_metric_registry_v2170.json": ['"code": "mae"', '"code": "calibration_gap"', '"code": "drift_ratio"'],
        "README.md": ["Current release:** v2.20.0 — Intelligence Publishing and Story Map Studio"],
