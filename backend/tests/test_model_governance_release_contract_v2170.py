...
def test_release_contract_files_and_markers():
    checks = {
        ...
        "backend/app/model_forecast_early_warning_v2170.py": ['RELEASE_VERSION = "4.35.16"', "def register_model(", "def ingest_forecast(", "def evaluate_forecast(", "def evaluate_warning("],
        ...
        "backend/data/model_governance_policy_v2170.json": ['"version": "4.35.16"', "No individual-level targeting", "No hidden model substitution"],
