...
def test_application_loads_engine_before_all_map_modules():
    ...
    engine = html.index("/app/assets/vector-cartography-v3230.js?v=4.33.0")
    recovery = html.index("/app/assets/service-recovery-v3224.js?v=4.33.0")
    runtime = html.index("/app/assets/runtime-v3230.js?v=4.33.0")
    application = html.index("/app/assets/app.js?v=4.33.0")
