...
def test_application_loads_engine_before_all_map_modules():
    ...
    engine = html.index("/app/assets/vector-cartography-v3230.js?v=3.23.8")
    recovery = html.index("/app/assets/service-recovery-v3224.js?v=3.23.8")
    runtime = html.index("/app/assets/runtime-v3230.js?v=3.23.8")
    application = html.index("/app/assets/app.js?v=3.23.8")
