...
def test_v370_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.23.0", "rest_live_intelligence_homepage", "rest_live_intelligence_gateway_policy",
        ...
        "README.md": ["v4.23.0 — Homepage Intelligence Gateway"],
        "docs/RELEASE_MANIFEST_V370.json": ["\"version\": \"4.23.0\"", "\"automatic_emergency_publication\": false", "\"full_application_boot_required\": false"],
    }
