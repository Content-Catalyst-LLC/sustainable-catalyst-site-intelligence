...
def test_v370_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.35.14", "rest_live_intelligence_homepage", "rest_live_intelligence_gateway_policy",
        ...
        "README.md": ["v4.35.14 — Homepage Intelligence Gateway"],
        "docs/RELEASE_MANIFEST_V370.json": ["\"version\": \"4.35.14\"", "\"automatic_emergency_publication\": false", "\"full_application_boot_required\": false"],
    }
