...
def test_release_contract_files_and_markers():
    checks = {
        ...
        "backend/app/scheduled_monitoring_v2210.py": ['RELEASE_VERSION = "4.3.0"', "def save_monitor(", "def check_monitor(", "def run_due(", "def generate_digest(", "def feed_payload(", "def deliver_digest("],
        ...
        "backend/data/scheduled_monitoring_policy_v2210.json": ['"version": "4.3.0"', "Duplicate alerts", "human explicitly approves", "disabled by default"],
    }
