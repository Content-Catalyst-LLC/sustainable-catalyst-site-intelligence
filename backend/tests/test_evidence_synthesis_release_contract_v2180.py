...
def test_release_contract_files_and_markers():
    checks = {
        ...
        "backend/app/evidence_synthesis_v2180.py": ['RELEASE_VERSION = "4.10.0"', "def register_claim(", "def add_evidence(", "def contradiction_review(", "def synthesize("],
        ...
        "backend/data/evidence_synthesis_policy_v2180.json": ['"version": "4.10.0"', "No fabricated evidence", "No suppression of conflicting evidence"],
    }
