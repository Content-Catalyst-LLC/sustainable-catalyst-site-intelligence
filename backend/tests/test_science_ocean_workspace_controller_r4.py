...
def test_main_router_cache_busts_and_recovers_science_controller():
    ...
    assert 'const SCIENCE_CONTROLLER_SRC="/app/assets/science-v240.js?v=4.39.1"' in app
...
def test_r4_cache_namespace_and_assets_are_mirrored_to_wordpress():
    ...
    assert '/app/assets/production-truth-v3231.js?v=4.39.1' in index
    assert '/app/assets/bootstrap-v32361.js?v=4.39.1' in index
...
def test_science_discovery_reports_r4_release_lineage():
    ...
    assert '"release_lineage": "v4.39.1"' in source
