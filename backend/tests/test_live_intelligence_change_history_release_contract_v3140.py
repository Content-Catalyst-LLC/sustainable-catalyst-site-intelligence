...
def test_v3140_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.35.2", "sc_live_intelligence_change_history",
        ...
        "README.md": ["v4.35.2 — Corrections, Retractions, and Public Change History"],
        "RELEASE_NOTES_SITE_INTELLIGENCE_V3140.md": ["Corrections, Retractions", "append-only", "original release"],
        "docs/RELEASE_MANIFEST_V3140.json": ['"version": "4.35.2"', '"deletion_performed": false'],
