...
def test_v3180_release_contract():
    requirements = {
        ...
        "wordpress-plugin/sustainable-catalyst-site-intelligence/sustainable-catalyst-site-intelligence.php": [
            "Version: 4.35.24", "sc_live_intelligence_preservation_registry",
        ...
        "README.md": ["v4.35.24 — Federated Preservation Registry, Trust Profiles, and Cross-Institution Verification"],
        "RELEASE_NOTES_SITE_INTELLIGENCE_V3180.md": ["Federated Preservation Registry", "multi-party", "trust profiles"],
        "docs/RELEASE_MANIFEST_V3180.json": ['"version": "4.35.24"', '"certification_claimed": false'],
