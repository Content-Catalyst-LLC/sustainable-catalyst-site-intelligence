(function (window, document) {
  ...
  function mapSnapshot() {
    ...
    return {
      ...
      libraryMode: window.L?.__scsiSelfHosted ? "self-hosted-map-engine" : window.L?.__scsiFirstParty ? "first-party-interactive" : window.L?.__scsiFallback ? "geographic-fallback" : window.L ? "leaflet" : "unavailable",
