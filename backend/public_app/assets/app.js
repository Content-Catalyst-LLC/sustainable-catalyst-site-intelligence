...
(() => {
  ...
  async function loadSourceStudio(pushState=false){
    ...
    try{
      ...
      populateSourceFilters(sourceStudioState.data);renderMethodology(sourceStudioState.methods);renderAuthoritativeApiAudit(sourceStudioState.audit||{summary:{counts:{}},completed_connector_targets:[],priority_connector_targets:[]});qs("#sourceIssueMetric").textContent="…";
  ...
  window.SCSIRouterV3228={version:"4.35.3.1",navigate:navigateToRoute,current:()=>state.route};
...
/* v4.35.3.1 publishing integration: window.SCIntelligencePublishingV2200 */
/* v4.35.3.1 scheduled monitoring integration: window.SCScheduledMonitoringV2210 */
