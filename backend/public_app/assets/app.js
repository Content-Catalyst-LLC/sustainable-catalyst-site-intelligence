...
(() => {
  ...
  window.SCSIRouterV3228={version:"4.35.15",navigate:navigateToRoute,current:()=>state.route};
...
/* v4.35.15 publishing integration: window.SCIntelligencePublishingV2200 */
/* v4.35.15 scheduled monitoring integration: window.SCScheduledMonitoringV2210 */
