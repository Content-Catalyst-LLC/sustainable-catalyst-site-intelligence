...
(() => {
  ...
  window.SCSIRouterV3228={version:"3.24.0",navigate:navigateToRoute,current:()=>state.route};
...
/* v3.24.0 publishing integration: window.SCIntelligencePublishingV2200 */
/* v3.24.0 scheduled monitoring integration: window.SCScheduledMonitoringV2210 */
