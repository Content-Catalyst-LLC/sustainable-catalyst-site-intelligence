...
printf '\n==> Validating v4.6.0 Security, Observability, Performance, and Scale Assurance contracts\n'
...
grep -q 'institutional-governance-v3300.js?v=4.6.0' "$BACKEND/public_app/index.html"
...
printf '\nSUCCESS: Site Intelligence v4.6.0 passed Security, Observability, Performance, and Scale Assurance validation.\nRepository: %s\n' "$ROOT"
