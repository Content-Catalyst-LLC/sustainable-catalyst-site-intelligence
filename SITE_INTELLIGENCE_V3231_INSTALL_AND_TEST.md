# Install and test Site Intelligence v3.23.1

## Required files

- `sustainable-catalyst-site-intelligence-v3.23.1-release-bundle.zip`
...
BUNDLE="$(find . -maxdepth 1 -type f \
  -name 'sustainable-catalyst-site-intelligence-v3.23.1-release-bundle*.zip' \
  -print0 | xargs -0 ls -t | head -1)"
