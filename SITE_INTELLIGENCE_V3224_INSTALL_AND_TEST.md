# Site Intelligence v3.22.4 installation and deployment
...
bash deploy_and_validate_site_intelligence_v3_22_4_macos.sh \
  sustainable-catalyst-site-intelligence-v3.22.4-release-bundle.zip
```
...
Do not install the WordPress ZIP until both endpoints report v3.22.4 and the Git commit printed by the deployment script.
