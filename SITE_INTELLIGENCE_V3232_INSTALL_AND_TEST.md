...
Install the WordPress ZIP only after Terminal reports that v3.23.6.3 is live. Replace the current plugin, purge WordPress and CDN caches, and open the page in a new Incognito window.
