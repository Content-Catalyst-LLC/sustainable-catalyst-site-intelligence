...
## Install
Use the standalone macOS installer together with the matching v4.35.18 release bundle.
...
BUNDLE="$(find . -maxdepth 1 -type f \
  -name 'sustainable-catalyst-site-intelligence-v4.35.18-release-bundle*.zip' \
  -print0 | xargs -0 ls -t | head -1)"
