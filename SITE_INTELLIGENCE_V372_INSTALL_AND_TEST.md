...
1. Place the v3.7.2 release bundle in `~/Downloads` and unzip it.
2. Run `chmod +x install_and_push_site_intelligence_v3_7_2.sh`.
3. Run `./install_and_push_site_intelligence_v3_7_2.sh`.
4. Deploy the updated backend from the repository and install the v3.7.2 WordPress ZIP.
5. Confirm `/public/build-info` and the WordPress plugin both report `3.7.2`.
