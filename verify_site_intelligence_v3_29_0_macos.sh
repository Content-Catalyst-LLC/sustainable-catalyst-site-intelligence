...
printf '\n==> Validating v4.15.0 Briefing, Story Map, and Publication Studio contracts\n'
...
grep -q 'briefing-publication-v3290.js?v=4.15.0' "$BACKEND/public_app/index.html"
...
printf '\nSUCCESS: Site Intelligence v4.15.0 passed Briefing, Story Map, and Publication Studio validation.\nRepository: %s\n' "$ROOT"
