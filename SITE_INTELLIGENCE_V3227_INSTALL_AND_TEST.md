...
1. Place the v3.22.9 release bundle and macOS installer in `~/Downloads`.
...
- Confirm the WordPress release-status surface reports backend v3.22.9 and release id `site-intelligence-v3.22.9`.
